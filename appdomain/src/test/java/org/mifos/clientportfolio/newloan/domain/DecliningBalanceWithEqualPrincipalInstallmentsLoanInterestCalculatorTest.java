...
public class DecliningBalanceWithEqualPrincipalInstallmentsLoanInterestCalculatorTest {

    private DecliningBalanceWithEqualPrincipalInstallmentsLoanInterestCalculator decliningBalanceWithEqualPrincipalInstallmentsLoanInterestCalculator;

    @Before
    public void setup() {
        decliningBalanceWithEqualPrincipalInstallmentsLoanInterestCalculator = new DecliningBalanceWithEqualPrincipalInstallmentsLoanInterestCalculator();
    }

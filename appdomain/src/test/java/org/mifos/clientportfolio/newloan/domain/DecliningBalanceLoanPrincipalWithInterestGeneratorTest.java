...
public class DecliningBalanceLoanPrincipalWithInterestGeneratorTest {
    ...
    @Before
    public void setup() {
        principalWithInterestGenerator = new DecliningBalancePrincipalWithInterestGenerator();
    }
    ...
    public void givenGraceOnAllRepaymentsShouldReturnPrincipalAndInterestDueForEachInstallmentRelativeToLoanAmount() {
        ...
        // verification
        assertThat(TestMoneyUtil.moneyOf(equalInstallments.get(0).getPrincipal()), is(TestMoneyUtil.moneyOf("4.7")));
        assertThat(TestMoneyUtil.moneyOf(equalInstallments.get(0).getInterest()), is(TestMoneyUtil.moneyOf("16.0")));
    }
    ...
    public void givenNoGraceWithZeroInterestShouldReturnPrincipalAndInterestDueForEachInstallmentRelativeToLoanAmount() {
        ...
        // verification
        assertThat(TestMoneyUtil.moneyOf(equalInstallments.get(0).getPrincipal()), is(TestMoneyUtil.moneyOf("-6.0")));
        assertThat(TestMoneyUtil.moneyOf(equalInstallments.get(0).getInterest()), is(TestMoneyUtil.moneyOf("16.0")));
    }
}
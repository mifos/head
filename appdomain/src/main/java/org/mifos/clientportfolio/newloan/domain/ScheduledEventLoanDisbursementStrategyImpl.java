...
public class ScheduledEventLoanDisbursementStrategyImpl implements LoanDisbursementStrategy {

    private final ScheduledEvent scheduledEvent;

    public ScheduledEventLoanDisbursementStrategyImpl(ScheduledEvent scheduledEvent) {

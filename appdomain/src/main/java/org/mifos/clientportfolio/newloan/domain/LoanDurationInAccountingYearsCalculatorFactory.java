...
public class LoanDurationInAccountingYearsCalculatorFactory {

    public LoanDurationInAccountingYearsCalculator create(RecurrenceType recurrenceType) {
        switch (recurrenceType) {
        case MONTHLY:
            return new LoanDurationInAccountingYearsCalculatorFactoryForMonthlyRecurrence();
        case WEEKLY:

...
public class BranchReportLoanArrearsProfileBO extends AbstractBusinessObject {
    ...
    public BranchReportLoanArrearsProfileBO(Integer loansInArrears, Integer clientsInArrears,
            Money overDueBalanceInArrears, Money unpaidBalanceInArrears, Integer loansAtRisk,

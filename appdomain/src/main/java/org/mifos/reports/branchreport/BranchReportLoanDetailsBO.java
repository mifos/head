...
public class BranchReportLoanDetailsBO extends AbstractBusinessObject {
    ...
    public BranchReportLoanDetailsBO(String productName, Integer numberOfLoansIssued, Money loanAmountIssued,
            Money loanInterestIssued, Integer numberOfLoansOutstanding, Money loanAmountOutstanding,
            Money loanInterestOutstanding) {
        super();
    ...
    public int hashCode() {
        final int PRIME = 31;
        int result = 1;
        result = PRIME * result + ((loanAmountIssued == null) ? 0 : loanAmountIssued.hashCode());
        ...
        result = PRIME * result + ((loanInterestIssued == null) ? 0 : loanInterestIssued.hashCode());
        result = PRIME * result + ((loanInterestOutstanding == null) ? 0 : loanInterestOutstanding.hashCode());
        result = PRIME * result + ((numberOfLoansIssued == null) ? 0 : numberOfLoansIssued.hashCode());
        result = PRIME * result + ((numberOfLoansOutstanding == null) ? 0 : numberOfLoansOutstanding.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        } else if (!numberOfLoansOutstanding.equals(other.numberOfLoansOutstanding)) {
            return false;
        }
        if (productName == null) {

...
public class SurveysPersistence extends LegacyGenericDao {
    ...
    public List<SurveyResponse> retrieveAllResponses()  {
    ...
    public List<Survey> retrieveSurveysByType(SurveyType type)  {
    ...
    public List<Question> getQuestionsByQuestionType(int questionType)  {
    ...
    public List<Question> retrieveSomeQuestions(int offset, int limit)  {
        Query query = getSession().getNamedQuery(NamedQueryConstants.QUESTIONS_RETRIEVE_ALL);
    ...
    public List<Question> retrieveGeneralQuestionsByState(QuestionState state)  {
    ...
    public List<Question> retrieveQuestionsByAnswerType(AnswerType type)  {
    ...
    public List<SurveyInstance> retrieveInstancesByCustomer(CustomerBO customer)  {
    ...
    public List<SurveyInstance> retrieveInstancesByAccount(AccountBO account)  {
    ...
    public List<SurveyInstance> retrieveInstancesBySurvey(Survey survey)  {
    ...
    public Iterator<SurveyInstance> retrieveInstancesBySurveyIterator(Survey survey)  {
        Query query = getSession().getNamedQuery(NamedQueryConstants.SURVEYINSTANCE_RETRIEVE_BY_SURVEY);
        query.setParameter("INSTANCE_SURVEY", survey);
        return query.iterate();
    }

    public Iterator<Survey> retrieveSurveysByTypeIterator(SurveyType type)  {
        Query query = getSession().getNamedQuery(NamedQueryConstants.SURVEYS_RETRIEVE_BY_TYPE);
        query.setParameter("SURVEY_TYPE", type.getValue());
        return query.iterate();
    }

    public Iterator<Survey> retrieveNonPPISurveysByTypeIterator(SurveyType type)  {

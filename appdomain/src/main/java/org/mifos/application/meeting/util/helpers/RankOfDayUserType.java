 ...
 * RankOfDay.FIRST(1) has ordinal value 0 as it's first in order in RankOfDay ENUM while the value is 1.
 ...
 */
public class RankOfDayUserType implements UserType {
    ...
    public Class<RankOfDay> returnedClass() {
        return RankOfDay.class;
    }
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, @SuppressWarnings("unused") Object owner) throws HibernateException, SQLException {
        ...
        if (object instanceof Number) {
            ...
            for (RankOfDay rankOfDay : RankOfDay.values()) {
                if (value == rankOfDay.getValue()) {
                    return rankOfDay;
                }
            }
        }
    ...
    public void nullSafeSet(PreparedStatement st, Object obj, int index) throws HibernateException, SQLException {
        if (obj == null) {
            ...
            st.setObject(index, ((RankOfDay) obj).getValue(), sqlType);
        }
    }

...
@Configuration
public class ClientPhotoServiceConfiguration {
    ...
    @Bean(name="clientPhotoService")
    public ClientPhotoService getClientPhotoService() {
        return this.clientPhotoService;
    }
    
    public ClientPhotoServiceConfiguration() {
        ...
        if (imageStorageConfig != null && imageStorageConfig.equals(DB_CONFIG)) {
            ...
            this.clientPhotoService = new ClientPhotoServiceFileSystem();
        }
    }
}

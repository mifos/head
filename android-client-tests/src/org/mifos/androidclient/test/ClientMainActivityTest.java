...
import org.mifos.androidclient.utils.ConnectionHelper;
...
public class ClientMainActivityTest extends ActivityInstrumentationTestCase2 {
    ...
    public void testCentersListActivity() throws Exception {
        ...
        solo.assertCurrentActivity("CentersListActivity",
                Class.forName("org.mifos.androidclient.main.CentersListActivity"));

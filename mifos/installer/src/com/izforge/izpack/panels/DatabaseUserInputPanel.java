 ...
 * --------------------------------------------------------------------------
 */
public class DatabaseUserInputPanel extends IzPanel implements ActionListener
{
    ...
    protected int instanceNumber = 3; 
     ...
     */
    /*--------------------------------------------------------------------------*/
    public DatabaseUserInputPanel(InstallerFrame parent, InstallData installData)
    {
        ...
        if(isValid) 
        {
        	...
        	for (int i = 0; i < uiElements.size(); i++)
	        {
	            ...
	            if ((field != null) && (((Boolean) field[POS_DISPLAYED]).booleanValue()))
	            {
	                ...
	                {
	            		PasswordGroup group = (PasswordGroup) field[POS_GROUP];
	                ...
	                {
	                	if(field[2] != null && field[2].equals("db.host")) {
	                		final TextInputField textField = (TextInputField) field[POS_FIELD];
	                		dbHost = textField.getText();
	                	} else if(field[2] != null && field[2].equals("db.port")) {
	                		final TextInputField textField = (TextInputField) field[POS_FIELD];
	                		dbPort = textField.getText();
	                	} else if(field[2] != null && field[2].equals("db.schema")) {
	                		final TextInputField textField = (TextInputField) field[POS_FIELD];
	                		dbSchema = textField.getText();
	                	} else if(field[2] != null && field[2].equals("db.user")) {
	                		final TextInputField textField = (TextInputField) field[POS_FIELD];
	    	...
	    	try {
	    		...
	    		String url = "jdbc:mysql://".concat(dbHost).concat(":").concat(dbPort);
	    	...
	    	if(!isValid) {
	    		showMessage("invalid.db.connection");
	    	}
        }

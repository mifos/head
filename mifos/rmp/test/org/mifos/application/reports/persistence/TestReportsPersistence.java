...
*/
	...
	public void testCreateReportsDataSource()throws Exception{
		...
		ReportsDataSource objval = new ReportsDataSource(userContext);
		objval.setName("DS1");
		...
		hibernateProperties.load(new FileInputStream(new File("c:/hibernate.properties")));
		...
		System.out.println("getsession"+session);
  		...
  		HibernateUtil.closeSession();
		//reportsPersistence.persist(objval);
	}

			...
			<td align="left" valign="top" bgcolor="#FFFFFF"
				...
				<table width="95%">
					...
					<tr>
						...
						<td><span class="fontnormal"><c:out value="${sessionScope.systemInfo.osName} / ${sessionScope.systemInfo.osArch} / ${sessionScope.systemInfo.osVersion}"/></span></td>
					</tr>
					<tr>
						<td><span class="fontnormal"><mifos:mifoslabel name="admin.sysinfo.java" bundle="adminUIResources" /></span></td>
						<td><span class="fontnormal"><c:out value="${sessionScope.systemInfo.javaVendor} / ${sessionScope.systemInfo.javaVersion}"/></span></td>
					</tr>
					<tr>
						<td><span class="fontnormal"><mifos:mifoslabel name="admin.sysinfo.database" bundle="adminUIResources" /></span></td>
						<td><span class="fontnormal"><c:out value="${sessionScope.systemInfo.databaseVendor} / ${sessionScope.systemInfo.databaseVersion}"/></span></td>
					</tr>
					<tr>
						<td><span class="fontnormal"><mifos:mifoslabel name="admin.sysinfo.driver" bundle="adminUIResources" /></span></td>
						<td><span class="fontnormal"><c:out value="${sessionScope.systemInfo.driverName} / ${sessionScope.systemInfo.driverVersion}"/></span></td>
					</tr>
					<tr>
						<td><span class="fontnormal"><mifos:mifoslabel name="admin.sysinfo.appserver" bundle="adminUIResources" /></span></td>
						<td><span class="fontnormal"><c:out value="${sessionScope.systemInfo.applicationServerInfo}"/></span></td>
					</tr>
					<tr>
						<td><span class="fontnormal"><mifos:mifoslabel name="admin.sysinfo.applicationversion" bundle="adminUIResources" /></span></td>
						<td><span class="fontnormal"><c:out value="${sessionScope.systemInfo.applicationVersion}"/></span></td>
					</tr>
					<tr>

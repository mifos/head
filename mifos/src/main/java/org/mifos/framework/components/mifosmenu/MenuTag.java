...
public class MenuTag extends BaseHandlerTag{
	...
	public int doStartTag()throws JspException{
		...
		if(leftMenu==null){
			...
			leftMenu=menuRepository.getMenuForTabAndLocale(topMenuTab,locale);
			if(leftMenu==null) // TODO: to be modified for exception from resource bundle
	 ...
	 * @param topMenuTab is the value to be set
	 */
	 ...
	 * @param output is the string to which generated html is to be appended
	 * @param menuGroup whose menuitem details are to be appended as html
	 */

 ...
 * you want to populate the left listbox [label] : label of the MifosSelect
 * [property] : name of the String array as declared in bean with first letter
 * in caps [property1] : name of the form bean property in which you want to
 * store the selected list [multiple] : whether list boxes are multiple or not
 * [selectStyle] : Style information of list boxes e.g <mifos:MifosSelect
 * name="inputForm" label="abc" property="InList" property1="outList"
 * multiple="true" selectStyle=" width:100 ">
 */
    ...
    Map helper(Collection coll) throws SecurityException, NoSuchMethodException, IllegalArgumentException,
        ...
        if (coll != null && !coll.isEmpty()) {
            for (Iterator it = coll.iterator(); it.hasNext();) {
                ...
                getList = object.getClass().getMethod("get" + str1.toUpperCase() + this.Property2.substring(1),
                        (Class[]) null);
                string2 = getList.invoke(object, (Object[]) null);
                String str2 = this.Property1.substring(0, 1);
                getList = object.getClass().getMethod("get" + str2.toUpperCase() + this.Property1.substring(1),
                        (Class[]) null);

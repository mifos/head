...
<html-el:form action="centerAction.do?method=update" onsubmit="func_disableSubmitBtn('submitButton');">
          ...
          <table width="93%" border="0" cellpadding="3" cellspacing="0">
            <tr>
              <td class="headingorange">
                  <span class="heading"><c:out value="${requestScope.centerVO.displayName}"/> 
                  - </span>
          ...
          <table width="93%" border="0" cellpadding="0" cellspacing="0">
           ...
           <tr>
             <td width="100%" class="fontnormal">
                ...
                <span class="fontnormal"><c:out value="${requestScope.centerVO.personnel.displayName}"/></span>
              </td>
              </tr>
            ...
            <tr id="Center.ExternalId">
             <td width="100%" class="fontnormal">    
		        ...
		        <span class="fontnormal"> <c:out value="${requestScope.centerVO.externalId}"/></span><br>
		      </td>
		      </tr>
             ...
             <span class="fontnormalbold">      
				...
				<span class="fontnormal"> <c:out value="${sessionScope.centerActionForm.mfiJoiningDate}"/> <br></span><br>
                </span>
             </td>
             </tr>
    		...
    		<tr id="Center.Address">
             <td width="100%" class="fontnormal"> 
            		...
            		<c:out value="${requestScope.centerVO.displayAddress}"/><br></span>
            </td>
            </tr>

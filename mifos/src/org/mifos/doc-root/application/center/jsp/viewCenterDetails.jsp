						...
						<tr>
							...
							<c:if test="${statusID != CustomerConstants.CENTER_INACTIVE_STATE}">
								<span class="fontnormal"> <a
									href="GroupAction.do?method=load&centerSystemId=<c:out value="${sessionScope.BusinessKey.globalCustNum}"/>&parentOfficeId=${sessionScope.BusinessKey.office.officeId}&recordOfficeId=${sessionScope.BusinessKey.office.officeId}&recordLoanOfficerId=${sessionScope.BusinessKey.personnel.personnelId}">

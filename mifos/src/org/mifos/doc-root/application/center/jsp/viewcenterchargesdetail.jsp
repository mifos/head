           ...
           <table width="96%" border="0" cellpadding="0" cellspacing="0">
            ...
            <table width="96%" border="0" cellpadding="3" cellspacing="0">
              <tr>
                ...
                <html-el:link href="customerAction.do?method=getAllActivity&type=Center&globalCustNum=${sessionScope.linkValues.globalCustNum}&prdOfferingName=${sessionScope.linkValues.customerName}&input=ViewCenterCharges&globalAccountNum=${param.globalAccountNum}&accountType=${param.accountType}&accountId=${param.accountId}&securityParamInput=Center">

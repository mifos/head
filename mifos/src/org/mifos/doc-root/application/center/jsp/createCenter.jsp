  ...
  //Function to display the fee amount in the text box on the selection of a particualar fee from the combo box
	function displayAmount(listBox, textBox ){
		...
		if(comboBox.selectedIndex==0)
			...
			if (centerActionForm.selectedFeeAmntList[indexSelectedFee]!= undefined){
				//obtaining the fee amount for a particular fee
				var amount=centerActionForm.selectedFeeAmntList[indexSelectedFee].value;
				//assigning the value of the fee amount to the text box
				amountField.value = amount;
			}
			else{			
				amountField.value=centerActionForm.selectedFeeAmntList.value;
			}
								...
								<td align="left" valign="top" class="paddingleftCreates">
									<table width="93%" border="0" cellpadding="3" cellspacing="0">
										<tr>
											<td class="headingorange">
												<c:choose>
													<c:when test="${param.method eq 'previous' and param.input eq 'create'}">

														<span class="heading"> <mifos:mifoslabel name="Center.Manage" bundle="CenterUIResources" /> <mifos:mifoslabel name="${ConfigurationConstants.CENTER}" /><c:out value=" " /> <mifos:mifoslabel name="Center.dash" bundle="CenterUIResources" />
														</span>
									...
									<table width="93%" border="0" cellpadding="3" cellspacing="0">
										<tr>
											<td colspan="2" class="fontnormal">
												...
												<c:out value="${sessionScope.centerActionForm.office.officeName}" />
												<br>
												<br>
											</td>
										</tr>
									...
									<table width="93%" border="0" cellpadding="3" cellspacing="0">
										...
										<tr class="fontnormal">
											...
											<td width="79%">
												<mifos:mifosalphanumtext keyhm="Center.Address1" name="centerActionForm" property="customerAddressDetail.line1" maxlength="200" />
											</td>
										</tr>
										...
										<tr class="fontnormal">
											...
											<td>
												<mifos:mifosalphanumtext keyhm="Center.Address2" name="centerActionForm" property="customerAddressDetail.line2" maxlength="200" />
											</td>
										</tr>
										<!-- Line 3 of address -->
										<tr class="fontnormal">
											...
											<td>
												<mifos:mifosalphanumtext keyhm="Center.Address3" name="centerActionForm" property="customerAddressDetail.line3" maxlength="200" />
											</td>
										</tr>
										<!-- City of address -->
										<tr class="fontnormal">
											...
											<td>
												<mifos:mifosalphanumtext keyhm="Center.City" name="centerActionForm" property="customerAddressDetail.city" maxlength="100" />
											</td>
										</tr>
										<!-- State of address -->
										<tr class="fontnormal">
											...
											<td>
												<mifos:mifosalphanumtext keyhm="Center.State" name="centerActionForm" property="customerAddressDetail.state" maxlength="100" />
											</td>
										</tr>
										<!-- Country of address -->
										<tr class="fontnormal">
											...
											<td>
												<mifos:mifosalphanumtext keyhm="Center.Country" name="centerActionForm" property="customerAddressDetail.country" maxlength="100" />
											</td>
										</tr>
										...
										<tr class="fontnormal">
											...
											<td>
												<mifos:mifosalphanumtext keyhm="Center.PostalCode" name="centerActionForm" property="customerAddressDetail.zip" maxlength="20" />
											</td>
										</tr>
										...
										<tr class="fontnormal">
											...
											<td>
												<mifos:mifosalphanumtext keyhm="Center.PhoneNumber" name="centerActionForm" property="customerAddressDetail.phoneNumber" maxlength="20" />
											</td>
										</tr>
									</table>
									<br>
											...
											<tr class="fontnormal">
												...
												<td width="79%">
													...
													<c:if test="${cf.fieldType == 1}">
														<mifos:mifosnumbertext name="centerActionForm" property='customField[${ctr}].fieldValue' maxlength="200" />
													</c:if>
													<c:if test="${cf.fieldType == 2}">
														<mifos:mifosalphanumtext name="centerActionForm" property='customField[${ctr}].fieldValue' maxlength="200" />
													</c:if>
															...
															<c:choose>
																<c:when test="${adminFees.feeFrequencyTypeId == 1}">
																	<td width="148">
																		...
																		<html-el:hidden property="adminFee[${ctr1}].feeFrequencyTypeId" value="${adminFees.feeFrequencyTypeId}"></html-el:hidden>
																	</td>
																</c:when>
																<c:otherwise>
																	<c:choose>
																		<c:when test="${param.method eq 'load'}">
																			<td width="148">
									...
									<table width="93%" border="0" cellpadding="3" cellspacing="0">
										...
										<c:forEach begin="0" end="2" step="1" varStatus="loopStatus2">
											...
											<td width="17%" class="fontnormal">
												...
												<mifos:select name="centerActionForm" property='selectedFee[${ctr2}].feeId' onchange="displayAmount('selectedFee[${ctr2}].feeId', 'selectedFee[${ctr2}].rateOrAmount' )">

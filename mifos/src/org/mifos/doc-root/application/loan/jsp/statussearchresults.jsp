		...
		<html-el:form action="/ChangeAccountStatus">
			...
			<table width="95%" border="0" cellpadding="0" cellspacing="0" class="paddingleftmain">
				...
				<tr>
					...
					</span> <span class="heading"> <c:out value="Pending Approval" /> </span>
					<br>
					<br></td>
				...
				<tr>
					...
					<table width="95%" border="0" cellpadding="5" cellspacing="0"
						...
						<tr class="bglightblue" valign="middle" height="35">
							<td width="5%" class="drawtablerowboldnolinebg"><input type="checkbox"
								onclick="selectAll(this)" name="selectAll1" /></td>
							...
							<td width="15%" class="drawtablerowboldnolinebg"><b><mifos:mifoslabel
								name="accountStatus.disbursementdate" /></b></td>
						...
						<c:forEach var="loan" items="${sessionScope.searchResults}"
							...
							<tr>
								...
								<td width="15%"  valign="top" class="drawtablerow"><c:out value="${loan.loanAmount}" /></td>
								...
								<b><mifos:mifoslabel name="accountStatus.loanofficer" /></b> <c:out
				...
				<tr>
					...
					<table width="95%" border="0" cellpadding="3" cellspacing="0">
						<tr>
							...
							<td align="left" width="89%" valign="top"><html-el:select property="newStatus" style="width:136px;">
						...
						<tr>
							...
							<td><html-el:textarea style="width:320px; height:110px;" property="comments">
							</html-el:textarea></td>
						</tr>
				...
				<tr>
					...
					<html-el:button property="cancel" styleClass="buttn"
						style="width:65px" onclick="submitData(this.form);" >

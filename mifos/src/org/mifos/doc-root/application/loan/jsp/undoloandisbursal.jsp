 ...
 * undoloandisbursal.jsp    version: 1.0
				...
				<tr>
					<td align="left" valign="top" class="paddingL10">
							...
							<tr>
								<td width="100%" valign="top" class="fontnormal">
									<p>
										...
										<c:out value="${BusinessKey.customer.displayName}"/>: ID <c:out value="${BusinessKey.customer.globalCustNum}"/>
										<br>
						...
						<table width="96%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td align="center">
									<html-el:submit property="previewButton" styleClass="buttn" style="width:70px;">

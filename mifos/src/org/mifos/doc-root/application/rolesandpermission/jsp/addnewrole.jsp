...
<script language="javascript" src="pages/application/rolesandpermission/js/checkBoxLogic.js">
		...
		<html-el:form action="/manageRolesAndPermission.do?method=create" focus="name">
					...
					<table width="95%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td class="bluetablehead05"><span class="fontnormal8pt">
												...
												<html-el:link href="javascript:submitAdminLink()">
								<mifos:mifoslabel
								...
								class="fontnormal8ptbold"> </span><span class="fontnormal8pt">
								 ...
								 <html-el:link href="javascript:submitRolesAndPermissionLink()"
								>

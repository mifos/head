...
<html-el:form action="PersonnelAction.do?method=create" onsubmit="func_disableSubmitBtn('submitBtn')">
      ...
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="bluetableborder">
          <tr>
			...
			<span class="fontnormalbold">
			 ...
			 <span class="fontnormal"><c:out value="${session:getFromSession(sessionScope.flowManager,requestScope.currentFlowKey,'office').officeName}"/>
			 </span>
		</td>
                </tr>
              </table>   
				...
				<span class="fontnormal">
				 ...
				 <tr id="Personnel.GovernmentId">
                  <td class="fontnormalbold">
					...
					<span class="fontnormal">
					  <c:out value="${personActionForm.governmentIdNumber}"/> 
					</span> <br>
				</td>
				</tr>
				 ...
				 <tr>
                  <td   class="fontnormalbold">
					...
					<span class="fontnormal">
					<c:out value="${userdatefn:getUserLocaleDate(sessionScope.UserContext.pereferedLocale,personActionForm.dob)}" />
					<%--<c:out value="${requestScope.PersonnelVO.dob}"/> --%>
					 </span><br>
					</td>
					</tr>
                  ...
                  <td   class="fontnormalbold">
					...
					<span class="fontnormal">
					 	<mifoscustom:lookUpValue id="${personActionForm.maritalStatus}" searchResultName="maritalStatusList"></mifoscustom:lookUpValue> 
					</span><br>
					</td>
					</tr>
				 ...
				 <tr>
                  <td   class="fontnormalbold">
                      <mifos:mifoslabel name="Personnel.Gender" bundle="PersonnelUIResources"></mifos:mifoslabel>
						<span class="fontnormal">
							<mifoscustom:lookUpValue id="${personActionForm.gender}" searchResultName="genderList"></mifoscustom:lookUpValue>
						</span><br>
					</td>
					</tr>
				 ...
				 <tr>
                  <td  class="fontnormalbold">                 
					...
					<span class="fontnormal">
					<c:out value="${userdatefn:getUserLocaleDate(sessionScope.UserContext.pereferedLocale,personActionForm.dateOfJoiningMFI)}" />
						<%--<c:out value="${requestScope.PersonnelVO.dateOfJoiningMFI}"/> --%>
					</span><br>  
					</td>
					</tr>
                  ...
                  <td  class="fontnormalbold">                 
                      <mifos:mifoslabel name="Personnel.DOJBranch"  bundle="PersonnelUIResources"></mifos:mifoslabel>
						<span class="fontnormal">
							<c:out value="${userdatefn:getUserLocaleDate(sessionScope.UserContext.pereferedLocale,personActionForm.dateOfJoiningBranch)}" />			
							<%--<c:out value="${requestScope.PersonnelVO.personnelDetails.dateOfJoiningBranch}"/> --%>
						</span><br> <br>
					</td>
					</tr>
                  ...
                  <td  class="fontnormalbold">
					...
					<br>
					 ...
					 <tr>
						...
						<span class="fontnormal">
						 <c:out value="${rpersonActionForm.city}"/> 
						</span><br>
					</td>
					</tr>
					
					 <tr>
                  <td class="fontnormalbold" id="Personnel.State">
				      <mifos:mifoslabel name="${ConfigurationConstants.STATE}"  bundle="PersonnelUIResources" keyhm="Personnel.State" isColonRequired="yes" isManadatoryIndicationNotRequired="yes"></mifos:mifoslabel>
					<span class="fontnormal">
				 ...
				 <tr id="Personnel.PostalCode">
                  <td  class="fontnormalbold">
				      <mifos:mifoslabel name="${ConfigurationConstants.POSTAL_CODE}" bundle="PersonnelUIResources" keyhm="Personnel.PostalCode" isColonRequired="yes" isManadatoryIndicationNotRequired="yes"></mifos:mifoslabel> 
					<span class="fontnormal">

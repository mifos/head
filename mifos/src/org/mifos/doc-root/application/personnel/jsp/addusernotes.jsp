...
<html-el:form action="PersonnelNotesAction.do?method=preview">
      ...
      <table width="95%" border="0" cellpadding="0" cellspacing="0">
		...
		<mifos:mifoslabel name="Personnel.AddNote" bundle="PersonnelUIResources"></mifos:mifoslabel>
			...
			<mifos:mifoslabel name="Personnel.EnterANote" bundle="PersonnelUIResources"></mifos:mifoslabel>
           ...
           <br>
			...
			<mifos:mifoslabel name="Personnel.Note" bundle="PersonnelUIResources" mandatory="yes"></mifos:mifoslabel>
		</td>
                  <td width="93%" align="left" valign="top">
					<html-el:textarea property="comment" cols="37" style="width:320px; height:110px;">
                  </html-el:textarea>
                  </td>
                </tr>
              </table>

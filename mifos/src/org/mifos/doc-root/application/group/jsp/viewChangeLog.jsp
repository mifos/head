...
<tiles:insert definition=".clientsacclayoutsearchmenu">
	...
	function returnToDetails(){
		groupCustActionForm.action="groupCustAction.do?method=cancelChangeLog";
		groupCustActionForm.submit();
	}
	</script>
		<html-el:form method="post" action="groupCustAction.do">
			...
			<table width="95%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td class="bluetablehead05"><span class="fontnormal8pt">
						<customtags:headerLink selfLink="false" /></span>
					</td>
				</tr>
			</table>
			<table width="95%" border="0" cellpadding="0" cellspacing="0">
					...
					<table width="96%" border="0" cellpadding="3" cellspacing="0">
						...
						<tr>
							<td class="fontnormal"><br>
								<mifos:mifoslabel name="Group.rec_creation_date" />:&nbsp;

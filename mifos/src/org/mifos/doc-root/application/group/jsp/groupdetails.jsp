	                  ...
	                  <c:forEach items="${requestScope.CustomerActiveLoanAccounts}" var="loan">
	                      ...
	                      <td>
	                        ...
	                        <tr>
	                          <td width="65%">
	                          	<span class="fontnormal">
	                          		<html-el:link href="loanAction.do?globalAccountNum=${loan.globalAccountNum}&method=get&recordOfficeId=${param.recordOfficeId}&recordLoanOfficerId=${param.recordLoanOfficerId}">

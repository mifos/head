...
<html-el:form action="/surveyInstanceAction.do?method=dummy_create">
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
	<tr>
		...
		<td width="70%">
		<date:datetag property="dateConducted" renderstyle="simple"/>
		</td>
	</tr>
	<tr>
...
<table width="95%">
	...
	<c:forEach var="question" items="${sessionScope.retrievedSurvey.questions}">
		...
		<tr>
			...
			<html-el:radio property="responses" value="${choice.choiceId}">
			...
			<c:otherwise><html-el:text property="responses"/></c:otherwise>
			</c:choose>
			</td>
		</tr>
		<tr>

          ...
          <td align="left" valign="top" class="paddingL15T15" >              <table width="95%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="83%" class="headingorange"><span class="heading">
               ...
               <mifos:mifoslabel name="Surveys.instance.entersurveydata" bundle="SurveysUIResources"/> </td>
            </tr>
          </table>
            ...
            <table width="95%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                  <br>
                    <span class="fontnormalRedBold"><ul><html-el:errors bundle="SurveysUIResources"/></ul></span>
              ...
              <tr>
                ...
                <td width="71%" class="drawtablerow">
                  <span class="fontnormal8pt">
                    ...
                    <html-el:text property="value(dateSurveyed_DD)" maxlength="2" size="2" style="width:1.5em"/>
                    &nbsp;DD&nbsp;
                    <html-el:text property="value(dateSurveyed_MM)" maxlength="2" size="2" style="width:1.5em"/>
                    &nbsp;MM&nbsp;
                    <html-el:text property="value(dateSurveyed_YY)" maxlength="4" size="4" style="width:3em"/>
                    &nbsp;YYYY&nbsp;
                  </span>
                </td>
              </tr>
                  ...
                  <td height="30" colspan="2" class="drawtablerow">
                    <c:choose>
                      ...
                      <c:when test="${question.question.answerType == 5}"> <!-- date question -->
                        <date:datetag property="response_${question.question.questionId})" renderstyle="simplemapped"/>
                      </c:when>
                      <c:when test="${question.question.answerType == 3}"> <!-- number question -->
                        <html-el:text property="value(response_${question.question.questionId})"/>
                      </c:when>
                    </c:choose>
                  </td>
                </tr>
            ...
            <table width="95%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td>                 
                  <input type="clear" styleClass="insidebuttn">
                    <mifos:mifoslabel name="Surveys.button.editsurvey" bundle="SurveysUIResources" />
                  </input>
                </td>
              </tr>
              -->

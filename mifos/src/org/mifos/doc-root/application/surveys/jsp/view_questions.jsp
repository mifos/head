            ...
            <table width="98%" border="0" cellpadding="3" cellspacing="0">
              ...
              <tr>
                ...
                <td width="53%" class="drawtablerow"><c:choose>
                               ...
                               <c:when test="${question.answerType == 4}"><c:forEach var="choice" items="${question.choices}" varStatus="ptr"><c:out value="${choice.choiceText}"/><c:if test="${not ptr.last}">, </c:if></c:forEach></c:when></c:choose></td>
              </tr>
              </c:forEach>
            </table>
          </td>

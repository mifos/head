							...
							<table width="93%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr id="Office.PostalCode">
									<td class="fontnormalbold"><mifos:mifoslabel name="${ConfigurationConstants.POSTAL_CODE}"
										...
										class="fontnormal"> <c:out
										value="${offActionForm.address.postalCode}"></c:out>
									</span>
								</tr>
								<tr>
									<td class="fontnormalbold"><br><mifos:mifoslabel name="Office.labelTelephone"
										/><span
										class="fontnormal"> <c:out
										value="${offActionForm.address.telephoneNo}"></c:out></span><br>
									<br>
									...
									<!-- custom field preview --> <c:forEach var="cfdef"
										...
										<c:forEach var="cf"
											...
											<c:if test="${cfdef.fieldId==cf.fieldId}">
												...
												<mifos:mifoslabel name="${cfdef.lookUpEntity.entityType}" bundle="OfficeUIResources"></mifos:mifoslabel>:
												</font>

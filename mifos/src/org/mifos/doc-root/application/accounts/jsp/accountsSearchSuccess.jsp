 ...
 * accountsSearchSuccess.jsp    version: 1.0
							...
							<table width="96%" border="0" cellspacing="0" cellpadding="0">
								<tr align="left">
									<td class="fontnormal"><mifos:mifoslabel
										...
										styleId="111" property="searchNode(searchString)" maxlength="200"/> <html-el:hidden
										property="searchNode(search_name)" value="AccountsSearch" />&nbsp;

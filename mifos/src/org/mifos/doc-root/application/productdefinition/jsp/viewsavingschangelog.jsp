 ...
 * viewsavingschangelog.jsp    version: 1.0
 ...
 <table width="95%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td class="bluetablehead05"><span class="fontnormal8pt"> <html-el:link
						...
						href="javascript:fnSearch(savingsprdactionform)">
						<mifos:mifoslabel name="product.viewsavingsprd"
							bundle="ProductDefUIResources" />
...
<c:out value="${userdatefn:getUserLocaleDate(sessionScope.UserContext.pereferedLocale,requestScope.Context.valueObject.createdDate)}" />
            ...
            <br>           
<mifoscustom:mifostabletag moduleName="customer/client" scope="request" source="SavingsChangeLogList" xmlFileName="ClientChangeLog.xml" passLocale="true"/>                        

			...
			<table width="95%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td class="bluetablehead05"><span class="fontnormal8pt"> <html-el:link
						...
						value="${sessionScope.BusinessKey.productCategoryName}" /></span></td>
				</tr>
			</table>
			<table width="95%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<table width="96%" border="0" cellpadding="3" cellspacing="0">
						<tr>
							<td width="50%" height="23" class="headingorange"><c:out
								value="${sessionScope.BusinessKey.productCategoryName}" /></td>
							<td width="50%" align="right"><html-el:link
								href="javascript:fnManage()">
						...
						<tr>
							<td height="23" colspan="2" class="fontnormalbold"><span
								...
								<c:when
									test="${sessionScope.BusinessKey.prdCategoryStatus.id eq 1}">
							...
							<span class="fontnormal"><mifos:mifoslabel
								...
								items="${sessionScope.ProductTypeList}" var="productTypeObject">
								<c:if
									test="${productTypeObject.productTypeID eq sessionScope.BusinessKey.productType.productTypeID}">
							...
							<c:if
								test="${sessionScope.BusinessKey.productCategoryDesc != null && 
								!(sessionScope.BusinessKey.productCategoryDesc eq '')}">
								<mifos:mifoslabel name="product.desc"
									bundle="ProductDefUIResources" />
								<span class="fontnormal"><br>
								</span>
								<span class="fontnormal"> <c:out
									value="${sessionScope.BusinessKey.productCategoryDesc}" /> </span>
								<span class="fontnormal"><br>

							...
							<table width="93%" border="0" cellpadding="3" cellspacing="0">
								...
								<tr class="fontnormal">
									<td width="20%" align="right"><mifos:mifoslabel
										...
										bundle="ProductDefUIResources" />:</td>
									<td width="80%"><mifos:select name="mifosproddefactionform"
										property="productType.productTypeID" style="width:136px;">
										<html-el:options property="id" labelProperty="name"
								...
								<html-el:hidden property="prdCategoryStatus.prdCategoryStatusId"
									value="1" />
							</table>

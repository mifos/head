			...
			<table width="95%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<table width="96%" border="0" cellpadding="3" cellspacing="0">
						...
						<c:if test="${!empty requestScope.ClosedAccountsList}">
							<tr class="fontnormal">
								<td height="30"><span class="heading"> <mifos:mifoslabel
									name="${ConfigurationConstants.LOAN}" /> </span></td>
							</tr>
						</c:if>
						<c:forEach items="${requestScope.ClosedAccountsList}"
							var="closedAccount">
							<tr class="fontnormal">
								...
								<table width="90%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="50%"><span class="fontnormal"> <html-el:link
													href="loanAction.do?method=get&globalAccountNum=${closedAccount.globalAccountNum}">
													<c:out
												...
												<td width="50%"><span class="fontnormal"> <img
													...
													width="8" height="9"> <mifoscustom:lookUpValue
													id="${closedAccount.accountStateId}"
													searchResultName="ClosedAccSearchStatusList"
										...
										<mifos:mifoslabel name="client.date"
											bundle="ClientUIResources" /> <mifoscustom:lookUpValue
											id="${closedAccount.accountStateId}"
											searchResultName="ClosedAccSearchStatusList"
											mapToSeperateMasterTable="true">
										</mifoscustom:lookUpValue>:&nbsp; <c:out
						...
						<c:forEach items="${requestScope.ClosedSavingsAccountsList}"
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="50%"><span class="fontnormal"> <img
													...
													value="${closedSavingsAccount.accountState.name}" /> </span></td>
											</tr>
										</table>
					...
					<c:if
						test="${!empty requestScope.ClosedSavingsAccountsList || !empty requestScope.ClosedAccountsList}">

				...
				<table width="98%" border="0" cellspacing="0" cellpadding="3">
					...
					<tr>
						...
						<span class="fontnormal"> <c:out
							...
							value="${requestScope.clientVO.globalCustNum}" /> <span
							class="fontnormal"><br>
						...
						<c:if test="${requestScope.clientVO.statusId == 3}">
							...
							<br>
						</c:if> <!-- Link to create a new group --> <a
							href="GroupAction.do?method=hierarchyCheck&office.officeId=<c:out value="${requestScope.clientVO.office.officeId}"/>">
						<mifos:mifoslabel name="client.CreateNewClientLink"
							bundle="ClientUIResources" /> <mifos:mifoslabel

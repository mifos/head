...
<tiles:insert definition=".detailsCustomer">
   ...
   function goToCancelPage(){
	...
	clientTransferActionForm.submit();
		...
		<html-el:form action="clientTransferAction.do?method=updateBranch"
				...
				<tr>
					...
					<table width="96%" border="0" cellpadding="3" cellspacing="0">
						<tr>
							...
							</span>Edit Branch Membership: <span class="fontnormal"><c:out
								value="${requestScope.clientTransferVO.office.officeName}" /> <br>
							</span></td>
						</tr>
					</table>

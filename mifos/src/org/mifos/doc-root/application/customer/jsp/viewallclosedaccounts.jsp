			...
			<table width="95%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<table width="96%" border="0" cellpadding="3" cellspacing="0">
						...
						<c:if test="${!empty sessionScope.ClosedLoanAccountsList}">
							<tr class="fontnormal">
								<td height="30"><span class="heading"> <mifos:mifoslabel
									name="${ConfigurationConstants.LOAN}" /> </span></td>
							</tr>
						</c:if>
						<c:forEach items="${sessionScope.ClosedLoanAccountsList}"
							var="closedAccount">
							<tr class="fontnormal">
								...
								<table width="90%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="50%"><span class="fontnormal"> <img
													...
													width="8" height="9"><c:out value="${closedAccount.accountState.name}" />
										...
										<mifos:mifoslabel name="client.date"
											bundle="ClientUIResources" />&nbsp;<c:out value="${closedAccount.accountState.name}" />:&nbsp; <c:out
						...
						<c:if test="${!empty sessionScope.ClosedSavingsAccountsList}">
							<tr class="fontnormal">
								<td height="30"><span class="heading"> <mifos:mifoslabel
									name="${ConfigurationConstants.SAVINGS}" /> </span></td>
							</tr>
						</c:if>
						<c:forEach items="${sessionScope.ClosedSavingsAccountsList}"
					...
					<c:if
						test="${!empty sessionScope.ClosedSavingsAccountsList || !empty sessionScope.ClosedLoanAccountsList}">
					...
					<html-el:form action="${formAction}" >
						<table width="96%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td align="center"><html-el:submit property="cancel"

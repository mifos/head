				...
				<tr>
					<td class="bluetablehead05">
						<span class="fontnormal8pt">
	          				...
	          				<!-- <html-el:link
						action="centerAction.do?method=get&globalAccountNum=${sessionScope.editCustomerStatusActionForm.globalAccountNum}">
						<c:out value="${sessionScope.editCustomerStatusActionForm.customerName}" />
					</html-el:link> -->
	        			</span>
					</td>
				</tr>
						...
						<tr>
							...
							<table width="95%" border="0" cellpadding="0" cellspacing="0">
								...
								<c:forEach var="status" items="${sessionScope.statusList}">
									<c:if test="${status.id == '5' || status.id == '6' ||status.id == '11' || status.id == '12'}">
										<tr class="fontnormal">
											<td align="center">&nbsp;</td>

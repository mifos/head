...
<tiles:insert definition=".clientsacclayoutsearchmenu">
  ...
  function goToCancelPage(){
	custHistoricalDataActionForm.action="custHistoricalDataAction.do?method=get";
	custHistoricalDataActionForm.submit();
  }
  function goToEditPage(){
	custHistoricalDataActionForm.action="custHistoricalDataAction.do?method=previous";
	custHistoricalDataActionForm.submit();
  }
  
 </script>

		<html-el:form action="custHistoricalDataAction.do?method=update"

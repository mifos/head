...
public class GLAccount {
	...
	public boolean equals(Object obj) {
		...
		if (other.glCode.equals(glCode)
				&& other.name.equals(name)
				&& (null == other.parentGlCode ? null == parentGlCode
						: other.parentGlCode.equals(parentGlCode)))
			return true;
	 ...
	 * Slightly simplified since we assume {@link #glCode} and {@link #name} are
	 * never null (a requirement for users of this class). The
	 * <code>hashCode</code> method generated by an IDE like Eclipse is
	 * arguably more generic, predictable, recognizable and maintainable; but
	 * this handwritten version works, too.
	 */
	@Override
	public int hashCode() {
		return glCode.hashCode() + name.hashCode()
				+ (null == parentGlCode ? 0 : parentGlCode.hashCode());
	}

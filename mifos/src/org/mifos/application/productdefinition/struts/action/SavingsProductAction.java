 ...
 * SavingsProductAction.java    version: xxx
...
import org.mifos.application.productdefinition.struts.actionforms.SavingsProductActionForm;
...
public class SavingsProductAction extends MifosBaseAction {
	...
	protected String getPath() {
		return ProductDefinitionConstants.GETPATHSAVINGSPRODUCT;
	}
	...
	public ActionForward customLoad(ActionMapping mapping,
		...
		request.getSession().setAttribute(ProductDefinitionConstants.SAVINGSPRDACTIONFORM, null);
		prdDefLogger.debug("Inside custom Load method of SavingsProductAction");
	...
	public ActionForward cancel(ActionMapping mapping,
			...
			HttpServletRequest request,
			HttpServletResponse response)throws Exception {
		prdDefLogger.debug("Inside cancel method of SavingsProductAction");
		request.getSession().setAttribute(ProductDefinitionConstants.SAVINGSPRDACTIONFORM, null);
	 ...
	 * which indicates the flow so that it can be determined wheteher we are creating or updating the savings product.
	...
	public ActionForward customPreview(ActionMapping mapping,
			...
			HttpServletRequest request,
			HttpServletResponse response)throws Exception {
		prdDefLogger.debug("Inside Custom Preview method of SavingsProductAction");
		String input = request.getParameter(ProductDefinitionConstants.INPUT);
		if (input.equals(ProductDefinitionConstants.INPUTDETAILS)) {
	...
	public ActionForward customPrevious(ActionMapping mapping,
			...
			HttpServletRequest request,
			HttpServletResponse response)throws Exception {
		prdDefLogger.debug("Inside custom Previous method of SavingsProductAction");
		String input = request.getParameter(ProductDefinitionConstants.INPUT);
		if (input.equals(ProductDefinitionConstants.INPUTDETAILS)) {
	...
	public ActionForward customCreate(ActionMapping mapping,
			...
			HttpServletRequest request,
			HttpServletResponse response)throws Exception {
		prdDefLogger.debug("Inside custom Create method of SavingsProductAction");
	...
	public ActionForward customGet(ActionMapping mapping,
			...
			HttpServletRequest request,
			HttpServletResponse response)throws Exception {
		prdDefLogger.debug("Inside custom get method of SavingsProductAction");
		request.getSession().setAttribute(ProductDefinitionConstants.SAVINGSPRDACTIONFORM, null);
	...
	public ActionForward customSearch(ActionMapping mapping,
			...
			HttpServletRequest request,
			HttpServletResponse response)throws Exception {
		prdDefLogger.debug("Inside custom Search method of SavingsProductAction");
		SavingsProductActionForm savingsProductActionForm=(SavingsProductActionForm)form;
		String input=savingsProductActionForm.getInput();
	...
	public ActionForward customManage(ActionMapping mapping,
			...
			HttpServletRequest request,
			HttpServletResponse response)throws Exception {
		prdDefLogger.debug("Inside custom Manage method of SavingsProductAction");
	...
	public ActionForward customUpdate(ActionMapping mapping,
			...
			HttpServletRequest request,
			HttpServletResponse response)throws Exception {
		prdDefLogger.debug("Inside custom Update method of SavingsProductAction");
	...
	public ActionForward customValidate(ActionMapping mapping, ActionForm form,
		...
		String input = ((SavingsProductActionForm) form).getInput();
		String forward = null;

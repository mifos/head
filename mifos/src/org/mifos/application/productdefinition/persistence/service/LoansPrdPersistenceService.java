 ...
 * LoansPrdPersistenceService.java    version: 1.0
...
public class LoansPrdPersistenceService extends PersistenceService{
	
	private LoansPrdPersistence serviceImpl = new LoansPrdPersistence();
	
		public Short retrieveLatenessForPrd()throws PersistenceException{
		return serviceImpl.retrieveLatenessForPrd();
	}
}

...
public class IdGenerator {
	 ...
	 * A global customer number is generated from the office global customer number and the current 
	 * max customerId in that office. EG: if the office global customer number is BRANCH01 
	 * and max id of customers in that branch is 14 then the new id generated will be BRANCH01-000000015
	 *  
	 * @param officeGlobalNum Global customer number for the office of the customer
	 * @param customerLevelId Level of the customer
	 * @param maxCustomerCount Number of customers in that branch till now
	...
	/** ADDED TO TEST GLOBAL ID GENERATION
	 * This method is used to generate the global customer number for a particular customer. 
	 * A global customer number is generated from the office global customer number and the current 
	 * max customerId in that office. EG: if the office global customer number is BRANCH01 
	 * and max id of customers in that branch is 14 then the new id generated will be BRANCH01-000000015

...
public interface CenterConstants {
	...
	/**Refers to the category id which indicates a particular fee is applicable to all customers*/
	short ALL_CATEGORY_ID = 1;
	/**Refers to the category id which indicates a particular fee is applicable to all centers*/

...
public class PenaltyAccountingEntry extends BaseAccountingEntry {
	...
	protected void getSpecificAccountActionEntry() throws FinancialException {
		...
		if(financialActivity.getAccountTrxn().getAccount().getAccountType().getAccountTypeId().equals(AccountType.LOANACCOUNT.getValue())) 
			amount = ((LoanTrxnDetailEntity) financialActivity.getAccountTrxn()).getMiscPenaltyAmount();
		else if(financialActivity.getAccountTrxn().getAccount().getAccountType().getAccountTypeId().equals(AccountType.CUSTOMERACCOUNT.getValue()))

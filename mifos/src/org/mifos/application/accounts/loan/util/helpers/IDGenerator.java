...
public class IDGenerator {
	 ...
	 *  
	 */
	 public static  String generateIdForLoan(String officeGlobalNum)throws ApplicationException {
		...
		try {
			loanAccountSysID.append(StringUtils.lpad(getLoanAccountRunningNumber().toString(),'0',11) );
	 ...
	 */
	private static Integer getLoanAccountRunningNumber()throws SystemException{

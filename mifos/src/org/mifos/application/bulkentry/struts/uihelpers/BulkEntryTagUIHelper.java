 ...
 * BulkEntryTagUIHelper.java    version: 1.0
...
public class BulkEntryTagUIHelper {
	...
	public void generateStartTD(StringBuilder builder, Object value,
			boolean isStyleClass) {
	...
	public void generateHiddenInput(StringBuilder builder, String name,
			Object value) {
	...
	public void generateTextInput(StringBuilder builder, String name,
			Object value) {
		builder.append("<input type=\"text\"");
		builder.append("name=\"" + name + "\"");
		builder.append(" value=\"" + value + "\"");
		builder.append(" size=\"6\" style=\"width:40px\" "
				+ "class=\"fontnormal8pt\">");
	}

	public void generateTextInput(StringBuilder builder, String name,
			Object value, int rows, int columns, int size, int initialAccNo,
			int centerTotalCount, int loanProductSize, int savingsProductSize) {
		builder.append("<input type=\"text\"");
		builder.append("name=\"" + name + "\"");
		builder.append(" value=\"" + value + "\"");
		...
		builder.append(")\"");
		builder
				.append("onblur=\"if( false == doValidation(this,null)) this.focus();else ");
		builder.append("checkTotalForCenter(");
		builder.append(rows);
		builder.append("," + columns + "," + size + "," + initialAccNo + ","
				+ centerTotalCount + "," + loanProductSize + ","
				+ savingsProductSize + ")\"");
		builder.append(" size=\"6\" style=\"width:40px\" "
				+ "class=\"fontnormal8pt\">");
	}
	...
	public void generateTextInput(StringBuilder builder, String name,
			Object value, int columns, int size, int loanProductSize,
		...
		builder.append("," + size + "," + loanProductSize + ","
				+ savingsProductSize + ")\"");
		builder.append(" size=\"6\" style=\"width:40px\" "
				+ "class=\"fontnormal8pt\">");
	}

	public void generateSavingsTextInput(StringBuilder builder, String name,
			Object value, int rows, int columns, int size, int initialAccNo,
			int loanProductsSize, int savingsProductsSize, int depWithFalg,
		...
		builder.append(rows);
		builder.append("," + columns + "," + size + "," + initialAccNo + ","
				+ loanProductsSize + "," + savingsProductsSize + ","
	...
	public void generateSavingsTextInput(StringBuilder builder, String name,
			Object value, int columns, int size, int depWithFlag,
		...
		builder.append(columns);
		builder.append("," + size + "," + depWithFlag + "," + loanProductSize
				+ "," + savingsProductSize + ")\"");
		builder.append(" size=\"6\" style=\"width:40px\" "
				+ "class=\"fontnormal8pt\">");
	}

	public void generateCustomerAccountTextInput(StringBuilder builder,
			String name, Object value, int rows, int columns, int size,
	...
	public void generateCustomerAccountTextInput(StringBuilder builder,
			String name, Object value, int columns, int size,
			int loanProductSize, int savingsProductSize) {
		builder.append("<input type=\"text\"");
		builder.append("name=\"" + name + "\"");
		builder.append(" value=\"" + value + "\"");

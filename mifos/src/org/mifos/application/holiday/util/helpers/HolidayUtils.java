...
public class HolidayUtils {
	...
	public static Calendar adjustDate(Calendar day, MeetingBO meeting)
	...
	private static Calendar adjustDateUsingRepaymentRule(Short repaymentRuleId,
			Calendar adjustedDate, MeetingBO meeting) throws MeetingException {
		if (NEXT_WORKING_DAY.getValue().equals(repaymentRuleId)) {
			...
			Date nextDate = meeting
					.getNextScheduleDateAfterRecurrenceWithoutAdjustment(adjustedDate
							.getTime());
	...
	private static List<HolidayBO> getAllHolidaysInCurrentAndNextYears(

 ...
 * CollSheetCustBO.java    version: 1.0
...
public class CollSheetCustBO extends BusinessObject {
	...
	/**
	 * This method populates customer details from the passed in customer object.
	 */
	...
	public void setCollectionSheetLoanDetails(
			Set<CollSheetLnDetailsEntity> collectionSheetLoanDetailsSet) {
	...
	public void setCollSheetSavingsDetails(
			Set<CollSheetSavingsDetailsEntity> collSheetSavingsDetails) {
		this.collSheetSavingsDetails = collSheetSavingsDetails;
	}
	
	/**
	 * This method adds the passed collectionSheetSavingsDetail object to the collectionSheetSavingsDetail Set.
	 * It also sets the bidirectional relationship.
	 */
	public void addCollectionSheetSavingsDetail(CollSheetSavingsDetailsEntity collectionSheetSavingsDetail) {
		...
		this.collectiveSavingsAmntDue = new Money().add(collectiveSavingsAmntDue).add(collectionSheetSavingsDetail.getRecommendedAmntDue()).add( collectionSheetSavingsDetail.getAmntOverDue())  ;
	...
	public void addCollectiveTotalsForChild(CollSheetCustBO collSheetCustomer) {
		this.collectiveAccntCharges = new Money().add(collectiveAccntCharges).add( collSheetCustomer.getCollectiveAccntCharges());
		this.collectiveLoanAmntDue = new Money().add(collectiveLoanAmntDue).add( collSheetCustomer.getCollectiveLoanAmntDue());
		this.collectiveLoanDisbursal = new Money().add(collectiveLoanDisbursal).add(collSheetCustomer.getCollectiveLoanDisbursal());
		this.collectiveNetCashIn = new Money().add(collectiveNetCashIn).add(collSheetCustomer.getCollectiveNetCashIn());
		this.collectiveSavingsAmntDue = new Money().add(collectiveSavingsAmntDue).add(collSheetCustomer.getCollectiveSavingsAmntDue());
		this.collectiveTotalCollection = new Money().add(collectiveTotalCollection).add( collSheetCustomer.getCollectiveTotalCollection());

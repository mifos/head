...
public class QueryFactory
{
    ...
    public static QueryResult getQueryResult(String searchName)
    {
    	...
    	else if(searchName.equals(PersonnelConstants.USER_LIST) || searchName.equals(CustomerSearchConstants.CENTERSEARCH) ||  searchName.equals(CustomerSearchConstants.GROUPLIST) ||  searchName.equals(CustomerSearchConstants.ACCOUNTSEARCHRESULTS) || searchName.equals(CustomerSearchConstants.CUSTOMERSFORSAVINGSACCOUNT))
    	{

  ...
  public  Object buildDTO(Object[] dtoData) throws HibernateSearchException
  {
 	...
 	Method[] method;
	  ...
	  try
	  {
	   ...
	   method = dtoObject.getClass().getMethods();
                                 ...
                                 if(dataType.equals("integer") )
                                      params[0] = Integer.TYPE;
                                              ...
                                              params[0] = Double.TYPE;
                                                ...
                                                params[0] = new java.sql.Timestamp(System.currentTimeMillis()).getClass();
								 else if(dataType.equals("TIME"))
                                                params[0] = new java.sql.Time(System.currentTimeMillis()).getClass();
                                else
                          			return null;
                   }
                   catch(Exception e)

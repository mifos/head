...
public class HibernateStartUp
{
	/**
		...
		database
		connectivity. This method internally calls 
		{@link ConfigureSession#configure(String)}
		to get hibernate configuration object. 
		It then sets the hibernate configuration to hibernate session 
		factory from which hibernate session
		are obtained
	 */
	public static void initialize(String hibernatePropertiesPath)
		...
		try {
			...
			throw new HibernateStartUpException(
				HibernateConstants.STARTUPEXCEPTION, e);
		}
	}

...
public class MifosListBox extends BodyTagSupport {
	 ...
	 * @param usercontext. It sets the userContext 
	 */
	 ...
	 * @param width. Set the width of the listbox by user
	 */
    ...
    public int doEndTag() throws JspException {
        ...
        /*
         *todo -- rightnow we are taking hardcoded value
         *        we can use UserContext object to get mifos_locale
         */
        
        //String mifos_locale=((UserContext)pageContext.getSession().getAttribute("userContext")).getLocale();
        //String mifos_locale=(String)pageContext.getServletContext().getInitParameter(mifosLocale);
        
        String mifos_locale= "en";
        TagUtils.getInstance().write(pageContext,"<link rel=\"stylesheet\" type=\"text/css\" href=\"pages/framework/css/special_"+mifos_locale+".css\"/>");

        results.append(" <ul class=\"special_en\" style=\"" +
    ...
    /**
     * a helper method in the bean which directs 
     * the href as to where the code should go
     * 
     * @param text   inputList item
     * 
    ...
    
    {
    	...
    	buff.append((obj.getClass().getDeclaredMethod("BuildLink",new Class[]{String.class})).invoke(obj,new Object[]{text}));
    	}

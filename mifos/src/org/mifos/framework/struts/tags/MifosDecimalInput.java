 ...
 * MifosDecimalInput.java    version: 1
...
public class MifosDecimalInput extends ELTextTag {
    ...
    /**
     * This will hold the decimal format tag user want to decimal tag to have
     */
    private String decimalFmt;
    /**
     * This would hold the max value decimal tag can hold
     */
    private String max;
    /**
     * This would hold the min value decimal tag can hold
     */
    private String min;
    /**************************constructor********************************/
    /**

...
public class RepaymentScheduleInstallment
{
	...
	// This field has been added to display the date in the user locale on the ui
	...
	public String getDueDateInUserLocale(){
		//return DateHelper.getUserLocaleDate(getLocale(), new java.util.Date(getDueDate().getYear(),getDueDate().getMonth(),getDueDate().getDate()).toString());

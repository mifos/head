...
public class Column {
  ...
  public void getColumnHeader(StringBuilder tableInfo){
	  ...
	  if(getLabel().replaceAll("","").equals("") || getLabel()==null )
		  ...
		  tableInfo.append("<b>"+getLabel()+"</b>");
	  tableInfo.append("</td>");
  }

  public void generateTableColumn(StringBuilder tableInfo,Object obj,Locale locale,Locale prefferedLocale,Locale mfiLocale) throws TableTagParseException{
  ...
  public void getTableColumn(StringBuilder tableInfo,Object obj,Locale locale,Locale prefferedLocale,Locale mfiLocale) throws TableTagParseException{
   ...
   public void getTableColumnWithLink(StringBuilder tableInfo,Object obj,Locale locale,Locale prefferedLocale,Locale mfiLocale) throws TableTagParseException{
	  tableInfo.append("<a " );

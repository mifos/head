 ...
 * MenuRepository.java    version: 1.0
...
public class MenuRepository {
	/** crudeMenuList is an array of Menu objects that are not mapped to locale specific resources 
	 */	
	private Menu[] crudeMenuList=null;
	
	/** localeMenuMap stores menus of locale and acts as a repository that can return Menu Objects when locale is given as key.
	 */	
	...
	/**
	 * Method to construct MenuRepository instance.
	 * This is a private constructor to implement singleton.
	 */	
	 ...
	 * @param crudeMenuList is an array of crude Menu objects.
	 */
	 ...
	 * @param menuTabName is the topMenuTab name whose left menu is to be obtained.
	 ...
	 * @param lc is locale for which menu is to be find in repository.
	 ...
	 * @param localeMenu is an array of menus for a locale
	 * @param lc is locale for which menus is to be set.
	 */
	 ...
	 * @param topTabName is the name of top menu tab.
	 * @param lc is locale for which menus is to be find.

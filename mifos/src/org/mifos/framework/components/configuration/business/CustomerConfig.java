...
/**
 * This class defines methods that tells configuration details about Customer
 * (Center/Group/Client). It has specific methods for specific type of
 * configuration items related to Customer.
 * <p>

...
public interface OfficeConfigConstants {
	public static final  String NAME_SEQUENCE="NameSequence";
	public static final  String BACK_DATED_TRXN_ALLOWED="BackDatedTrxnAllowed";
	...
	//kim public static final  String NO_OF_INTEREST_DAYS="NoOfInterestDays";

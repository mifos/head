 ...
 *  Class contains functions to enable the logger to log to a database. This 
 *  extend from the JDBCAppender provided by log4J 
 */
public class MifosJDBCAppender extends JDBCAppender {
	
	/**This is the marker defining the statement, containing the logged user within the log statement*/

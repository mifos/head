...
public class ActivityMapper {
	...
	private ActivityMapper() {
		...
		activityMap.put("/manageRolesAndPermission-manage",SecurityConstants.VIEW);
		activityMap.put("/manageRolesAndPermission-get",SecurityConstants.VIEW);
		activityMap.put("/manageRolesAndPermission-load",SecurityConstants.ROLES_CREATE_ROLES);
		activityMap.put("/manageRolesAndPermission-create",SecurityConstants.ROLES_CREATE_ROLES);
		activityMap.put("/manageRolesAndPermission-update",SecurityConstants.ROLES_EDIT_ROLES);
		activityMap.put("/manageRolesAndPermission-cancel",SecurityConstants.VIEW);
		activityMap.put("/manageRolesAndPermission-preview",SecurityConstants.ROLES_DELETE_ROLES);
		...
		activityMap.put("/GroupAction-loadMeeting",SecurityConstants.MEETING_CREATE_GROUP_MEETING);
		activityMap.put("/GroupAction-setDefaultFormedByPersonnel",SecurityConstants.VIEW);
		...
		activityMap.put("/GroupAction-manage",SecurityConstants.GROUP_EDIT_GROUP);
		activityMap.put("/GroupAction-update",SecurityConstants.GROUP_EDIT_GROUP);
		
		//activities related to change center membership for Group Module
		activityMap.put("/GroupAction-loadParentTransfer",SecurityConstants.GROUP_CHANGE_CENTER_MEMBERSHIP);
		activityMap.put("/GroupAction-confirmParentTransfer",SecurityConstants.GROUP_CHANGE_CENTER_MEMBERSHIP);
		activityMap.put("/GroupAction-updateParent",SecurityConstants.GROUP_CHANGE_CENTER_MEMBERSHIP);
		...
		activityMap.put("/GroupAction-loadTransfer",SecurityConstants.GROUP_TRANSFER_THE_GROUP);
		activityMap.put("/GroupAction-confirmBranchTransfer",SecurityConstants.GROUP_TRANSFER_THE_GROUP);
		activityMap.put("/GroupAction-updateBranch",SecurityConstants.GROUP_TRANSFER_THE_GROUP);
		//apply charges
		activityMap.put("/closedaccsearchaction-search",SecurityConstants.GROUP_APPLY_CHARGES_TO_GROUP_ACCOUNT);
		...
		//mapping for group 
		activityMap.put("/CustomerNoteAction-load-Group",SecurityConstants.GROUP_ADD_NOTE_TO_GROUP);
		activityMap.put("/CustomerNoteAction-load-Client",SecurityConstants.CLIENT_ADD_NOTE_TO_CLIENT);
		activityMap.put("/CustomerNoteAction-load-Center",SecurityConstants.CENTER_ADD_NOTE_TO_CENTER);

		
		
		//Customer Historical Data related mapping
		activityMap.put("/CustomerHistoricalDataAction-load-Group",SecurityConstants.GROUP_ADD_EDIT_HISTORICAL_DATA);
		activityMap.put("/CustomerHistoricalDataAction-load-Client",SecurityConstants.CIENT_ADD_EDIT_HISTORICAL_DATA);
		activityMap.put("/CustomerHistoricalDataAction-get",SecurityConstants.VIEW);
		activityMap.put("/CustomerHistoricalDataAction-preview",SecurityConstants.VIEW);
		activityMap.put("/CustomerHistoricalDataAction-previous",SecurityConstants.VIEW);
		activityMap.put("/CustomerHistoricalDataAction-update",SecurityConstants.VIEW);
		
		
		
		//personnel related mappings 
		activityMap.put("/PersonnelAction-chooseOffice",SecurityConstants.PERSONNEL_CREATE_PERSONNEL);
		activityMap.put("/PersonnelAction-load",SecurityConstants.PERSONNEL_CREATE_PERSONNEL);
		...
		activityMap.put("/PersonnelAction-create",SecurityConstants.PERSONNEL_CREATE_PERSONNEL);
		
		activityMap.put("/PersonnelAction-get",SecurityConstants.VIEW);
		activityMap.put("/PersonnelAction-manage",SecurityConstants.PERSONNEL_EDIT_PERSONNEL);
		activityMap.put("/PersonnelAction-update",SecurityConstants.PERSONNEL_EDIT_PERSONNEL);
		...
		activityMap.put("/PersonnelAction-loadUnLockUser",SecurityConstants.PERSONNEL_UNLOCK_PERSONNEL);
		activityMap.put("/PersonnelAction-unLockUserAccount",SecurityConstants.PERSONNEL_UNLOCK_PERSONNEL);
		
		//for your settings link
		activityMap.put("/PersonnelAction-getDetails",SecurityConstants.VIEW);
		activityMap.put("/PersonnelAction-editPersonalInfo",SecurityConstants.PERSONNEL_EDIT_SELF_INFO);
		activityMap.put("/PersonnelAction-previewPersonalInfo",SecurityConstants.VIEW);
		activityMap.put("/PersonnelAction-prevPersonalInfo",SecurityConstants.VIEW);
		activityMap.put("/PersonnelAction-updateSettings",SecurityConstants.PERSONNEL_EDIT_SELF_INFO);
		activityMap.put("/PersonnelAction-loadChangePassword",SecurityConstants.PERSONNEL_EDIT_SELF_INFO);
		activityMap.put("/PersonnelNotesAction-load",SecurityConstants.PERSONNEL_EDIT_PERSONNEL);
		activityMap.put("/PersonnelNotesAction-preview",SecurityConstants.VIEW);
		activityMap.put("/PersonnelNotesAction-previous",SecurityConstants.VIEW);
		activityMap.put("/PersonnelNotesAction-create",SecurityConstants.PERSONNEL_EDIT_PERSONNEL);
		...
		activityMap.put("/centerAction-chooseOffice",SecurityConstants.CENTER_CREATE_NEW_CENTER);
		activityMap.put("/centerAction-load",SecurityConstants.CENTER_CREATE_NEW_CENTER);
		activityMap.put("/centerAction-loadMeeting-CenterCreate",SecurityConstants.MEETING_CREATE_CENTER_MEETING);
		activityMap.put("/centerAction-loadMeeting-Center",SecurityConstants.MEETING_UPDATE_CENTER_MEETING);

		
		activityMap.put("/centerAction-getDetails",SecurityConstants.VIEW);
		activityMap.put("/centerAction-get",SecurityConstants.VIEW);
		activityMap.put("/centerAction-loadStatus",SecurityConstants.CENTER_EDIT_STATUS);
		...
		activityMap.put("/centerAction-create",SecurityConstants.CENTER_CREATE_NEW_CENTER);
		activityMap.put("/centerAction-update",SecurityConstants.CENTER_MODIFY_CENTER_INFORMATION_AND_CHANGE_CENTER_STATUS);
		...
		activityMap.put("/closedaccsearchaction-search",SecurityConstants.VIEW);
...
//		activityMap.put("/CustomerSearchAction-validate",SecurityConstants.VIEW);
		...
		activityMap.put("/clientCreationAction-preLoad",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-load",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-chooseOffice",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-setDefaultFormedByPersonnel",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-next",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-preview",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-prevPersonalInfo",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-prevMFIInfo",SecurityConstants.VIEW);
		...
		activityMap.put("/clientCreationAction-getDetails",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-loadStatus",SecurityConstants.VIEW );
		activityMap.put("/clientCreationAction-loadTransfer",SecurityConstants.CIENT_CHANGE_GROUP_MEMBERSHIP );
		activityMap.put("/clientCreationAction-loadBranchTransfer",SecurityConstants.CIENT_TRANSFER_THE_CLIENT );
		activityMap.put("/clientCreationAction-editMFIInfo",SecurityConstants.CIENT_EDIT_PERSONNEL_ANDMFI_INFORMATION );
		activityMap.put("/clientCreationAction-editPersonalInfo",SecurityConstants.CIENT_EDIT_PERSONNEL_ANDMFI_INFORMATION );
		activityMap.put("/clientCreationAction-update",SecurityConstants.CIENT_EDIT_PERSONNEL_ANDMFI_INFORMATION );
		activityMap.put("/clientCreationAction-updateMfi",SecurityConstants.CIENT_EDIT_PERSONNEL_ANDMFI_INFORMATION );
		
		activityMap.put("/clientCreationAction-loadMeeting-ClientCreate",SecurityConstants.MEETING_CREATE_CLIENT_MEETING);
		activityMap.put("/clientCreationAction-loadMeeting-Client",SecurityConstants.MEETING_UPDATE_CLIENT_MEETING);
		
		activityMap.put("/clientCreationAction-previous",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-retrievePictureOnPreview",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-retrievePicture",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-showPicture",SecurityConstants.VIEW);
		activityMap.put("/clientCreationAction-loadHistoricalData",SecurityConstants.CUSTOMER_ADD_HISTORICAL_DATA_TO_CENTER_GROUP_CLIENT);
		...
		activityMap.put("/clientTransferAction-loadGroupTransfer",SecurityConstants.VIEW);
		activityMap.put("/clientTransferAction-loadTransfer",SecurityConstants.VIEW);
		activityMap.put("/clientTransferAction-confirmBranchTransfer",SecurityConstants.VIEW);
		activityMap.put("/clientTransferAction-confirmGroupTransfer",SecurityConstants.VIEW);
		activityMap.put("/clientTransferAction-update",SecurityConstants.CIENT_CHANGE_GROUP_MEMBERSHIP );
		activityMap.put("/clientTransferAction-updateBranch",SecurityConstants.CIENT_TRANSFER_THE_CLIENT );
		
		//meeting action 
		activityMap.put("/MeetingAction-load",SecurityConstants.VIEW);
		activityMap.put("/MeetingAction-loadMeeting-Group",SecurityConstants.MEETING_UPDATE_GROUP_MEETING);
		activityMap.put("/MeetingAction-loadMeeting-Client",SecurityConstants.MEETING_UPDATE_CLIENT_MEETING);
		activityMap.put("/MeetingAction-create",SecurityConstants.VIEW);
		activityMap.put("/MeetingAction-get-Group",SecurityConstants.MEETING_UPDATE_GROUP_MEETING);
		activityMap.put("/MeetingAction-get-Client",SecurityConstants.MEETING_UPDATE_CLIENT_MEETING);
		activityMap.put("/MeetingAction-get-Center",SecurityConstants.MEETING_UPDATE_CENTER_MEETING);
       ...
       //product categories mapping		
		...
		activityMap.put("/mifosproddefaction-load",SecurityConstants.DEFINE_NEW_PRODUCT_CATEGORIES);
		activityMap.put("/mifosproddefaction-preview",SecurityConstants.VIEW);
		activityMap.put("/mifosproddefaction-create",SecurityConstants.DEFINE_NEW_PRODUCT_CATEGORIES);
		...
		activityMap.put("/mifosproddefaction-manage",SecurityConstants.EDIT_PRODUCT_CATEGORIES);
		activityMap.put("/mifosproddefaction-update",SecurityConstants.EDIT_PRODUCT_CATEGORIES);
		...
		activityMap.put("/prdconfigurationaction-search",SecurityConstants.VIEW);
		activityMap.put("/prdconfigurationaction-update",SecurityConstants.EDIT_PRODUCT_CATEGORIES);
		
		//loan product categories 
		
		activityMap.put("/loanprdaction-load",SecurityConstants.DEFINE_NEW_LOAN_PRODUCT_INSTANCE);
		...
		activityMap.put("/loanprdaction-create",SecurityConstants.DEFINE_NEW_LOAN_PRODUCT_INSTANCE);
		activityMap.put("/loanprdaction-search",SecurityConstants.VIEW);
		activityMap.put("/loanprdaction-get",SecurityConstants.VIEW);
		activityMap.put("/loanprdaction-manage",SecurityConstants.EDIT_LOAN_PRODUCT);
		activityMap.put("/loanprdaction-update",SecurityConstants.EDIT_LOAN_PRODUCT);
		...
		activityMap.put("/feeaction-create",SecurityConstants.FEES_CREATE_FEES);
		...
		activityMap.put("/loanActivityAction-getAllActivity",SecurityConstants.VIEW);
		...
		activityMap.put("/AccountNotesAction-load",SecurityConstants.LOAN_CAN_ADD_NOTES_TO_LOAN);
		...
		activityMap.put("/AccountNotesAction-create",SecurityConstants.LOAN_CAN_ADD_NOTES_TO_LOAN);
		...
		//apply charges 
		activityMap.put("/AccountsApplyChargesAction-load",SecurityConstants.APPLY_CHARGES_TO_CLIENT_GROUP_CENTERS_LOANS);
		activityMap.put("/AccountsApplyChargesAction-create",SecurityConstants.APPLY_CHARGES_TO_CLIENT_GROUP_CENTERS_LOANS);
		...
		activityMap.put("/bulkentryaction-getLastMeetingDateForCustomer",SecurityConstants.VIEW);
		activityMap.put("/bulkentryaction-create",SecurityConstants.VIEW);
		activityMap.put("/bulkentryaction-loadLoanOfficers",SecurityConstants.VIEW);
		activityMap.put("/bulkentryaction-loadCustomerList",SecurityConstants.VIEW);
		activityMap.put("/bulkentryaction-validate",SecurityConstants.VIEW);
		
		//removing fees
		activityMap.put("/accountAppAction-removeFees",SecurityConstants.LOAN_REMOVE_FEE_TYPE_ATTACHED_TO_ACCOUNT);
		activityMap.put("/accountAppAction-getTrxnHistory",SecurityConstants.VIEW);
		
		//mapping for savings account
		activityMap.put("/savingsAction-getPrdOfferings",SecurityConstants.VIEW);
		...
		activityMap.put("/savingsAction-edit",SecurityConstants.SAVINGS_UPDATE_SAVINGS);
		...
		activityMap.put("/savingsAction-getRecentActivity",SecurityConstants.VIEW);
		activityMap.put("/savingsAction-getTransactionHistory",SecurityConstants.VIEW);
		activityMap.put("/savingsAction-getDepositDueDetails",SecurityConstants.VIEW);
		
		activityMap.put("/savingsAction-waiveAmountDue",SecurityConstants.VIEW);
		activityMap.put("/savingsAction-waiveAmountOverDue",SecurityConstants.VIEW);
		
		//close savings account
		activityMap.put("/savingsClosureAction-load",SecurityConstants.SAVINGS_CLOSE_SAVINGS_ACCOUNT);
		...
		activityMap.put("/savingsApplyAdjustmentAction-load",SecurityConstants.SAVINGS_APPLY_ADJUSTMENT);
		activityMap.put("/savingsApplyAdjustmentAction-preview",SecurityConstants.SAVINGS_APPLY_ADJUSTMENT);
		activityMap.put("/savingsApplyAdjustmentAction-previous",SecurityConstants.SAVINGS_APPLY_ADJUSTMENT);
		activityMap.put("/savingsApplyAdjustmentAction-adjustLastUserAction",SecurityConstants.SAVINGS_APPLY_ADJUSTMENT);

		// entries for apply adjustment.
		
		activityMap.put("/applyAdjustment-loadAdjustment",SecurityConstants.LOAN_MAKE_ADJUSTMENT_ENTRY_TO_ACCOUNT);
		activityMap.put("/applyAdjustment-previewAdjustment",SecurityConstants.LOAN_MAKE_ADJUSTMENT_ENTRY_TO_ACCOUNT);
		activityMap.put("/applyAdjustment-applyAdjustment",SecurityConstants.LOAN_MAKE_ADJUSTMENT_ENTRY_TO_ACCOUNT);
		activityMap.put("/applyAdjustment-cancelAdjustment",SecurityConstants.LOAN_MAKE_ADJUSTMENT_ENTRY_TO_ACCOUNT);
		
		//mapping for repaying loan account
		activityMap.put("/repayLoanAction-loadRepayment",SecurityConstants.LOAN_CAN_REPAY_LOAN);
		activityMap.put("/repayLoanAction-preview",SecurityConstants.LOAN_CAN_REPAY_LOAN);
		activityMap.put("/repayLoanAction-previous",SecurityConstants.LOAN_CAN_REPAY_LOAN);
		activityMap.put("/repayLoanAction-makeRepayment",SecurityConstants.LOAN_CAN_REPAY_LOAN);
		...
		activityMap.put("/custApplyAdjustment-loadAdjustment-Client",SecurityConstants.CIENT_MAKE_ADJUSTMENT_ENTRIES_TO_CLIENT_ACCOUNT);
		activityMap.put("/custApplyAdjustment-previewAdjustment-Client",SecurityConstants.VIEW);
		activityMap.put("/custApplyAdjustment-applyAdjustment-Client",SecurityConstants.VIEW);
		activityMap.put("/custApplyAdjustment-cancelAdjustment-Client",SecurityConstants.VIEW);
		
		activityMap.put("/custApplyAdjustment-loadAdjustment-Group",SecurityConstants.GROUP_MAKE_ADJUSTMENT_ENTRIES_TO_GROUP_ACCOUNT);
		activityMap.put("/custApplyAdjustment-previewAdjustment-Group",SecurityConstants.VIEW);
		activityMap.put("/custApplyAdjustment-applyAdjustment-Group",SecurityConstants.VIEW);
		activityMap.put("/custApplyAdjustment-cancelAdjustment-Group",SecurityConstants.VIEW);
		
		activityMap.put("/custApplyAdjustment-loadAdjustment-Center",SecurityConstants.CENTER_MAKE_ADJUSTMENT_ENTRIES_TO_CENTER_ACCOUNT);
		activityMap.put("/custApplyAdjustment-previewAdjustment-Center",SecurityConstants.VIEW);
		activityMap.put("/custApplyAdjustment-applyAdjustment-Center",SecurityConstants.VIEW);
		activityMap.put("/custApplyAdjustment-cancelAdjustment-Center",SecurityConstants.VIEW);
		
		activityMap.put("/customerAction-forwardWaiveChargeDue",SecurityConstants.VIEW);
		activityMap.put("/customerAction-forwardWaiveChargeOverDue",SecurityConstants.VIEW);
		activityMap.put("/customerAction-waiveChargeDue-Client",SecurityConstants.CIENT_WAIVE_FEE_INSTALLMENT);
		activityMap.put("/customerAction-waiveChargeOverDue-Client",SecurityConstants.CIENT_WAIVE_FEE_INSTALLMENT);
		activityMap.put("/customerAction-waiveChargeDue-Group",SecurityConstants.GROUP_WAIVE_FEE_INSTALLMENT);
		activityMap.put("/customerAction-waiveChargeOverDue-Group",SecurityConstants.GROUP_WAIVE_FEE_INSTALLMENT);
		activityMap.put("/customerAction-waiveChargeDue-Center",SecurityConstants.CENTER_WAIVE_FEE_INSTALLMENT);
		activityMap.put("/customerAction-waiveChargeOverDue-Center",SecurityConstants.CENTER_WAIVE_FEE_INSTALLMENT);
		
		activityMap.put("/customerAction-getAllActivity",SecurityConstants.VIEW);
	...
	public boolean isStateChangePermittedForAccount(short newSate,short stateFlag,UserContext userContext,Short recordOfficeId,Short recordLoanOfficerId){
		return AuthorizationManager.getInstance().isActivityAllowed(userContext,new ActivityContext(getActivityIdForNewStateId(newSate,stateFlag),recordOfficeId,recordLoanOfficerId));
	}
	public boolean isStateChangePermittedForCustomer(short newSate,short stateFlag,UserContext userContext,Short recordOfficeId,Short recordLoanOfficerId){
		return AuthorizationManager.getInstance().isActivityAllowed(userContext,new ActivityContext(getActivityIdForNewCustomerStateId(newSate,stateFlag),recordOfficeId,recordLoanOfficerId));
	}

	public boolean isSavePermittedForAccount(short newSate,UserContext userContext,Short recordOfficeId,Short recordLoanOfficerId){
		return AuthorizationManager.getInstance().isActivityAllowed(userContext,new ActivityContext(getActivityIdForState(newSate),recordOfficeId,recordLoanOfficerId));
	}
	public boolean isSavePermittedForCustomer(short newSate,UserContext userContext,Short recordOfficeId,Short recordLoanOfficerId){
		return AuthorizationManager.getInstance().isActivityAllowed(userContext,new ActivityContext(getActivityIdForCustomerState(newSate),recordOfficeId,recordLoanOfficerId));
	}	
}

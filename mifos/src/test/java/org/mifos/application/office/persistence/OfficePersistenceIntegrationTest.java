...
public class OfficePersistenceIntegrationTest extends MifosIntegrationTest {
    ...
    public void testCreateOfficeValidationFailure() throws PersistenceException, OfficeException {
        ...
        try {
            OfficeBO office = getOfficePersistence().createOffice(userContext, template);
            fail("Office " + office.getOfficeName() + "should not have been successfully created");
    ...
    public void testGetAllOffices() throws Exception {
        assertEquals(Integer.valueOf("3").intValue(), getOfficePersistence().getAllOffices().size());
    }
    ...
    public void testGetChildCount() throws Exception {
        ...
        assertEquals(1, getOfficePersistence().getChildCount(Short.valueOf("1")).intValue());
    }
    ...
    public void testGetChildern() throws Exception {
        assertEquals(1, getOfficePersistence().getChildern(Short.valueOf("1")).size());
    }
    ...
    public void testGetOfficesTillBranchOfficeActive() throws Exception {
        assertEquals(2, getOfficePersistence().getOfficesTillBranchOffice("1.1").size());
    }

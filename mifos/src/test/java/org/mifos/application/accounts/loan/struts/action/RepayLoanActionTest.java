...
public class RepayLoanActionTest extends MifosMockStrutsTestCase {

	public RepayLoanActionTest() throws SystemException, ApplicationException {
        super();
    }
	...
	private void changeFirstInstallmentDate(AccountBO accountBO){
		...
		for(AccountActionDateEntity accountActionDateEntity:accountBO.getAccountActionDates()){
			LoanBOIntegrationTest.setActionDate(accountActionDateEntity,new java.sql.Date(currentDateCalendar.getTimeInMillis()));
			break;
		}
	}

...
public class TestSavingsOverDueDepositsTag extends MifosIntegrationTest {
	
	public TestSavingsOverDueDepositsTag() throws SystemException, ApplicationException {
        super();
    }

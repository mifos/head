...
public class LoanSummaryEntityIntegrationTest extends MifosIntegrationTest {

    public LoanSummaryEntityIntegrationTest() throws SystemException, ApplicationException {
        super();
    }

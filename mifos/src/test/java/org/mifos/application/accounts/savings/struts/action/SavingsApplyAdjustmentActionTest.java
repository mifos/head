...
public class SavingsApplyAdjustmentActionTest extends MifosMockStrutsTestCase {
	public SavingsApplyAdjustmentActionTest() throws SystemException, ApplicationException {
        super();
    }

...
public class TestSavingsBO extends MifosIntegrationTest {
    ...
    throws Exception {
        ...
        Date startDate = DateUtils.getCurrentDateWithoutTimeStamp();
        savingsOffering = createSavingsOffering("prd1", "cfgh",
                SavingsType.VOLUNTARY, InterestCalcType.MINIMUM_BALANCE, MONTHLY,
                new Short("1"), 10.0, startDate, 200.0, 0.0);
        savings = helper.createSavingsAccount(savingsOffering, group,
                AccountState.SAVINGS_ACTIVE, userContext);
        ...
        Date nextIntCalcDate2 = sHelper.getNextScheduleDate(startDate, nextIntCalcDate, 
        ...
        Date postDate = sHelper.getNextScheduleDate(startDate, null, 
                savingsOffering.getFreqOfPostIntcalc().getMeeting());
        assertEquals(postDate, savings.getLastIntPostDate());
        postDate = sHelper.getNextScheduleDate(startDate, postDate, 
                savingsOffering.getFreqOfPostIntcalc().getMeeting());
        ...
        assertEquals(getRoundedDouble(interest), getRoundedDouble(savings.getInterestToBePosted().getAmountDoubleValue()));
        nextIntCalcDate2 = sHelper.getNextScheduleDate(startDate, nextIntCalcDate2, 
                savingsOffering.getTimePerForInstcalc().getMeeting());
        assertEquals(nextIntCalcDate2, savings.getNextIntCalcDate());
    ...
    throws Exception {
        ...
        //assertEquals(2.6, savings.getInterestToBePosted().getAmountDoubleValue(), DELTA);
        assertEquals(2.7, getRoundedDouble(savings.getInterestToBePosted().getAmountDoubleValue()), DELTA);
        ...
        // 71.3 + 2.6 = 73.9
        // * TODO: financial_calculation_rounding
        //assertEquals(73.9, savings.getInterestToBePosted().getAmountDoubleValue(), DELTA);
        ...
        // * TODO: financial_calculation_rounding
        //assertEquals(5.9, savings.getInterestToBePosted().getAmountDoubleValue(), DELTA);
        ...
        // 77.7 + 3.6 = 81.3
        // * TODO: financial_calculation_rounding
        //assertEquals(83.9, savings.getInterestToBePosted().getAmountDoubleValue(), DELTA);
        ...
        // * TODO: financial_calculation_rounding
        //assertEquals(88.4, savings.getInterestToBePosted().getAmountDoubleValue(), DELTA);
    ...
    throws Exception {
        ...
        // * TODO: financial_calculation_rounding
        //assertEquals(77.2, savings.getInterestToBePosted().getAmountDoubleValue(), DELTA);
    ...
    throws Exception {
        ...
        //assertEquals(2.6, savings.getInterestToBePosted().getAmountDoubleValue(), DELTA);
        // * TODO: financial_calculation_rounding
        assertEquals(2.0, getRoundedDouble(savings.getInterestToBePosted()
                .getAmountDoubleValue()), DELTA);
        ...
        for (AccountActionDateEntity entity : actionDates) {
            if (entity.getActionDate().compareTo(
                ...
                assertEquals(700.0, ((SavingsScheduleEntity) entity)
                        .getDeposit().getAmountDoubleValue(), DELTA);
        }
    }
    ...
    public void testCalculateInterestForClosureAvgBal() throws Exception {
        ...
        Money amount = savings.calculateInterestForClosure(
                helper.getDate("30/05/2006"));
    ...
    throws Exception {
        ...
        group = (GroupBO) StaticHibernateUtil.getSessionTL().get(
    ...
    public void testGetOverDueDepositAmountForMandatoryAccounts()
        ...
        assertEquals(300.00, savings.getOverDueDepositAmount(
                accountActionDate.getActionDate()).getAmountDoubleValue(), DELTA);
    ...
    public void testGetRecentAccountActivity() throws Exception {
        ...
        SavingsActivityEntity savingsActivity = new SavingsActivityEntity(
                savings.getPersonnel(), (AccountActionEntity) StaticHibernateUtil
    ...
    public void testCalculateInterest_IntCalcFreqTenDays_minbal()
        ...
        savings.updateInterestAccrued();
        // * TODO: financial_calculation_rounding
        //assertEquals(1.6, savings.getInterestToBePosted().getAmountDoubleValue(), DELTA);
    ...
    public void testCalculateInterest_IntCalcFreqTenDays_avg() throws Exception {
        ...
        savings.updateInterestAccrued();
        // * TODO: financial_calculation_rounding
        //assertEquals(4.6, savings.getInterestToBePosted().getAmountDoubleValue(), DELTA);
    ...
    public void testInterestAdjustment_LastWithdrawalPaymentModified_WithMinBal()
        ...
        // * TODO: financial_calculation_rounding
        //assertEquals(4.4, savings.getInterestToBePosted().getAmountDoubleValue(), DELTA);
    ...
    public void testGenerateMeetingForNextYear() throws Exception {
        ...
        group = (CustomerBO) StaticHibernateUtil.getSessionTL().get(CustomerBO.class,
                group.getCustomerId());
        savingsBO = (SavingsBO) StaticHibernateUtil.getSessionTL().get(

...
public class HiddenMandatoryConfigurationActionTest extends MifosMockStrutsTestCase {
    ...
    public void testLoad() throws Exception {
        ...
        assertEquals("1", actionForm.getMandatoryClientSpouseFatherSecondLastName());
    ...
    public void testUpdate() throws Exception {
        ...
        assertEquals("0", actionForm.getMandatoryClientSpouseFatherSecondLastName());
        assertEquals("0", actionForm.getMandatoryClientTrained());
        assertEquals("0", actionForm.getMandatoryClientTrainedOn());
        assertEquals("0", actionForm.getMandatorySystemAddress1());

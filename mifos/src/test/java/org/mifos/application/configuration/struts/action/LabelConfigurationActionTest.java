...
public class LabelConfigurationActionTest extends MifosMockStrutsTestCase {
	 ...
	 * to be in ConfigurationTestSuite-- ConfigurationIntegrationTest seems to
	 * be the specific culprit. If this test runs before ConfigurationIntegrationTest
	 * it fails, if it runs after ConfigurationIntegrationTest, it succeeds.
	 */

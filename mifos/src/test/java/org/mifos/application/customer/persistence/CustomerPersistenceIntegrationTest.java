...
public class CustomerPersistenceIntegrationTest extends MifosIntegrationTest {
	...
	public void testLastLoanAmount() throws PersistenceException,
		...
		StaticHibernateUtil.commitTransaction();
		StaticHibernateUtil.closeSession();
		account = (AccountBO) StaticHibernateUtil.getSessionTL().get(LoanBO.class,
				loanBO.getAccountId());
	...
	public void testGetCustomersWithUpdatedMeetings() throws Exception {
		...
		group = TestObjectFactory.createGroupUnderCenter("Group1",
				CustomerStatus.GROUP_ACTIVE, center);
		CustomerBOIntegrationTest.setUpdatedFlag(group.getCustomerMeeting(), YesNoFlag.YES
				.getValue());
	...
	public void testGetChildrenForParent() throws NumberFormatException,
		...
		customer = TestObjectFactory.getCustomer(customerIds
				.get(1));
	...
	public void testSearchWithCancelLoanAccounts() throws Exception {
		...
		groupAccount = TestObjectFactory.getObject(LoanBO.class, groupAccount
				.getAccountId());
		center = TestObjectFactory.getCustomer(center
				.getCustomerId());

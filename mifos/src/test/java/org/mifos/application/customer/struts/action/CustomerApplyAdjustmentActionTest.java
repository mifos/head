...
public class CustomerApplyAdjustmentActionTest extends MifosMockStrutsTestCase {
	public CustomerApplyAdjustmentActionTest() throws SystemException, ApplicationException {
        super();
    }
	...
	private void applyPayment() throws Exception {
		...
		CustomerAccountBOIntegrationTest.setMiscFeePaid(accountAction,TestObjectFactory
...
//		Money totalFees = new Money();
		...
		for (AccountFeesActionDetailEntity accountFeesActionDetailEntity : accountAction
			...
			CustomerAccountBOIntegrationTest.setFeeAmountPaid((CustomerFeeScheduleEntity) accountFeesActionDetailEntity,TestObjectFactory
					.getMoneyForMFICurrency(100));
			FeesTrxnDetailEntity feeTrxn = new FeesTrxnDetailEntity(
					accountTrxnEntity, accountFeesActionDetailEntity
							...
							.getFeeAmount());
			CustomerTrxnDetailEntityIntegrationTest.addFeesTrxnDetail(

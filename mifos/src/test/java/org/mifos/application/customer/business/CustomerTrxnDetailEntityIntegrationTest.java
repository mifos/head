...
public class CustomerTrxnDetailEntityIntegrationTest extends MifosIntegrationTest {
	...
	public void testGenerateReverseTrxn() throws Exception {
		...
		for(AccountFeesActionDetailEntity accountFeesActionDetailEntity:accountAction.getAccountFeesActionDetails()) {
			CustomerAccountBOIntegrationTest.setFeeAmountPaid((CustomerFeeScheduleEntity) accountFeesActionDetailEntity,TestObjectFactory.getMoneyForMFICurrency(100));

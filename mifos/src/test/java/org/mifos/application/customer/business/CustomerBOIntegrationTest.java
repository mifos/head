...
public class CustomerBOIntegrationTest extends MifosIntegrationTest {
	...
	public void testRemoveGroupMemberShip() throws Exception {
		...
		StaticHibernateUtil.closeSession();
		loanOfficer = (PersonnelBO) StaticHibernateUtil.getSessionTL().get(
	...
	public void testGroupPerfObject() throws PersistenceException {
		...
		GroupBOIntegrationTest.setLastGroupLoanAmount(groupPerformanceHistory, new Money(
				"100"));
	...
	public void testGetDelinquentPortfolioAmount() {
		...
		TestObjectFactory.flushandCloseSession();
		client = TestObjectFactory.getClient(ClientBO.class,
				client.getCustomerId());
		assertEquals(new Money("0.7"), client.getDelinquentPortfolioAmount());
		TestObjectFactory.flushandCloseSession();
		center = TestObjectFactory.getCenter(CenterBO.class, center
				.getCustomerId());
	...
	*/
	...
	public void testValidateStatusForClientWithActiveAccounts()
		...
		center = (CenterBO) StaticHibernateUtil.getSessionTL().get(CenterBO.class,
				center.getCustomerId());
		accountBO = (LoanBO) StaticHibernateUtil.getSessionTL().get(LoanBO.class,
				accountBO.getAccountId());
	}
	...
	public void testValidateStatusForClientSavingsAccountInactive()
		...
		center = (CenterBO) StaticHibernateUtil.getSessionTL().get(CenterBO.class,
				center.getCustomerId());
		accountBO = (SavingsBO) StaticHibernateUtil.getSessionTL().get(

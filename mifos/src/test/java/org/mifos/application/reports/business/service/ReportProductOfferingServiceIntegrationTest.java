...
public class ReportProductOfferingServiceIntegrationTest extends MifosIntegrationTest {
    ...
    protected void setUp() throws Exception {
        ...
        reportProductOfferingService = new ReportProductOfferingService(loanPrdBusinessServiceMock,
                savingsProductBusinessServiceMock, reportProductOfferingConfig) {
            @Override

...
public class ReportsPersistenceIntegrationTest extends MifosIntegrationTest {
    ...
    public void testGetAllReportCategories() {
        ...
        assertEquals("1", listOfReportCategories.get(0).getReportCategoryId().toString());
        assertEquals("Client Detail", listOfReportCategories.get(0).getReportCategoryName());
        assertEquals("2", listOfReportCategories.get(1).getReportCategoryId().toString());
        assertEquals("Performance", listOfReportCategories.get(1).getReportCategoryName());
        assertEquals("3", listOfReportCategories.get(2).getReportCategoryId().toString());
        assertEquals("Center", listOfReportCategories.get(2).getReportCategoryName());
        assertEquals("4", listOfReportCategories.get(3).getReportCategoryId().toString());
        assertEquals("Loan Product Detail", listOfReportCategories.get(3).getReportCategoryName());
        assertEquals("5", listOfReportCategories.get(4).getReportCategoryId().toString());
        assertEquals("Status", listOfReportCategories.get(4).getReportCategoryName());
        assertEquals("6", listOfReportCategories.get(5).getReportCategoryId().toString());
        assertEquals("Analysis", listOfReportCategories.get(5).getReportCategoryName());
        assertEquals("7", listOfReportCategories.get(6).getReportCategoryId().toString());
        assertEquals("Miscellaneous", listOfReportCategories.get(6).getReportCategoryName());

...
public class MeetingBOTest extends MifosTestCase{
	...
	public void testGetAllDatesMonthlyWithRepaymentIndepOfMeetingEnabled()
			throws Exception {
		//dates that lies on second monday of every month
		startDate = getDate("15/11/2005");
		endDate = getDate("15/10/2006");
		meeting = createMonthlyMeetingOnWeekDay(WeekDay.MONDAY,
				RankType.SECOND, ONE, startDate);
	...
	public void testShouldThrowMeetingExceptionIfEndDateBeforeStartDateForGeneratingAllMeetingDates()
			throws Exception {
	...
	public void testShouldReturnEmptyListIfStartDateAndEndDateSameForGeneratingAllMeetingDates()
			throws Exception {
		startDate = getDate("18/08/2006");
    ...
    */
	...
	public void testShouldReturnDateOfNextWeekOnSameWeekdayAsConfiguredIfStartDateDayIsAfterConfiguredWeekday()
			throws Exception {
		Date dateFallingOnTuesday = DateUtils
				.getDate(2008, Calendar.JANUARY, 8);
		MeetingBO meetingBO = createWeeklyMeeting(WeekDay.MONDAY, ONE, DateUtils.getDate(
		...
		assertEquals(DateUtils.getDate(2008, Calendar.JANUARY, 14),
				shouldBeDateFallingNextWeekOnMeetingWeekday);
	}

	public void testShouldReturnDateOfSameWeekOnSameWeekdayAsConfiguredIfStartDateDayIsBeforeConfiguredWeekday()
			throws Exception {
		Date dateFallingOnSunday = DateUtils
				.getDate(2008, Calendar.JANUARY, 13);
		MeetingBO meetingBO = createWeeklyMeeting(WeekDay.MONDAY, ONE, DateUtils.getDate(
						2008, Calendar.JANUARY, 1));
		Date shouldBeDateFallingNextWeekOnMeetingWeekday = meetingBO

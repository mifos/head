...
public class LoanOfferingBOTest extends MifosIntegrationTest {
	...
	public static void setStatus(LoanOfferingBO loanOffering,
			PrdStatusEntity prdStatus) {
		loanOffering.setPrdStatus(prdStatus);
	}

	public static void setGracePeriodType(LoanOfferingBO loanOffering,
	...
	public void testUpdateLoanOfferingFeeTypesForLogging() throws Exception {
		...
		product
				.update((short) 1, "Loan Product", "LOAN", productCategory,
		...
		List<AuditLog> auditLogList = TestObjectFactory.getChangeLog(
				EntityType.LOANPRODUCT, new Integer(product.getPrdOfferingId()
						.toString()));
		...
		for (AuditLogRecord auditLogRecord : auditLogList.get(0)
			...
			if (auditLogRecord.getFieldName().equalsIgnoreCase("Fee Types")
					&& auditLogRecord.getNewValue().equalsIgnoreCase(
							"Loan Periodic")) {
				assertEquals("-", auditLogRecord.getOldValue());
			}
			else if (auditLogRecord.getFieldName()
					.equalsIgnoreCase("Fee Types")
					&& auditLogRecord.getNewValue().equalsIgnoreCase(
							"Loan One time")) {
	...
	public void testUpdateLoanOfferingForLogging()
		...
		for (AuditLogRecord auditLogRecord : auditLogList.get(0)
			...
			if (auditLogRecord.getFieldName().equalsIgnoreCase(
				...
				assertEquals("1000.0", auditLogRecord.getNewValue());
					...
					"Description")) {
				assertEquals("-", auditLogRecord.getOldValue());
				assertEquals("Loan Product updated", auditLogRecord
						.getNewValue());
			}
			else if (auditLogRecord.getFieldName().equalsIgnoreCase(
					"Applicable For")) {
	...
	public void testBuildloanOfferingWithoutDataForMandatoryFields() {
		try {
			new LoanOfferingBO(null, null, null, null, null, null, null, null,
	...
	public void testBuildloanOfferingWithoutDataForAllFields() {
		try {
			new LoanOfferingBO(null, null, null, null, null, null, null, null,
					...
					null, null, false, false, false, null, null, null, null,
					null);
			fail();
		}
		catch (ProductDefinitionException e) {
	...
	public void testBuildloanOfferingWithoutName() throws SystemException,
			ApplicationException {
		createIntitalObjects();
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), null, "S",
					productCategory, prdApplicableMaster, new Date(System
							.currentTimeMillis()), interestTypes, new Money(
	...
	public void testBuildloanOfferingWithShortNameGreaterThanFourDig()
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					"LOANOFF", productCategory, prdApplicableMaster, new Date(
							System.currentTimeMillis()), interestTypes,
	...
	public void testStartDateGreaterThanCurrentDate() throws SystemException,
			ApplicationException {
		createIntitalObjects();
		Date startDate = offSetCurrentDate(2);
		LoanOfferingBO product = new LoanOfferingBO(TestObjectFactory
	...
	public void testBuildloanOfferingWithDuplicatePrdOfferingName()
		...
		Date startDate = offSetCurrentDate(0);
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Product",
					"LOAN", productCategory, prdApplicableMaster, startDate,
					interestTypes, new Money("1000"), new Money("3000"), 12.0,
					2.0, 3.0, (short) 20, (short) 1, (short) 12, false, false,
					false, frequency, principalglCodeEntity, intglCodeEntity);
	...
	public void testBuildloanOfferingWithEndDateLessThanStartDate()
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					...
					new Money("1000"), new Money("3000"), null, 12.0, 2.0, 3.0,
					(short) 20, (short) 1, (short) 12, false, false, false,
	...
	public void testBuildloanOfferingWithNoInterestTypes()
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Product",
					"LOAN", productCategory, prdApplicableMaster, startDate,
					null, new Money("1000"), new Money("3000"), 12.0, 2.0, 3.0,
					(short) 20, (short) 1, (short) 12, false, false, false,
					frequency, principalglCodeEntity, intglCodeEntity);
			fail();
		}
	...
	public void testBuildloanOfferingWithNoMaxAmount() throws SystemException,
			ApplicationException {
		createIntitalObjects();
		Date startDate = offSetCurrentDate(0);
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					"LOAP", productCategory, prdApplicableMaster, startDate,
					interestTypes, new Money("1000.0"), null, 12.0, 2.0, 3.0,
					(short) 20, (short) 1, (short) 12, false, false, false,
					frequency, principalglCodeEntity, intglCodeEntity);
			fail();
		}
	...
	public void testBuildloanOfferingWithoutGLCode() throws SystemException,
			ApplicationException {
		createIntitalObjects();
		Date startDate = offSetCurrentDate(0);
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					"LOAP", productCategory, prdApplicableMaster, startDate,
					interestTypes, new Money("1000.0"), new Money("3000"),
					12.0, 2.0, 3.0, (short) 20, (short) 1, (short) 12, false,
					false, false, frequency, null, null);
			fail();
		}
		catch (ProductDefinitionException e) {
		}
	...
	public void testDefAmountNotBetweenMinMaxAmounts() {
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					"LOAP", productCategory, prdApplicableMaster, startDate,
					endDate, null, null, null, interestTypes,
					new Money("1000"), new Money("3000"), new Money("200.0"),
					12.0, 2.0, 3.0, (short) 20, (short) 1, (short) 12, false,
	...
	public void testMinAmountGreaterThanMaxAmount() {
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					"LOAP", productCategory, prdApplicableMaster, startDate,
					endDate, null, null, null, interestTypes,
					new Money("10000"), new Money("3000"), null, 12.0, 2.0,
					3.0, (short) 20, (short) 1, (short) 12, false, false,
					false, null, null, frequency, principalglCodeEntity,
					intglCodeEntity);
			fail();
		}
		catch (ProductDefinitionException e) {
	...
	public void testDefInterestRateNotBetweenMinMaxRates() {
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					...
					12.0, 2.0, 13.0, (short) 20, (short) 1, (short) 12, false,
					false, false, null, null, frequency, principalglCodeEntity,
					intglCodeEntity);
			fail();
		}
	...
	public void testMinInterestRateGretaterThanMaxRate() {
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					...
					endDate, null, null, null, interestTypes,
					new Money("1000"), new Money("3000"), new Money("2000.0"),
					12.0, 20.0, 13.0, (short) 20, (short) 1, (short) 12, false,
					false, false, null, null, frequency, principalglCodeEntity,
					intglCodeEntity);
			fail();
		}
	...
	public void testMinInstallmentsGreaterThanMaxInstallments() {
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					...
					endDate, null, null, null, interestTypes,
					new Money("1000"), new Money("3000"), new Money("2000.0"),
					12.0, 2.0, 3.0, (short) 20, (short) 31, (short) 21, false,
					false, false, null, null, frequency, principalglCodeEntity,
					intglCodeEntity);
			fail();
		}
	...
	public void testDefInstallmentsNotBetweenMinMaxInstallments() {
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					...
					endDate, null, null, null, interestTypes,
					new Money("1000"), new Money("3000"), new Money("2000.0"),
					12.0, 2.0, 3.0, (short) 20, (short) 11, (short) 7, false,
					false, false, null, null, frequency, principalglCodeEntity,
					intglCodeEntity);
			fail();
		}
	...
	public void testNullGracePeriodDurationWithGraceType()
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					"LOAP", productCategory, prdApplicableMaster, startDate,
					endDate, null, gracePeriodType, null, interestTypes,
					new Money("1000"), new Money("3000"), new Money("2000.0"),
	...
	public void testFeeNotMatchingFrequencyOfLoanOffering()
		...
		try {
			new LoanOfferingBO(TestObjectFactory.getContext(), "Loan Offering",
					...
					new Money("1000"), new Money("3000"), new Money("2000.0"),
					12.0, 2.0, 3.0, (short) 20, (short) 11, (short) 17, false,
					false, false, null, fees, frequency, principalglCodeEntity,
					intglCodeEntity);
			fail();
		}
		catch (ProductDefinitionException e) {
	...
	public void testCreateLoanOffering() throws ProductDefinitionException,
		...
		assertEquals(GraceType.GRACEONALLREPAYMENTS.getValue(), product
				.getGracePeriodType().getId());
		...
		assertEquals(RecurrenceType.WEEKLY, product.getLoanOfferingMeeting()
	...
	public void testUpdateloanOfferingWithoutName() throws SystemException,
			ApplicationException {
		createIntitalObjects();
		product = createLoanOfferingBO("Loan Product", "LOAP");
		try {
	...
	public void testUpdateloanOfferingWithShortNameGreaterThanFourDig()
		...
		product = createLoanOfferingBO("Loan Product", "LOAP");
		try {
			product.update((short) 1, "Loan Product", "LOANS", productCategory,
					prdApplicableMaster, new Date(System.currentTimeMillis()),
					null, "Loan Product updated", PrdStatus.LOAN_ACTIVE, null,
					interestTypes, (short) 0, new Money("3000"), new Money(
							"1000"), new Money("2000"), 12.0, 2.0, 3.0,
	...
	public void testupdateloanOfferingWithStartDateLessThanCurrentDate()
		...
		try {
			product.update((short) 1, "Loan Product", "LOAN", productCategory,
					prdApplicableMaster, startDate, null,
					"Loan Product updated", PrdStatus.LOAN_ACTIVE, null,
					interestTypes, (short) 0, new Money("3000"), new Money(
							"1000"), new Money("2000"), 12.0, 2.0, 3.0,
					(short) 20, (short) 1, (short) 12, false, false, false,
	...
	public void testupdateloanOfferingWithNoMaxAmount() throws SystemException,
			ApplicationException {
		createIntitalObjects();
		Date startDate = offSetCurrentDate(0);
		product = createLoanOfferingBO("Loan Product", "LOAP");
	...
	public void testUpdateGracePeriodForIntDedAtDisb()
		...
		assertEquals(GraceType.NONE.getValue(), product.getGracePeriodType()
				.getId());
	...
	public void testUpdateLoanOffering() throws ProductDefinitionException,
		...
		assertEquals(2, product.getLoanOfferingFees().size());
		assertNotNull(product.getLoanOfferingMeeting());
		assertEquals(RecurrenceType.MONTHLY, product.getLoanOfferingMeeting()
				.getMeeting().getMeetingDetails().getRecurrenceTypeEnum());
		assertNotNull(product.getPrincipalGLcode());
		assertNotNull(product.getInterestGLcode());
	}
	...
	private void createIntitalObjects() {
		...
		principalglCodeEntity = (GLCodeEntity) StaticHibernateUtil.getSessionTL()
				.get(GLCodeEntity.class, (short) 7);
		intglCodeEntity = (GLCodeEntity) StaticHibernateUtil.getSessionTL().get(
	...
	public void testCreateLoanOfferingSameForAllLoan()
			throws ProductDefinitionException, FeeException {
		createIntitalObjects();
		GracePeriodTypeEntity gracePeriodType = new GracePeriodTypeEntity(
				GraceType.GRACEONALLREPAYMENTS);
		...
		product = new LoanOfferingBO(TestObjectFactory.getContext(),
				...
				frequency, principalglCodeEntity, intglCodeEntity,
				populateNoOfInstallSameForAllLoan("1", "12", "1", "2",
						populateLoanAmountSameForAllLoan("1",
								new Double("3000"), new Double("1000"),
								new Double("2000"), loanPrdActionForm)));
		product.save();
		StaticHibernateUtil.commitTransaction();
		StaticHibernateUtil.closeSession();
		product = (LoanOfferingBO) TestObjectFactory.getObject(
		...
		for (Iterator<LoanAmountSameForAllLoanBO> itr = product
			...
			assertEquals(new Double("3000"), loanAmountSameForAllLoanBO
					.getMaxLoanAmount());
			assertEquals(new Double("1000"), loanAmountSameForAllLoanBO
					.getMinLoanAmount());
			assertEquals(new Double("2000"), loanAmountSameForAllLoanBO
					.getDefaultLoanAmount());
		}
		for (Iterator<NoOfInstallSameForAllLoanBO> itr = product
				.getNoOfInstallSameForAllLoan().iterator(); itr.hasNext();) {
			NoOfInstallSameForAllLoanBO noofInstallSameForAllLoanBO = itr
					.next();
			assertEquals(new Short("12"), noofInstallSameForAllLoanBO
					.getMaxNoOfInstall());
			assertEquals(new Short("1"), noofInstallSameForAllLoanBO
					.getMinNoOfInstall());
	...
	public void testCreateLoanOfferingByLastLoanAmount()
			throws ProductDefinitionException, FeeException {
		createIntitalObjects();
		GracePeriodTypeEntity gracePeriodType = new GracePeriodTypeEntity(
				GraceType.GRACEONALLREPAYMENTS);
		...
		product = new LoanOfferingBO(TestObjectFactory.getContext(),
				...
				populateNoOfInstallFromLastLoanAmount("2", new Integer("0"),
						...
						"60", "80", "70", populateLoanAmountFromLastLoanAmount(
								...
								new Double("3000"), new Double("5000"),
								new Double("4000"), new Double("4000"),
								new Double("6000"), new Double("5000"),
								new Double("5000"), new Double("7000"),
								new Double("6000"), new Double("6000"),
								new Double("8000"), new Double("7000"),
								loanPrdActionForm)));
		product.save();
		StaticHibernateUtil.commitTransaction();
		StaticHibernateUtil.closeSession();
		...
		assertEquals(InterestType.FLAT.getValue(), product.getInterestTypes()
				.getId());
		for (Iterator<LoanAmountFromLastLoanAmountBO> itr = product
				.getLoanAmountFromLastLoan().iterator(); itr.hasNext();) {
			LoanAmountFromLastLoanAmountBO loanAmountFromLastLoanAmountBO = itr
					.next();
			assertEquals(new Double("0"), loanAmountFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("1000"), loanAmountFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Double("3000"), loanAmountFromLastLoanAmountBO
					.getMaxLoanAmount());
			assertEquals(new Double("1000"), loanAmountFromLastLoanAmountBO
					.getMinLoanAmount());
			assertEquals(new Double("2000"), loanAmountFromLastLoanAmountBO
					.getDefaultLoanAmount());
			loanAmountFromLastLoanAmountBO = itr.next();
			assertEquals(new Double("1001"), loanAmountFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("2000"), loanAmountFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Double("4000"), loanAmountFromLastLoanAmountBO
					.getMaxLoanAmount());
			assertEquals(new Double("2000"), loanAmountFromLastLoanAmountBO
					.getMinLoanAmount());
			assertEquals(new Double("3000"), loanAmountFromLastLoanAmountBO
					.getDefaultLoanAmount());
			loanAmountFromLastLoanAmountBO = itr.next();
			assertEquals(new Double("2001"), loanAmountFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("3000"), loanAmountFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Double("5000"), loanAmountFromLastLoanAmountBO
					.getMaxLoanAmount());
			assertEquals(new Double("3000"), loanAmountFromLastLoanAmountBO
					.getMinLoanAmount());
			assertEquals(new Double("4000"), loanAmountFromLastLoanAmountBO
					.getDefaultLoanAmount());
			loanAmountFromLastLoanAmountBO = itr.next();
			assertEquals(new Double("3001"), loanAmountFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("4000"), loanAmountFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Double("6000"), loanAmountFromLastLoanAmountBO
					.getMaxLoanAmount());
			assertEquals(new Double("4000"), loanAmountFromLastLoanAmountBO
					.getMinLoanAmount());
			assertEquals(new Double("5000"), loanAmountFromLastLoanAmountBO
					.getDefaultLoanAmount());
			loanAmountFromLastLoanAmountBO = itr.next();
			assertEquals(new Double("4001"), loanAmountFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("5000"), loanAmountFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Double("7000"), loanAmountFromLastLoanAmountBO
					.getMaxLoanAmount());
			assertEquals(new Double("5000"), loanAmountFromLastLoanAmountBO
					.getMinLoanAmount());
			assertEquals(new Double("6000"), loanAmountFromLastLoanAmountBO
					.getDefaultLoanAmount());
			loanAmountFromLastLoanAmountBO = itr.next();
			assertEquals(new Double("5001"), loanAmountFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("6000"), loanAmountFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Double("8000"), loanAmountFromLastLoanAmountBO
					.getMaxLoanAmount());
			assertEquals(new Double("6000"), loanAmountFromLastLoanAmountBO
					.getMinLoanAmount());
			assertEquals(new Double("7000"), loanAmountFromLastLoanAmountBO
		...
		for (Iterator<NoOfInstallFromLastLoanAmountBO> itr = product
				.getNoOfInstallFromLastLoan().iterator(); itr.hasNext();) {
			NoOfInstallFromLastLoanAmountBO noOfInstallFromLastLoanAmountBO = itr
					.next();
			assertEquals(new Double("0"), noOfInstallFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("1000"), noOfInstallFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Short("30"), noOfInstallFromLastLoanAmountBO
					.getMaxNoOfInstall());
			assertEquals(new Short("10"), noOfInstallFromLastLoanAmountBO
					.getMinNoOfInstall());
			assertEquals(new Short("20"), noOfInstallFromLastLoanAmountBO
					.getDefaultNoOfInstall());
			noOfInstallFromLastLoanAmountBO = itr.next();
			assertEquals(new Double("1001"), noOfInstallFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("2000"), noOfInstallFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Short("40"), noOfInstallFromLastLoanAmountBO
					.getMaxNoOfInstall());
			assertEquals(new Short("20"), noOfInstallFromLastLoanAmountBO
					.getMinNoOfInstall());
			assertEquals(new Short("30"), noOfInstallFromLastLoanAmountBO
					.getDefaultNoOfInstall());
			noOfInstallFromLastLoanAmountBO = itr.next();
			assertEquals(new Double("2001"), noOfInstallFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("3000"), noOfInstallFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Short("50"), noOfInstallFromLastLoanAmountBO
					.getMaxNoOfInstall());
			assertEquals(new Short("30"), noOfInstallFromLastLoanAmountBO
					.getMinNoOfInstall());
			assertEquals(new Short("40"), noOfInstallFromLastLoanAmountBO
					.getDefaultNoOfInstall());
			noOfInstallFromLastLoanAmountBO = itr.next();
			assertEquals(new Double("3001"), noOfInstallFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("4000"), noOfInstallFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Short("60"), noOfInstallFromLastLoanAmountBO
					.getMaxNoOfInstall());
			assertEquals(new Short("40"), noOfInstallFromLastLoanAmountBO
					.getMinNoOfInstall());
			assertEquals(new Short("50"), noOfInstallFromLastLoanAmountBO
					.getDefaultNoOfInstall());
			noOfInstallFromLastLoanAmountBO = itr.next();
			assertEquals(new Double("4001"), noOfInstallFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("5000"), noOfInstallFromLastLoanAmountBO
					.getEndRange());
			...
			assertEquals(new Short("60"), noOfInstallFromLastLoanAmountBO
					.getDefaultNoOfInstall());
			noOfInstallFromLastLoanAmountBO = itr.next();
			assertEquals(new Double("5001"), noOfInstallFromLastLoanAmountBO
					.getStartRange());
			assertEquals(new Double("6000"), noOfInstallFromLastLoanAmountBO
					.getEndRange());
			assertEquals(new Short("80"), noOfInstallFromLastLoanAmountBO
					.getMaxNoOfInstall());
			assertEquals(new Short("60"), noOfInstallFromLastLoanAmountBO
					.getMinNoOfInstall());
			assertEquals(new Short("70"), noOfInstallFromLastLoanAmountBO
	...
	public void testCreateLoanOfferingFromLoanCycle()
			throws ProductDefinitionException, FeeException {
		createIntitalObjects();
		GracePeriodTypeEntity gracePeriodType = new GracePeriodTypeEntity(
				GraceType.GRACEONALLREPAYMENTS);
		...
		product = new LoanOfferingBO(TestObjectFactory.getContext(),
				...
				interestTypes, 12.0, 2.0, 3.0, false, false, false, null, fees,
				frequency, principalglCodeEntity, intglCodeEntity,
				populateNoOfInstallFromLoanCycle("3", "10", "30", "20", "20",
						"40", "30", "30", "50", "40", "40", "60", "50", "50",
						"70", "60", "60", "80", "70",
						populateLoanAmountFromLoanCycle("3",
								new Double("1000"), new Double("3000"),
								new Double("2000"), new Double("2000"),
								new Double("4000"), new Double("3000"),
								new Double("3000"), new Double("5000"),
		...
		assertEquals(InterestType.FLAT.getValue(), product.getInterestTypes()
				.getId());
		for (Iterator<LoanAmountFromLoanCycleBO> itr = product
				.getLoanAmountFromLoanCycle().iterator(); itr.hasNext();) {
			LoanAmountFromLoanCycleBO loanAmountFromLoanCycleBO = itr.next();
			assertEquals(new Double("3000"), loanAmountFromLoanCycleBO
					.getMaxLoanAmount());
			assertEquals(new Double("1000"), loanAmountFromLoanCycleBO
					.getMinLoanAmount());
			assertEquals(new Double("2000"), loanAmountFromLoanCycleBO
					.getDefaultLoanAmount());
			loanAmountFromLoanCycleBO = itr.next();
			assertEquals(new Double("4000"), loanAmountFromLoanCycleBO
					.getMaxLoanAmount());
			assertEquals(new Double("2000"), loanAmountFromLoanCycleBO
					.getMinLoanAmount());
			assertEquals(new Double("3000"), loanAmountFromLoanCycleBO
					.getDefaultLoanAmount());
			loanAmountFromLoanCycleBO = itr.next();
			assertEquals(new Double("5000"), loanAmountFromLoanCycleBO
					.getMaxLoanAmount());
			assertEquals(new Double("3000"), loanAmountFromLoanCycleBO
					.getMinLoanAmount());
			assertEquals(new Double("4000"), loanAmountFromLoanCycleBO
					.getDefaultLoanAmount());
			loanAmountFromLoanCycleBO = itr.next();
			assertEquals(new Double("6000"), loanAmountFromLoanCycleBO
					.getMaxLoanAmount());
			assertEquals(new Double("4000"), loanAmountFromLoanCycleBO
					.getMinLoanAmount());
			assertEquals(new Double("5000"), loanAmountFromLoanCycleBO
					.getDefaultLoanAmount());
			loanAmountFromLoanCycleBO = itr.next();
			assertEquals(new Double("7000"), loanAmountFromLoanCycleBO
					.getMaxLoanAmount());
			assertEquals(new Double("5000"), loanAmountFromLoanCycleBO
					.getMinLoanAmount());
			assertEquals(new Double("6000"), loanAmountFromLoanCycleBO
					.getDefaultLoanAmount());
			loanAmountFromLoanCycleBO = itr.next();
			assertEquals(new Double("8000"), loanAmountFromLoanCycleBO
					.getMaxLoanAmount());
			assertEquals(new Double("6000"), loanAmountFromLoanCycleBO
					.getMinLoanAmount());
			assertEquals(new Double("7000"), loanAmountFromLoanCycleBO
		...
		for (Iterator<NoOfInstallFromLoanCycleBO> itr = product
				.getNoOfInstallFromLoanCycle().iterator(); itr.hasNext();) {
			NoOfInstallFromLoanCycleBO noOfInstallFromLoanCycleBO = itr.next();
			assertEquals(new Short("30"), noOfInstallFromLoanCycleBO
					.getMaxNoOfInstall());
			assertEquals(new Short("10"), noOfInstallFromLoanCycleBO
					.getMinNoOfInstall());
			assertEquals(new Short("20"), noOfInstallFromLoanCycleBO
					.getDefaultNoOfInstall());
			noOfInstallFromLoanCycleBO = itr.next();
			assertEquals(new Short("40"), noOfInstallFromLoanCycleBO
					.getMaxNoOfInstall());
			assertEquals(new Short("20"), noOfInstallFromLoanCycleBO
					.getMinNoOfInstall());
			assertEquals(new Short("30"), noOfInstallFromLoanCycleBO
					.getDefaultNoOfInstall());
			noOfInstallFromLoanCycleBO = itr.next();
			assertEquals(new Short("50"), noOfInstallFromLoanCycleBO
					.getMaxNoOfInstall());
			assertEquals(new Short("30"), noOfInstallFromLoanCycleBO
					.getMinNoOfInstall());
			assertEquals(new Short("40"), noOfInstallFromLoanCycleBO
					.getDefaultNoOfInstall());
			noOfInstallFromLoanCycleBO = itr.next();
			assertEquals(new Short("60"), noOfInstallFromLoanCycleBO
					.getMaxNoOfInstall());
			assertEquals(new Short("40"), noOfInstallFromLoanCycleBO
					.getMinNoOfInstall());
			assertEquals(new Short("50"), noOfInstallFromLoanCycleBO
					.getDefaultNoOfInstall());
			noOfInstallFromLoanCycleBO = itr.next();
			assertEquals(new Short("70"), noOfInstallFromLoanCycleBO
					.getMaxNoOfInstall());
			assertEquals(new Short("50"), noOfInstallFromLoanCycleBO
					.getMinNoOfInstall());
			assertEquals(new Short("60"), noOfInstallFromLoanCycleBO
					.getDefaultNoOfInstall());
			noOfInstallFromLoanCycleBO = itr.next();
			assertEquals(new Short("80"), noOfInstallFromLoanCycleBO
					.getMaxNoOfInstall());
			assertEquals(new Short("60"), noOfInstallFromLoanCycleBO
					.getMinNoOfInstall());
			assertEquals(new Short("70"), noOfInstallFromLoanCycleBO
	...
	private LoanPrdActionForm populateLoanPrdActionForm(String loanAmtCalcType,
			String calcInstallmentType, Double maxLoanAmount,
			Double minLoanAmount, Double defLoanAmount, String maxNoOfInstall,
	...
	public LoanPrdActionForm populateLoanAmountFromLastLoanAmount(
			...
			Double lastLoanMaxLoanAmt3, Double lastLoanDefaultLoanAmt3,
			Double lastLoanMinLoanAmt4, Double lastLoanMaxLoanAmt4,
			Double lastLoanDefaultLoanAmt4, Double lastLoanMinLoanAmt5,
			Double lastLoanMaxLoanAmt5, Double lastLoanDefaultLoanAmt5,
			Double lastLoanMinLoanAmt6, Double lastLoanMaxLoanAmt6,
			Double lastLoanDefaultLoanAmt6, LoanPrdActionForm loanPrdActionForm) {
	...
	public LoanPrdActionForm populateNoOfInstallFromLastLoanAmount(
			...
			String maxLoanInstallment3, String defLoanInstallment3,
			String minLoanInstallment4, String maxLoanInstallment4,
			String defLoanInstallment4, String minLoanInstallment5,
			String maxLoanInstallment5, String defLoanInstallment5,
			String minLoanInstallment6, String maxLoanInstallment6,
			String defLoanInstallment6, LoanPrdActionForm loanPrdActionForm) {
	...
	public LoanPrdActionForm populateLoanAmountFromLoanCycle(
			String loanAmtCalcType, Double cycleLoanMinLoanAmt1,
			Double cycleLoanMaxLoanAmt1, Double cycleLoanDefaultLoanAmt1,
			Double cycleLoanMinLoanAmt2, Double cycleLoanMaxLoanAmt2,
			Double cycleLoanDefaultLoanAmt2, Double cycleLoanMinLoanAmt3,
			Double cycleLoanMaxLoanAmt3, Double cycleLoanDefaultLoanAmt3,
			Double cycleLoanMinLoanAmt4, Double cycleLoanMaxLoanAmt4,
			Double cycleLoanDefaultLoanAmt4, Double cycleLoanMinLoanAmt5,
			Double cycleLoanMaxLoanAmt5, Double cycleLoanDefaultLoanAmt5,
			Double cycleLoanMinLoanAmt6, Double cycleLoanMaxLoanAmt6,
	...
	public LoanPrdActionForm populateNoOfInstallFromLoanCycle(
			String calcInstallmentType, String minCycleInstallment1,
			String maxCycleInstallment1, String defCycleInstallment1,
			String minCycleInstallment2, String maxCycleInstallment2,
			String defCycleInstallment2, String minCycleInstallment3,
			String maxCycleInstallment3, String defCycleInstallment3,
			String minCycleInstallment4, String maxCycleInstallment4,
			String defCycleInstallment4, String minCycleInstallment5,
			String maxCycleInstallment5, String defCycleInstallment5,
			String minCycleInstallment6, String maxCycleInstallment6,
			String defCycleInstallment6, LoanPrdActionForm loanPrdActionForm) {

...
public class CollSheetCustBOIntegrationTest extends MifosIntegrationTest {

	public CollSheetCustBOIntegrationTest() throws SystemException, ApplicationException {
        super();
    }
	...
	public void testPopulateAccountDetails() {
		...
		LoanScheduleEntityIntegrationTest.modifyData(accountActionDate,

...
public class MifosAlphaNumTextTagIntegrationTest extends MifosIntegrationTest {
	
	public MifosAlphaNumTextTagIntegrationTest() throws SystemException, ApplicationException {
        super();
    }

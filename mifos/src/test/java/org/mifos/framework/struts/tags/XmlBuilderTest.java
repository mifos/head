...
public class XmlBuilderTest extends TestCase {
    ...
    public void testFragment() throws Exception {
		/* Test the ability to generate part of an XML document:
		   that is, something which would be well-formed
		   if a root start tag and end tag were wrapped around it.
		 */
    	out.text("Hi");
    	out.startTag("p");
    ...
    public void testCompose() throws Exception {
		/*
		   Test the ability to compose XML in little pieces and
		   build it up into a larger document.
		 */

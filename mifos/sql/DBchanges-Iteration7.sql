...
ALTER TABLE SAVINGS_ACTIVITY_DETAILS MODIFY COLUMN CREATED_BY SMALLINT NULL;
ALTER TABLE CUSTOMER_ACCOUNT_ACTIVITY MODIFY COLUMN CREATED_BY SMALLINT NULL;

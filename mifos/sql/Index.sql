...
CREATE INDEX ACCNT_ID_ACTION_DATE_IDX ON ACCOUNT_ACTIONS_DATE (ACCOUNT_ID);

CREATE INDEX CUSTOMER_ID_ACTION_DATE_IDX ON ACCOUNT_ACTIONS_DATE (CUSTOMER_ID);

CREATE INDEX ACTION_DATE_ACCOUNT_IDX ON ACCOUNT_ACTIONS_DATE (ACTION_DATE);

CREATE INDEX ACCNT_DATE_ACTION_DATE_IDX ON ACCOUNT_ACTIONS_DATE (ACCOUNT_ID, ACTION_DATE);

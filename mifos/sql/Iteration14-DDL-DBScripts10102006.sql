...
ALTER TABLE FUND DROP COLUMN GLCODE_ID;
ALTER TABLE FUND ADD COLUMN FUNDCODE_ID SMALLINT NOT NULL;
ALTER TABLE FUND ADD FOREIGN KEY (FUNDCODE_ID) 
  REFERENCES FUND_CODE(FUNDCODE_ID) ON DELETE NO ACTION ON UPDATE NO ACTION; 

ALTER TABLE CUSTOMER_DETAIL ADD COLUMN POVERTY_STATUS INTEGER;
ALTER TABLE CUSTOMER_DETAIL ADD FOREIGN KEY (POVERTY_STATUS) 
  REFERENCES LOOKUP_VALUE(LOOKUP_ID) ON DELETE NO ACTION ON UPDATE NO ACTION;

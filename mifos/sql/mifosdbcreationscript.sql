/*THIS TABLE HAS BEEN MADE MYISAM BECAUSE WE DO NOT NEED TO HAVE TRANSACTIONS ON THIS TABLE*/
...
CREATE TABLE FEES (
  ...
  FOREIGN KEY(UPDATE_TYPE) 
    REFERENCES FEE_UPDATE_TYPE(FEE_UPDATE_TYPE_ID) 
      ON DELETE NO ACTION 
      ON UPDATE NO ACTION
)TYPE=InnoDB CHARACTER SET utf8;
...
CREATE TABLE MEETING (
 ...
 MEETING_PALACE VARCHAR(200) NOT NULL,
 START_DATE DATE NULL,
 END_DATE DATE NULL,
...
CREATE TABLE LOAN_ACCOUNT (
  ...
  INTEREST_RATE_AMOUNT DECIMAL(13, 10) NULL,
  INTEREST_RATE_CURRENCY_ID SMALLINT NULL,
  FUND_ID SMALLINT NULL,
  MEETING_ID INTEGER NULL,
  ...
  FOREIGN KEY(LOAN_BALANCE_CURRENCY_ID)
    REFERENCES CURRENCY(CURRENCY_ID)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
  FOREIGN KEY(INTEREST_RATE_CURRENCY_ID)
    REFERENCES CURRENCY(CURRENCY_ID)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
  FOREIGN KEY(FUND_ID)
...
CREATE TABLE ACCOUNT_ACTIONS_DATE (
  ID INTEGER NOT NULL AUTO_INCREMENT,
  ACCOUNT_ID INTEGER NOT NULL,
  CUSTOMER_ID INTEGER NOT NULL,
  CURRENCY_ID SMALLINT NULL,
...
CREATE TABLE ACCOUNT_FEES (
  ...
  FEE_AMNT_CURRENCY_ID SMALLINT NULL,
  ...
  FOREIGN KEY(ACCOUNT_FEE_AMNT_CURRENCY_ID)
    REFERENCES CURRENCY(CURRENCY_ID)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
  FOREIGN KEY(FEE_AMNT_CURRENCY_ID)
    REFERENCES CURRENCY(CURRENCY_ID)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
...
CREATE TABLE SAVINGS_ACCOUNT (
  ...
  FREQ_FOR_INT_POST INTEGER NULL,
  MIN_AMNT_FOR_INT DECIMAL(10,3) NULL,
  MIN_AMNT_FOR_INT_CURRENCY_ID SMALLINT NULL,
  PRIMARY KEY(ACCOUNT_ID),
  FOREIGN KEY(ACCOUNT_ID)
...
CREATE TABLE ACCOUNT_FEES_ACTION_DETAIL (
  ...
  FOREIGN KEY(ID)
    REFERENCES ACCOUNT_ACTIONS_DATE(ID)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
  FOREIGN KEY(AMOUNT_CURRENCY_ID)
    REFERENCES CURRENCY(CURRENCY_ID)

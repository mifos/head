...
public class DailyTimeDimensionLoader {
	...
	public void tJava_1Process() throws TalendException {
		try {
			...
			boolean exists = stmt
					.execute("select time_id from time_dim_ where date like '"
							+ new java.sql.Date(startDate.getTimeInMillis())
							+ "'");
			if (!exists) {
				String statementString = "insert into time_dim_ ("
...
/*******************************************************************************
 * 19248 characters generated by Talend OpenStudio on the April 9, 2008 2:34:40
 * PM BST
 ******************************************************************************/

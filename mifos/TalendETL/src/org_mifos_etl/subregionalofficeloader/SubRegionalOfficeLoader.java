	...
	public void tMysqlInput_1Process() throws TalendException {
		...
		try {
			...
			while (rsTable_tMysqlOutput_4.next()) {
				...
				if (table_tMysqlOutput_4
						.equalsIgnoreCase("subregional_office_dim")) {
			...
			java.sql.ResultSet rs_tMysqlInput_1 = stmt_tMysqlInput_1
					.executeQuery("SELECT office.GLOBAL_OFFICE_NUM, office.OFFICE_LEVEL_ID, office.SEARCH_ID,  office.MAX_CHILD_COUNT, office.LOCAL_REMOTE_FLAG, office.DISPLAY_NAME, office.CREATED_BY,  office.CREATED_DATE, office.UPDATED_BY, office.UPDATED_DATE, office.OFFICE_SHORT_NAME,  office.PARENT_OFFICE_ID parent_id, office.STATUS_ID, office.VERSION_NO, office.OFFICE_CODE_ID, (select global_office_num from office o where parent_id = o.office_id)  parent_office_num FROM office where office.OFFICE_LEVEL_ID = 3");
	...
	public void tMysqlInput_3Process() throws TalendException {
		...
		try {
			...
			java.sql.ResultSet rs_tMysqlInput_3 = stmt_tMysqlInput_3
					.executeQuery("SELECT regional_office_dim.office_id, regional_office_dim.global_office_num,  regional_office_dim.office_level_id, regional_office_dim.search_id,  regional_office_dim.max_child_count, regional_office_dim.local_remote_flag,  regional_office_dim.display_name, regional_office_dim.created_by, regional_office_dim.created_date,  regional_office_dim.updated_by, regional_office_dim.updated_date,  regional_office_dim.office_short_name, regional_office_dim.head_office_id,  regional_office_dim.status_id, regional_office_dim.version_no, regional_office_dim.office_code_id  FROM regional_office_dim");
			...
			globalMap
					.put(
							"tMysqlInput_3_QUERY",
							"SELECT regional_office_dim.office_id, regional_office_dim.global_office_num,  regional_office_dim.office_level_id, regional_office_dim.search_id,  regional_office_dim.max_child_count, regional_office_dim.local_remote_flag,  regional_office_dim.display_name, regional_office_dim.created_by, regional_office_dim.created_date,  regional_office_dim.updated_by, regional_office_dim.updated_date,  regional_office_dim.office_short_name, regional_office_dim.head_office_id,  regional_office_dim.status_id, regional_office_dim.version_no, regional_office_dim.office_code_id  FROM regional_office_dim");
			...
			while (rs_tMysqlInput_3.next()) {
				...
				if (colQtyInRs_tMysqlInput_3 < 13) {
					...
					row2.head_office_id = null;

				} else {

					if (rs_tMysqlInput_3.getObject(13) != null) {
						row2.head_office_id = rs_tMysqlInput_3.getShort(13);
					} else {
				...
				row2_HashRow.head_office_id = row2.head_office_id;
...
/*******************************************************************************
 * 90913 characters generated by Talend OpenStudio on the March 14, 2008 1:54:25
 * PM GMT
 ******************************************************************************/

...
//
// ============================================================================ 
package org_mifos_etl.loanofficerdimensionloader;
...
/**
 * Job: LoanOfficerDimensionLoader Purpose: Load the MFI personnel information<br>
 ...
 * @status DEV
 */
public class LoanOfficerDimensionLoader {
	...
	private static final String jobName = "LoanOfficerDimensionLoader";
	...
	private class TalendException extends Exception {
		...
		private LoanOfficerDimensionLoader c = null;

		private TalendException(LoanOfficerDimensionLoader c, Exception e) {
			this.e = e;
			this.c = c;
		}
	...
	public static synchronized int runJob(String[] args) {
		...
		try {
			java.io.InputStream inContext = LoanOfficerDimensionLoader.class
					.getClassLoader()
					.getResourceAsStream(
							"org_mifos_etl/loanofficerdimensionloader/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = LoanOfficerDimensionLoader.class.getClassLoader()
						.getResourceAsStream(
								"org_mifos_etl/loanofficerdimensionloader/contexts/"
		...
		final LoanOfficerDimensionLoader LoanOfficerDimensionLoaderClass = new LoanOfficerDimensionLoader();
		LoanOfficerDimensionLoaderClass.tStatCatcher_1.addMessage("begin");
		try {
			LoanOfficerDimensionLoaderClass.tStatCatcher_1Process();
		} catch (Exception e) {
			e.printStackTrace();
		}
		try {
			errorCode = null;
			LoanOfficerDimensionLoaderClass.tJava_1Process();
			status = "end";
		...
		LoanOfficerDimensionLoaderClass.tStatCatcher_1.addMessage(
...
/*******************************************************************************
 * 97609 characters generated by Talend OpenStudio on the April 2, 2008 4:20:38
 * PM BST
 ******************************************************************************/

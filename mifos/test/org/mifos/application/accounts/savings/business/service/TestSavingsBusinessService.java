...
public class TestSavingsBusinessService extends TestCase {
	...
	public TestSavingsBusinessService() {
	}

	public TestSavingsBusinessService(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		super.setUp();
		service = (SavingsBusinessService) ServiceFactory
	...
	public void testGetSavingProducts()throws Exception{		
		...
		List<PrdOfferingView> products=service.getSavingProducts(null,group.getCustomerLevel(),CustomerConstants.GROUP_LEVEL_ID);
		assertEquals(Integer.valueOf("2").intValue(),products.size());
		assertEquals("Offerng name for the first product do not match.",products.get(0).getPrdOfferingName(),"SavingPrd1");
		assertEquals("Offerng name for the second product do not match.",products.get(1).getPrdOfferingName(),"SavingPrd2");
	}

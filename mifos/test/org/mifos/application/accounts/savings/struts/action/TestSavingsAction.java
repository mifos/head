...
public class TestSavingsAction extends MockStrutsTestCase {
	...
	public TestSavingsAction() {
	}

	public TestSavingsAction(String name) {
		super(name);
	}
	...
	public void testGetPrdOfferings(){
		...
		savingsOffering1 = createSavingsOffering();
		savingsOffering2 = createSavingsOffering();
		...
		List<PrdOfferingView> savingPrds=(List<PrdOfferingView>) request.getSession().getAttribute(SavingsConstants.SAVINGS_PRD_OFFERINGS);
	...
	public void testSuccessfullLoad(){
		...
		savingsObj = (SavingsBO)request.getSession().getAttribute(Constants.BUSINESS_KEY);

		assertNotNull(request.getSession().getAttribute(MasterConstants.INTEREST_CAL_TYPES));
		assertNotNull(request.getSession().getAttribute(MasterConstants.SAVINGS_TYPE));
		assertNotNull(request.getSession().getAttribute(MasterConstants.RECOMMENDED_AMOUNT_UNIT));
		assertNotNull(request.getSession().getAttribute(SavingsConstants.CUSTOM_FIELDS));
	...
	public void testSuccessfulSave(){
		...
		savings.setRecommendedAmntUnit(savingsOffering.getRecommendedAmntUnit());
	...
	public void testSuccessfulSaveInActiveState(){
		...
		savingsOffering=createSavingsOffering();
		//addRequestParameter("selectedPrdOfferingId", savingsOffering.getPrdOfferingId().toString());
		addRequestParameter("stateSelected",Short.toString(AccountStates.SAVINGS_ACC_APPROVED));
	...
	public void testSuccessfulGetBySystemId(){
		...
		savingsOffering = createSavingsOffering();
		addRequestParameter("input","preview");
		savings = createSavingsAccount("000X00000000013",savingsOffering,AccountStates.SAVINGS_ACC_PARTIALAPPLICATION);
		addRequestParameter("globalAccountNum","000X00000000013");
		setRequestPathInfo("/savingsAction.do");
		addRequestParameter("method","get");
        actionPerform();
		verifyForward("get_success");
		SavingsBO savingsObj = (SavingsBO)request.getSession().getAttribute(Constants.BUSINESS_KEY);
		assertEquals(savings.getGlobalAccountNum(),savingsObj.getGlobalAccountNum());
		assertEquals(savingsOffering.getRecommendedAmount().getAmountDoubleValue(),savingsObj.getRecommendedAmount().getAmountDoubleValue());
		verifyNoActionErrors();
		verifyNoActionMessages();
	}
	...
	public void testSuccessfulEdit(){
		createInitialObjects();
		savingsOffering = createSavingsOffering();
		savings = createSavingsAccount("000X00000000014",savingsOffering, AccountStates.SAVINGS_ACC_PARTIALAPPLICATION);
		request.getSession().setAttribute(Constants.BUSINESS_KEY,savings);
		setRequestPathInfo("/savingsAction.do");
	...
	public void testSuccessfulEditPrevious(){
		createInitialObjects();
		savingsOffering = createSavingsOffering();
		savings = createSavingsAccount("000X00000000016",savingsOffering, AccountStates.SAVINGS_ACC_PARTIALAPPLICATION);
		request.getSession().setAttribute(Constants.BUSINESS_KEY,savings);
		setRequestPathInfo("/savingsAction.do");
	...
	public void testSuccessfulUpdate(){
		createInitialObjects();
		savingsOffering = createSavingsOffering();
		savings = createSavingsAccount("000X00000000017",savingsOffering,AccountStates.SAVINGS_ACC_PARTIALAPPLICATION);
		savings.setCustomer(group);
		savings.setSavingsOffering(savingsOffering);
		request.getSession().setAttribute(Constants.BUSINESS_KEY,savings);
		savings.setRecommendedAmount(new Money(TestObjectFactory.getMFICurrency(),"600.0"));
		setRequestPathInfo("/savingsAction.do");
		addRequestParameter("method","update");
        actionPerform();
		verifyForward("update_success");
		assertEquals(new Double(600).doubleValue(),savings.getRecommendedAmount().getAmountDoubleValue());
		verifyNoActionErrors();
		verifyNoActionMessages();
	}
	...
	public void testSuccessfulUpdateInActiveState(){
		...
		createInitialObjects();
		savingsOffering = createSavingsOffering();
		savings = createSavingsAccount("000X00000000017",savingsOffering,AccountStates.SAVINGS_ACC_APPROVED);
		savings.setCustomer(group);
		savings.setSavingsOffering(savingsOffering);
		savings.setRecommendedAmount(new Money(TestObjectFactory.getMFICurrency(),"600.0"));
		request.getSession().setAttribute(SavingsConstants.RECOMMENDED_AMOUNT,savings.getRecommendedAmount());
		request.getSession().setAttribute(Constants.BUSINESS_KEY,savings);
		setRequestPathInfo("/savingsAction.do");
		addRequestParameter("method","update");
        actionPerform();
	...
	public void testMultipleCreatesInBetweenUpdate()throws Exception{
		...
		SavingsBO savingsObj = (SavingsBO)request.getSession().getAttribute(Constants.BUSINESS_KEY);
		savingsObj.setRecommendedAmount(new Money(TestObjectFactory.getMFICurrency(),"400"));
		setRequestPathInfo("/savingsAction.do");
		addRequestParameter("method","update");
        actionPerform();
		verifyForward("update_success");
		...
		savingsOffering3 = createSavingsOffering();
		addRequestParameter("stateSelected",Short.toString(AccountStates.SAVINGS_ACC_PARTIALAPPLICATION));
		...
		savings3.setRecommendedAmntUnit(savingsOffering3.getRecommendedAmntUnit());
	...
	public void testSuccessfulGetRecentActivity(){
		createInitialObjects();
		savingsOffering = createSavingsOffering();
		savings = createSavingsAccount("000X00000000018",savingsOffering, AccountStates.SAVINGS_ACC_PARTIALAPPLICATION);
		request.getSession().setAttribute(Constants.BUSINESS_KEY,savings);
		try{
			SessionUtils.setAttribute(Constants.USER_CONTEXT_KEY,TestObjectFactory.getUserContext(),request.getSession());
		}catch(Exception e){
		...
		verifyNoActionErrors();
		verifyNoActionMessages();
		assertEquals(((List<SavingsRecentActivityView>)request.getSession().getAttribute(SavingsConstants.RECENTY_ACTIVITY_LIST)).size(),0);
	}

	public void testSuccessfulGetTransactionHistory(){
		createInitialObjects();
		savingsOffering = createSavingsOffering();
		savings = createSavingsAccount("000X00000000019",savingsOffering, AccountStates.SAVINGS_ACC_PARTIALAPPLICATION);
		request.getSession().setAttribute(Constants.BUSINESS_KEY,savings);
		try{
			SessionUtils.setAttribute(Constants.USER_CONTEXT_KEY,TestObjectFactory.getUserContext(),request.getSession());
		}catch(Exception e){
		...
		verifyNoActionErrors();
		verifyNoActionMessages();
		assertEquals(((List<SavingsTransactionHistoryView>)request.getSession().getAttribute(SavingsConstants.TRXN_HISTORY_LIST)).size(),0);
	}
	...
	public void testGetDepositDueDetails() throws Exception{
		...
		createInitialObjects();
		savingsOffering = createSavingsOffering();
		savings = createSavingsAccount("000X00000000020",savingsOffering, AccountStates.SAVINGS_ACC_PARTIALAPPLICATION);
		HibernateUtil.closeSession();
		request.getSession().setAttribute(Constants.BUSINESS_KEY,savings);
		SessionUtils.setAttribute(Constants.USER_CONTEXT_KEY,TestObjectFactory.getUserContext(),request.getSession());
		setRequestPathInfo("/savingsAction.do");
	...
	public void testWaiveAmountDue() throws Exception{
		createInitialObjects();
		savingsOffering = createSavingsOffering();
		savings = createSavingsAccount("000X00000000019",savingsOffering, AccountStates.SAVINGS_ACC_APPROVED);
		HibernateUtil.closeSession();
		request.getSession().setAttribute(Constants.BUSINESS_KEY,savings);
		SessionUtils.setAttribute(Constants.USER_CONTEXT_KEY,TestObjectFactory.getUserContext(),request.getSession());
		setRequestPathInfo("/savingsAction.do");
	...
	private SavingsBO createSavingsAccount(String globalAccountNum,SavingsOfferingBO savingsOffering, short accountStateId){

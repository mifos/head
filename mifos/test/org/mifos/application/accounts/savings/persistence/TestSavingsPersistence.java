...
public class TestSavingsPersistence extends TestCase {
	...
	public TestSavingsPersistence() {
	}

	public TestSavingsPersistence(String name) {
		super(name);
	}
	...
	public void testGetSavingsProducts() throws Exception{
		...
		List<PrdOfferingView> products = savingsPersistence
				.getSavingsProducts(null, group.getCustomerLevel(),
						new Short("2"));
	...
	public void testFindById()throws Exception {
		...
		SavingsBO savings1 = savingsPersistence.findById(savings
				.getAccountId());
	...
	public void testRetrieveAllAccountStateList() throws NumberFormatException, PersistenceException{
		List<AccountStateEntity> accountStateEntityList = savingsPersistence.retrieveAllAccountStateList(Short.valueOf("2"));
	...
	public void testGetStatusChecklist() {
		createCheckList();
		List statusCheckList = savingsPersistence.getStatusChecklist(Short.valueOf("13"),Short.valueOf("2"));
	...
	public void testGetAccountsPendingForIntCalc()throws Exception{
		...
		savings = helper.createSavingsAccount("000100000000021",savingsOffering, group, AccountStates.SAVINGS_ACC_INACTIVE,userContext);
		savings1 = helper.createSavingsAccount("000100000000022",savingsOffering1, group, AccountStates.SAVINGS_ACC_PARTIALAPPLICATION,userContext);
		savings2= helper.createSavingsAccount("000100000000023",savingsOffering2, group, AccountStates.SAVINGS_ACC_APPROVED,userContext);
	...
	public void testGetAccountsPendingForIntPost()throws Exception{
		...
		List<Integer> savingsList =  savingsPersistence.retreiveAccountsPendingForIntPosting(helper.getDate("01/08/2006"));
		assertEquals(Integer.valueOf("1").intValue(), savingsList.size());

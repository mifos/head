...
public class MoratoriumBusinessServiceTest
	...
	public void testGetMoratoriums() throws Exception {
		...
		List<MoratoriumBO> moratoriums = new MoratoriumBusinessService().getMoratoriums();
	...
	public void testGetMoratoriumById() throws Exception{
		...
		List<MoratoriumBO> moratorium = new MoratoriumBusinessService().getMoratoriumById("2");
	...
	public void testGetMoratoriumByCustomerId() throws Exception{
		...
		List<MoratoriumBO> moratorium = new MoratoriumBusinessService().getMoratoriumByCustomerId("1");
		assertNotNull(moratorium);
		assertEquals(1, moratorium.size());
	}
	...
	public void testGetMoratoriumByOfficeId() throws Exception{
		...
		List<MoratoriumBO> moratorium = new MoratoriumBusinessService().getMoratoriumByOfficeId("1");
		assertNotNull(moratorium);
		assertEquals(1, moratorium.size());
	}
}

...
public class TestHolidayUtils extends MifosTestCase {
    ...
    */
	 ...
	 */
	private HolidayBO[] createHolidayCollection(String holidayDateList, String ruleList) throws ApplicationException, ParseException {
	...
	private HolidayBO createHoliday(Date holidayStartDate, Date holidayEndDate, 
									Short repaymentRule, String holidayName) throws ApplicationException {
		// Create Holiday
		HolidayPK holidayPK = new HolidayPK((short)1, holidayStartDate);

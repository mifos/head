...
public class TestReportsPersistenceService extends MifosTestCase {
	...
	public void testGetAllReportCategories() {
		...
		List<ReportsCategoryBO> listOfReportCategories = reportsPersistenceService
				.getAllReportCategories();

		assertEquals(7, listOfReportCategories.size());
		assertEquals("1", ((ReportsCategoryBO) listOfReportCategories.get(0))
				.getReportCategoryId().toString());
		assertEquals("Client Detail",
				((ReportsCategoryBO) listOfReportCategories.get(0))
						.getReportCategoryName());
		assertEquals("2", ((ReportsCategoryBO) listOfReportCategories.get(1))
				.getReportCategoryId().toString());
		assertEquals("Performance", ((ReportsCategoryBO) listOfReportCategories
		...
		assertEquals("Loan Product Detail",
				((ReportsCategoryBO) listOfReportCategories.get(3))
						.getReportCategoryName());
		assertEquals("5", ((ReportsCategoryBO) listOfReportCategories.get(4))
				.getReportCategoryId().toString());
		assertEquals("Status", ((ReportsCategoryBO) listOfReportCategories
				.get(4)).getReportCategoryName());
		assertEquals("6", ((ReportsCategoryBO) listOfReportCategories.get(5))
				.getReportCategoryId().toString());
		assertEquals("Analysis", ((ReportsCategoryBO) listOfReportCategories
				.get(5)).getReportCategoryName());
		assertEquals("7", ((ReportsCategoryBO) listOfReportCategories.get(6))
				.getReportCategoryId().toString());
		assertEquals("Miscellaneous",
				((ReportsCategoryBO) listOfReportCategories.get(6))
						.getReportCategoryName());
	...
	public void testGetAllReportsForACategory() {
		...
		List<ReportsCategoryBO> listOfReportCategories = reportsPersistenceService
				.getAllReportCategories();
		Set<ReportsBO> reportsSet = ((ReportsCategoryBO) listOfReportCategories
				.get(0)).getReportsSet();

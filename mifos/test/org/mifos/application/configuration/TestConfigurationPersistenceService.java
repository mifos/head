 ...
 * TestConfigurationPersistenceService.java    version: 1.0
...
public class TestConfigurationPersistenceService extends MifosTestCase {
	...
	public void testGetLookupEntities() {
		assertNotNull(configurationPersistenceService.getLookupEntities());
	}

	public void testGetLookupValues() {
		assertNotNull(configurationPersistenceService.getLookupValues());
	}

	public void testGetSupportedLocale() {
		assertNotNull(configurationPersistenceService.getSupportedLocale());
	}

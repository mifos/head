...
public class TestCollSheetSavingsDetailsEntity extends MifosTestCase {
	...
	public void testForMandatoryAccountWithNoPreviousPayments()throws SystemException,ApplicationException   {
		...
		//Scenario: Mandatory savings Account: None of the previous installments have been paid and hence with a deposit
		//of 200, total overdue amount is 400 and due amount for next meeting date is 200
		...
		accountActionDate.setDepositPaid(new Money(TestObjectFactory.getMFICurrency(),100.00));
		collSheetSavingsDetail.addAccountDetails(savings.getAccountActionDate((short)3));
		...
		accountActionDate.setDepositPaid(new Money(TestObjectFactory.getMFICurrency(),200.00));
		accountActionDate.setPaymentStatus(AccountConstants.PAYMENT_PAID);
		collSheetSavingsDetail.addAccountDetails(savings.getAccountActionDate((short)3));
		assertEquals(200.00 ,collSheetSavingsDetail.getAmntOverDue().getAmountDoubleValue());
		assertEquals(200.00 ,collSheetSavingsDetail.getRecommendedAmntDue().getAmountDoubleValue());

	}
	public void testForMandatoryAccountWithPartialPayment()throws SystemException,ApplicationException   {
	...
	public void testForMandatoryAccountWithFullPayment()throws SystemException,ApplicationException   {
	...
	public void testForVoluntaryAccountWithPartialPayment()throws SystemException,ApplicationException   {
	...
	public void testForVoluntaryAccountWithFullPayment()throws SystemException,ApplicationException   {
	...
	public void testTotalSavingsAmountDueForVoluntaryAccount()throws SystemException,ApplicationException   {
		...
		accountActionDate.setPaymentStatus(AccountConstants.PAYMENT_PAID);
		collSheetSavingsDetail.addAccountDetails(savings.getAccountActionDate((short)3));
		assertEquals(200.00 ,collSheetSavingsDetail.getTotalSavingsAmntDue().getAmountDoubleValue());
	}
	
	public void testTotalSavingsAmountDueForMandatoryAccount()throws SystemException,ApplicationException   {
		...
		accountActionDate.setPaymentStatus(AccountConstants.PAYMENT_PAID);
		collSheetSavingsDetail.addAccountDetails(savings.getAccountActionDate((short)3));
		assertEquals(400.00 ,collSheetSavingsDetail.getTotalSavingsAmntDue().getAmountDoubleValue());
	}
	...
	private SavingsBO createSavingsAccount(short savingsType){
		...
		return TestObjectFactory.createSavingsAccount("43245434",
				client1, (short)16, new Date(System.currentTimeMillis()), savingsOffering);

...
ruby -I ./modules -S modules/ProductCategory/ProductCategory_main.rb
ruby -I ./modules -S modules/LoanProduct/LoanProduct_Main.rb
ruby -I ./modules -S modules/Centers/CenterTest.rb
ruby -I ./modules -S modules/Groups/GroupTest.rb

...
class FeeOnetime < TestClass
  ...
  def man_search_account()
    begin
      ...
      assert($ie.contains_text("Please enter the name to be searched in the application"))
  ...
  def search_account(feetype)
    begin
      data_connection(feetype)
      puts @@global_account_num

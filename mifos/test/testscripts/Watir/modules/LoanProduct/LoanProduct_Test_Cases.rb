...
class LoanProduct_Test_Cases < TestClass
  ...
  def Check_LoanProduct_Links()
    begin    
      assert($ie.contains_text($view_loanproduct_link)) and assert($ie.contains_text($new_loanproduct_link))
        $logger.log_results("LoanProduct- Check for loanproduct links on admin page", "Click on admin link","The links should be there","Passed")
      rescue =>e
        $logger.log_results("LoanProduct- Check for loanproduct links on admin page", "Click on admin link","The links should be there","Failed")
    end
  end
  ...
  def Check_New_LoanProduct()
    begin      
      assert($ie.contains_text($new_loanproduct_page_msg))
  ...
  def check_validation_error(prd_inst_name, short_name,description, prd_category, start_date, appl_for, min_ammount,
   max_ammount,default_ammount, interestrate_type, max_interestrate, min_interestrate, def_interestrate, installments_frequency,
    max_installments, min_installments, def_installments, interest_glcode, principal_glcode,	penalities_glcode)
      ...
      if $ie.contains_text($review_loanproduct_info)
  ...
  def Man_New_LoanProduct()
    begin  
      ...
      assert($ie.contains_text($new_loanproduct_page_msg)) and assert($ie.contains_text($loanproduct_prd_inst_name_msg))\
      and assert($ie.contains_text($loanproduct_shortname_msg)) and assert($ie.contains_text($loanproduct_prd_category_msg))\
      and assert($ie.contains_text($loanproduct_appl_for_msg)) and assert($ie.contains_text($loanproduct_interestrate_type_msg))\
      and assert($ie.contains_text($loanproduct_max_interestrate_msg)) and assert($ie.contains_text($loanproduct_min_interestrate_msg))\
      and assert($ie.contains_text($loanproduct_def_interestrate_msg)) and assert($ie.contains_text($loanproduct_max_emi_msg))\
      and assert($ie.contains_text($loanproduct_min_emi_msg)) and assert($ie.contains_text($loanproduct_def_emi_msg))\
      and assert($ie.contains_text($loanproduct_glcode_interest_msg)) and assert($ie.contains_text($loanproduct_glcode_principal_msg))\
      and assert($ie.contains_text($loanproduct_glcode_penalty_msg))
    ...
    begin
      ...
      $ie.button(:value,"Preview").click
      max_field_len(prd_inst_name,50,$loanproduct_prd_inst_name_length_msg)
      assert($ie.contains_text($new_loanproduct_page_msg)) and assert(!$ie.contains_text($loanproduct_prd_inst_name_msg))\
      and assert($ie.contains_text($loanproduct_shortname_msg)) and assert($ie.contains_text($loanproduct_prd_category_msg))\
      and assert($ie.contains_text($loanproduct_appl_for_msg)) and assert($ie.contains_text($loanproduct_interestrate_type_msg))\
      and assert($ie.contains_text($loanproduct_max_interestrate_msg)) and assert($ie.contains_text($loanproduct_min_interestrate_msg))\
    ...
    begin
      ...
      assert(!$ie.contains_text($loanproduct_shortname_msg)) and \
      assert($ie.contains_text($new_loanproduct_page_msg))and assert($ie.contains_text($loanproduct_prd_category_msg))\
      and assert($ie.contains_text($loanproduct_appl_for_msg)) and assert($ie.contains_text($loanproduct_interestrate_type_msg))\
      and assert($ie.contains_text($loanproduct_max_interestrate_msg)) and assert($ie.contains_text($loanproduct_min_interestrate_msg))\
      and assert($ie.contains_text($loanproduct_def_interestrate_msg)) and assert($ie.contains_text($loanproduct_max_emi_msg))\
      and assert($ie.contains_text($loanproduct_min_emi_msg)) and assert($ie.contains_text($loanproduct_def_emi_msg))\
    ...
    begin
     ...
     # set_value_txtfield("prdOfferingShortName", short_name)
      ...
      assert(!$ie.contains_text($loanproduct_prd_category_msg)) and assert($ie.contains_text($new_loanproduct_page_msg))\
      and assert($ie.contains_text($loanproduct_appl_for_msg)) and assert($ie.contains_text($loanproduct_interestrate_type_msg))\
      and assert($ie.contains_text($loanproduct_max_interestrate_msg)) and assert($ie.contains_text($loanproduct_min_interestrate_msg))\
      and assert($ie.contains_text($loanproduct_def_interestrate_msg)) and assert($ie.contains_text($loanproduct_max_emi_msg))\
      and assert($ie.contains_text($loanproduct_min_emi_msg)) and assert($ie.contains_text($loanproduct_def_emi_msg))\
    ...
    begin
      ...
      assert(!$ie.contains_text($loanproduct_appl_for_msg)) and assert($ie.contains_text($new_loanproduct_page_msg))\
      and assert($ie.contains_text($loanproduct_interestrate_type_msg))\
      and assert($ie.contains_text($loanproduct_max_interestrate_msg)) and assert($ie.contains_text($loanproduct_min_interestrate_msg))\
      and assert($ie.contains_text($loanproduct_def_interestrate_msg)) and assert($ie.contains_text($loanproduct_max_emi_msg))\
      and assert($ie.contains_text($loanproduct_min_emi_msg)) and assert($ie.contains_text($loanproduct_def_emi_msg))\
      and assert($ie.contains_text($loanproduct_glcode_interest_msg)) and assert($ie.contains_text($loanproduct_glcode_principal_msg))\
      and assert($ie.contains_text($loanproduct_glcode_penalty_msg))
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "prd_inst_name, short_name, prd_category, appl_for","All validation error message","Passed")     
      rescue Test::Unit::AssertionFailedError=>e
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "prd_inst_name, short_name, prd_category, appl_for","All validation error message","Failed")
     end    
   end
    ...
    def check_error_message_max_loan_amount(max_ammount) 
        ...
        $ie.button(:value,"Preview").click
        max_error_message_number(max_ammount,9999999.9,$loanproduct_max_ammount_msg ,"max loan amount")    
    end
    ...
    def check_error_message_min_loan_amount(min_ammount)
        ...
        $ie.button(:value,"Preview").click
        max_error_message_number(min_ammount,9999999.9,$loanproduct_min_ammount_msg ,"min loan amount")    
    end
    ...
    def check_error_message_default_loan_amount(default_ammount)
        ...
        $ie.button(:value,"Preview").click
        max_error_message_number(default_ammount,9999999.9,$loanproduct_def_ammount_msg ,"default loan amount")    
    end
      # Check for validation messages while creating new LoanProduct with prd_inst_name, short_name, prd_category,
    ...
    begin
      ...
      assert(!$ie.contains_text($loanproduct_interestrate_type_msg)) and assert($ie.contains_text($new_loanproduct_page_msg))\
      and assert($ie.contains_text($loanproduct_max_interestrate_msg)) and assert($ie.contains_text($loanproduct_min_interestrate_msg))\
      and assert($ie.contains_text($loanproduct_def_interestrate_msg)) and assert($ie.contains_text($loanproduct_max_emi_msg))\
      and assert($ie.contains_text($loanproduct_min_emi_msg)) and assert($ie.contains_text($loanproduct_def_emi_msg))\
      and assert($ie.contains_text($loanproduct_glcode_interest_msg)) and assert($ie.contains_text($loanproduct_glcode_principal_msg))\
    ...
    begin
      ...
      $ie.button(:value,"Preview").click
      max_error_message_number(max_interestrate,999,$loanproduct_max_interestrate_msg_size,"Max interest rate")
      assert(!$ie.contains_text($loanproduct_max_interestrate_msg)) and \
      assert($ie.contains_text($new_loanproduct_page_msg)) and assert($ie.contains_text($loanproduct_min_interestrate_msg))\
      and assert($ie.contains_text($loanproduct_def_interestrate_msg)) and assert($ie.contains_text($loanproduct_max_emi_msg))\
      and assert($ie.contains_text($loanproduct_min_emi_msg)) and assert($ie.contains_text($loanproduct_def_emi_msg))\
      and assert($ie.contains_text($loanproduct_glcode_interest_msg)) and assert($ie.contains_text($loanproduct_glcode_principal_msg))\
      and assert($ie.contains_text($loanproduct_glcode_penalty_msg))
    ...
    begin
      ...
      $ie.button(:value,"Preview").click
      max_error_message_number(min_interestrate,999,$loanproduct_min_interestrate_msg_size,"Min interest rate")
      assert(!$ie.contains_text($loanproduct_min_interestrate_msg)) and assert($ie.contains_text($new_loanproduct_page_msg))\
      and assert($ie.contains_text($loanproduct_def_interestrate_msg)) and assert($ie.contains_text($loanproduct_max_emi_msg))\
      and assert($ie.contains_text($loanproduct_min_emi_msg)) and assert($ie.contains_text($loanproduct_def_emi_msg))\
      and assert($ie.contains_text($loanproduct_glcode_interest_msg)) and assert($ie.contains_text($loanproduct_glcode_principal_msg))\
      and assert($ie.contains_text($loanproduct_glcode_penalty_msg))
 ...
 # puts "in Man_New_LoanProduct_with_DefInterestrate \n"
      ...
      $ie.button(:value,"Preview").click
      max_error_message_number(def_interestrate,999,$loanproduct_def_interestrate_msg_size,"Default interest rate")
      assert(!$ie.contains_text($loanproduct_def_interestrate_msg)) and \
      assert($ie.contains_text($new_loanproduct_page_msg))and assert($ie.contains_text($loanproduct_max_emi_msg))\
      and assert($ie.contains_text($loanproduct_min_emi_msg)) and assert($ie.contains_text($loanproduct_def_emi_msg))\
      and assert($ie.contains_text($loanproduct_glcode_interest_msg)) and assert($ie.contains_text($loanproduct_glcode_principal_msg))\
      and assert($ie.contains_text($loanproduct_glcode_penalty_msg))
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "nothing ","All validation error message","Passed")     
...
#  puts "in Man_New_LoanProduct_with_InstallmentsFrequency"
  ...
  def  Man_New_LoanProduct_with_MaxInstallments(max_installments)
   ...
   # puts "in Man_New_LoanProduct_with_MaxInstallments \n"
      ...
      assert(!$ie.contains_text($loanproduct_max_emi_msg)) and assert($ie.contains_text($new_loanproduct_page_msg))\
      and assert($ie.contains_text($loanproduct_min_emi_msg)) and assert($ie.contains_text($loanproduct_def_emi_msg))\
      and assert($ie.contains_text($loanproduct_glcode_interest_msg)) and assert($ie.contains_text($loanproduct_glcode_principal_msg))\
      and assert($ie.contains_text($loanproduct_glcode_penalty_msg)) 
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "nothing ", "All validation error message", "Passed")
  ...
  #  puts "in Man_New_LoanProduct_with_MinInstallments\n"
     ...
     # set_value_txtfield("maxNoInstallments", max_installments)
      ...
      $ie.button(:value,"Preview").click
      assert(!$ie.contains_text($loanproduct_min_emi_msg)) and \
      assert($ie.contains_text($new_loanproduct_page_msg))and assert($ie.contains_text($loanproduct_def_emi_msg))\
      and assert($ie.contains_text($loanproduct_glcode_interest_msg)) and assert($ie.contains_text($loanproduct_glcode_principal_msg))\
      and assert($ie.contains_text($loanproduct_glcode_penalty_msg)) 
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "nothing ", "All validation error message", "Passed")
      rescue=>e
  ...
  def   Man_New_LoanProduct_with_DefInstallments(def_installments)
    ...
    #puts "in Man_New_LoanProduct_with_DefInstallments\n "
      ...
      assert(!$ie.contains_text($loanproduct_def_emi_msg)) and assert($ie.contains_text($new_loanproduct_page_msg))\
      and assert($ie.contains_text($loanproduct_glcode_interest_msg)) and assert($ie.contains_text($loanproduct_glcode_principal_msg))\
      and assert($ie.contains_text($loanproduct_glcode_penalty_msg)) 
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "nothing ", "All validation error message", "Passed")
      rescue=>e
  ...
  def  Man_New_LoanProduct_with_InterestGlcode(interest_glcode)
    ...
    #puts "in  Man_New_LoanProduct_with_InterestGlcode\n "
      ...
      assert(!$ie.contains_text($loanproduct_glcode_interest_msg)) and assert($ie.contains_text($new_loanproduct_page_msg))\
      and assert($ie.contains_text($loanproduct_glcode_principal_msg))\
      and assert($ie.contains_text($loanproduct_glcode_penalty_msg)) 
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "nothing ", "All validation error message", "Passed")
      rescue=>e
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "nothing ","All validation error message","Failed")
  ...
  def  Man_New_LoanProduct_with_PrincipalGlcode(principal_glcode)
   ...
   # puts "in  Man_New_LoanProduct_with_PrincipalGlcode\n "
      ...
      $ie.button(:value,"Preview").click
      assert(!$ie.contains_text($loanproduct_glcode_principal_msg)) and assert($ie.contains_text($new_loanproduct_page_msg)) \
      and assert($ie.contains_text($loanproduct_glcode_penalty_msg)) 
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "nothing ", "All validation error message", "Passed")
      rescue=>e
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "nothing ","All validation error message","Failed")
  ...
  #puts "in Man_New_LoanProduct_with_PenalitiesGlcode\n"
      ...
      assert(!$ie.contains_text($loanproduct_glcode_penalty_msg))      
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "nothing ", "All validation error message", "Passed")
      rescue=>e
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "nothing ","All validation error message","Failed")
     end
...
#     verify_InstallmentFrequency_weeks()
  ...
  def verify_PrdInstName(prd_inst_name)
    begin
      ...
      assert($ie.contains_text($loanproduct_prd_inst_name_length_msg))      
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "prd_inst_name", "All validation error message", "Passed")
      rescue=>e
       $logger.log_results("LoanProduct- Check for validation error while creating new LoanProduct", "prd_inst_name","All validation error message","Failed")
     end
  ...
  if (b!=nil) 
    begin
     assert($ie.contains_text($loanproduct_shortname_space_msg))      
       $logger.log_results("SavingProduct- Error message appears when short_name contains space", short_name, $loanproduct_shortname_space_msg, "Passed")
    rescue=>e
       $logger.log_results("SavingProduct- Error message did not appear when short_name contains space", short_name,$loanproduct_shortname_space_msg,"Failed")
    end
  else
    begin
    assert(!$ie.contains_text($loanproduct_shortname_space_msg))
  ...
  if (max_interestrate.to_f >999)
    begin
        assert($ie.contains_text($loanproduct_max_interestrate_msg))      
        $logger.log_results("Error message appears when interest rate specified is greater than max value", max_interestrate.to_s,$loanproduct_max_interestrate_msg , "Passed")
          rescue=>e
        $logger.log_results("Error message does not appear when interest rate specified is greater than max value", max_interestrate.to_s,$loanproduct_max_interestrate_msg , "failed")
      end
   else
    begin
      assert(!$ie.contains_text($loanproduct_max_interestrate_msg))      
  ...
  def verify_DefInterestRate(def_interestrate)
    begin
      ...
      assert($ie.contains_text($loanproduct_def_interestrate_msg))      
  ...
  def verify_MinInterestRate(min_interestrate)
    begin
      ...
      assert($ie.contains_text($loanproduct_min_interestrate_msg))      
  ...
  def verify_valid_MaxInterestRate(max_interestrate, min_interestrate) 
    begin
      ...
      assert($ie.contains_text($loanproduct_valid_max_interestrate_msg))      
  ...
  def verify_valid_DefInterestRate(def_interestrate, min_interestrate) 
    begin
      ...
      assert($ie.contains_text($loanproduct_valid_def_interestrate_msg))      
  ...
  def verify_MaxAmmount(max_ammount) 
    begin
      ...
      assert($ie.contains_text($loanproduct_max_ammount_msg))      
  ...
  def verify_MinAmmount(min_ammount)  
    begin
      ...
      assert($ie.contains_text($loanproduct_min_ammount_msg))      
  ...
  def verify_DefAmmount(def_ammount)  
    begin
      ...
      assert($ie.contains_text($loanproduct_def_ammount_msg))      
  ...
  def  verify_valid_MaxAmmount(max_ammount, min_ammount) 
    begin
      ...
      assert($ie.contains_text($loanproduct_valid_max_ammount_msg))      
  ...
  def  verify_valid_DefAmmount(def_ammount, min_ammount) 
    begin
      ...
      assert($ie.contains_text($loanproduct_valid_def_ammount_msg))      
  ...
  def verify_MaxInstallments(max_installments)
    begin        
      ...
      assert($ie.contains_text($loanproduct_max_emi_error_msg))      
  ...
  def verify_MinInstallments(min_installments)
    begin        
      ...
      assert($ie.contains_text($loanproduct_min_emi_error_msg))      
  ...
  def verify_DefInstallments(def_installments)
    begin        
      ...
      assert($ie.contains_text($loanproduct_def_emi_error_msg))      
  ...
  def verify_valid_MaxInstallments(max_installments, min_installments)
    begin        
      ...
      assert($ie.contains_text($loanproduct_valid_max_emi_msg))      
  ...
  def verify_valid_DefInstallments(def_installments, min_installments)
    begin        
      ...
      assert($ie.contains_text($loanproduct_valid_def_emi_msg))      
  ...
  def verify_InstallmentFrequency_weeks()
    begin  
      ...
      $ie.button(:value,"Preview").click                  
      assert($ie.contains_text($loanproduct_emi_frequency_weeks_msg))      
   ...
   def verify_InstallmentFrequency_months()
    begin
      ...
      $ie.button(:value,"Preview").click                  
      assert($ie.contains_text($loanproduct_emi_frequency_months_msg))      
  ...
  def Dupl_loan_product_instance_name_shortname(prd_inst_name,short_name)
    ...
    if (number_of_products.to_i > 0) and (number_of_shortname.to_i > 0)
      ...
      begin 
      assert($ie.contains_text($loanproduct_dupl_inst_name_msg)) and \
      assert($ie.contains_text($loanproduct_dupl_short_name_msg))
      $logger.log_results("Error message appears for duplicate product instance name",prd_inst_name.to_s,$loanproduct_dupl_inst_name_msg,"passed")
      $logger.log_results("Error message appears for duplicate product instance short name",short_name.to_s,$loanproduct_dupl_short_name_msg,"passed")
      rescue Test::Unit::AssertionFailedError=>e
      $logger.log_results("Error message does not appear when both instance name and short name already exist",prd_inst_name.to_s," , "+short_name.to_s,$loanproduct_dupl_inst_name_msg+" and "+$loanproduct_dupl_short_name_msg,"failed")      
      end
    elsif (number_of_products.to_i > 0) and (number_of_shortname.to_i == 0) 
      $ie.button(:value,"Submit").click
      begin
      assert($ie.contains_text($loanproduct_dupl_inst_name_msg))
      $logger.log_results("Error message appears for duplicate product instance name",prd_inst_name.to_s,$loanproduct_dupl_inst_name_msg,"passed")
      rescue Test::Unit::AssertionFailedError=>e
      $logger.log_results("Error message does not appear for duplicate product instance name",prd_inst_name.to_s,$loanproduct_dupl_inst_name_msg,"failed") 
      end
    elsif (number_of_products.to_i == 0) and (number_of_shortname.to_i > 0)
      $ie.button(:value,"Submit").click
      begin 
      ...
      $logger.log_results("Error message does not appear for duplicate product instance short name",short_name.to_s,$loanproduct_dupl_short_name_msg,"failed")      
      end
    else
      $ie.button(:value,"Submit").click
    end
  ...
  def Create_New_LoanProduct(prd_inst_name, short_name, prd_category, start_date, appl_for, min_ammount,
   max_ammount,def_ammount, interestrate_type, max_interestrate, min_interestrate, def_interestrate, installments_frequency,
    ...
    begin
    puts "Function: Create_New_LoanProduct"
  ...
  def set_LoanProduct_data(prd_inst_name, short_name, prd_category, start_date, appl_for, min_ammount,
    ...
    max_installments, min_installments, def_installments, interest_glcode, principal_glcode, penalities_glcode)
    begin      
          if($ie.contains_text($new_loanproduct_page_msg))
  ...
  def  validate_LoanProduct_preview_page(prd_inst_name, short_name, prd_category, start_date, appl_for, min_ammount,
    ...
    begin
      if $ie.contains_text($review_loanproduct_info) then
   ...
   #puts "###################### IN preview ########################"
       ...
       assert_on_page("Min Loan amount : " + min_ammount.to_f.to_s)
       assert_on_page("Max Loan amount: " + max_ammount.to_f.to_s)
       assert_on_page("Default Loan amount : " + def_ammount.to_f.to_s)
       assert_on_page("Service Charge rate type: " + interestrate_type.to_s)
       assert_on_page("Max Service Charge rate: " + max_interestrate.to_f.to_s + " %")
       assert_on_page("Min Service Charge rate: " + min_interestrate.to_f.to_s + " %")
       assert_on_page("Default Service Charge rate: " + def_interestrate.to_f.to_s + " %")
       assert_on_page("Frequency of installments: " + frequencyOfInstallments[1].to_s + " " + periods.to_s + "(s)") 
       assert_on_page("Max # of installments: " + max_installments.to_i.to_s)      
       assert_on_page("Min # of installments: " + min_installments.to_i.to_s)
       assert_on_page("Default # of installments: " + def_installments.to_i.to_s)
       assert_on_page("Principal: " + principal_glcode.to_s)
       assert_on_page("Penalties: " + penalities_glcode.to_s)   
    #  puts "############## Preview Exit ###############"
    end 
  end  
  ...
  def LoanProduct_Creation_Conformation()
    assert($ie.contains_text($loanproduct_created_msg))and assert($ie.contains_text("Define a new Loan product"))\
      and assert($ie.contains_text("View Loan Product details now"))
       $logger.log_results("LoanProduct- LoanProduct created", "LoanProduct created","The page should redirect to LoanProductCreation-Conformation page","Passed")
        $ie.link(:text, "Define a new Loan product").click
        Check_New_LoanProduct()
    rescue =>e
  ...
  # puts "########## In view prod ####################"
       ...
       assert_on_page("Min Loan amount: " + min_ammount.to_f.to_s)
       assert_on_page("Max Loan amount: " + max_ammount.to_f.to_s)
       assert_on_page("Default amount: " + def_ammount.to_f.to_s)
       assert_on_page("Service Charge rate type: " + interestrate_type.to_s)
       assert_on_page("Max Service Charge rate: " + max_interestrate.to_f.to_s + " %")
       assert_on_page("Min Service Charge rate: " + min_interestrate.to_f.to_s + " %")
       assert_on_page("Default Service Charge rate: " + def_interestrate.to_f.to_s + " %")
  ...
  def  edit_loanproduct_status(prd_inst_name, status)
    begin    
      ...
      assert($ie.contains_text(prd_inst_name.to_s + " - Edit Loan product information"))

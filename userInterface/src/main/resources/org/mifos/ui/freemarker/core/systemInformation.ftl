   ...
   <div class=" content leftMargin180">
    ...
    <div class="span-24">
        ...
        <div class="span-22">
            ...
            <div><span class="span-5" id="sysinfo.text.applicationVersion">[@spring.message "systemAdministration.viewsysteminformation.mifosDatabaseVersion" /]</span><span class="span-16">${model.systemInformationDto.applicationVersion}</span></div>

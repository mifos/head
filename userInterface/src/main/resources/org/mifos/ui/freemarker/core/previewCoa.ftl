...
<span id="page.id" title="PreviewCoa"></span>
<div class="content">
	<div>
	     <div class="breadcrumb">
            ...
            <span class="fontBold">[@spring.message "coa.preview"  /]</span>
        </div>
    <div class="span-24">
    
        <div class="margin20lefttop">
            <p class="font15 margin15bottom"><span
                    class="orangeheading">[@spring.message "coa.preview" /]</span></p>
			...
			<div class="clear">&nbsp;</div>	
            <form method="post" action="previewCoa.ftl" name="formname">

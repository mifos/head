	...
	<div>
		<table id="loanInstallmentTable" width="60%" border="0" cellpadding="3" cellspacing="0">
			...
			<tr>
				...
				<a id="nextPayment_loanAccount.link.waiveFeeOverDue" href="loanAccountAction.do?method=waiveChargeOverDue&accountId=${loanInformationDto.accountId}&WaiveType=fees&type=LoanAccount&input=LoanAccount&globalAccountNum=${loanInformationDto.globalAccountNum}&prdOfferingName=${loanInformationDto.prdOfferingName}&randomNUm=${Session.randomNUm}&currentFlowKey=${Request.currentFlowKey}">
					[@spring.message "loan.waive" /]
				</a>
				[/#if]
				</td>
			...
			<tr>
				...
				<a id="nextPayment_loanAccount.link.waivePenaltyOverDue" href="loanAccountAction.do?method=waiveChargeOverDue&accountId=${loanInformationDto.accountId}&WaiveType=penalty&type=LoanAccount&input=LoanAccount&globalAccountNum=${loanInformationDto.globalAccountNum}&prdOfferingName=${loanInformationDto.prdOfferingName}&randomNUm=${Session.randomNUm}&currentFlowKey=${Request.currentFlowKey}">
					[@spring.message "loan.waive" /]
				</a>
				[/#if]
				</td>

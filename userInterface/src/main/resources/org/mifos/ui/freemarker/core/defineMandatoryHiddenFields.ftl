...
<!--  Main Content Begins-->  
  ...
  <p>&nbsp;&nbsp;</p>
    ...
    <div class="span-22 last">
        ...
        <div class="span-22 borderbtm">
        	<span class="span-8 paddingLeft">[@spring.message "manadatoryHiddenFields.spouse/fathermiddlename"/] </span><span class="span-7 paddingLeft "><input type="checkbox" name="hideClientSpouseFatherMiddleName" [#if fields.hideClientSpouseFatherMiddleName=true]  checked="checked" [/#if] value="1" onclick="disableFields(this)"></span><span class="span-5 paddingLeft">&nbsp;</span>
        </div>
        <div class="span-22 borderbtm">
        	<span class="span-8 paddingLeft">[@spring.message "manadatoryHiddenFields.spouse/fathersecondlastname"/] </span><span class="span-7 paddingLeft "><input type="checkbox" name="hideClientSpouseFatherSecondLastName" [#if fields.hideClientSpouseFatherSecondLastName=true]  checked="checked" [/#if] [#if fields.mandatoryClientSpouseFatherSecondLastName=true]  DISABLED [/#if] value="1" onclick="disableFields(this)"></span><span class="span-5 paddingLeft"><input type="checkbox" name="mandatoryClientSpouseFatherSecondLastName" [#if fields.mandatoryClientSpouseFatherSecondLastName=true]  checked="checked" [/#if] [#if fields.hideClientSpouseFatherSecondLastName=true]  DISABLED [/#if] value="1" onclick="disableFields(this)"></span>
        </div>
        <div class="span-22 borderbtm">
        	<span class="span-8 paddingLeft">[@spring.message "manadatoryHiddenFields.phonenumber"/] </span><span class="span-7 paddingLeft "><input type="checkbox" name="hideClientPhone" [#if fields.hideClientPhone=true]  checked="checked" [/#if] [#if fields.mandatoryClientPhone=true]  DISABLED [/#if] value="1" onclick="disableFields(this)"></span><span class="span-5 paddingLeft"><input type="checkbox" name="mandatoryClientPhone" [#if fields.mandatoryClientPhone=true]  checked="checked" [/#if] [#if fields.hideClientPhone=true]  DISABLED [/#if] value="1" onclick="disableFields(this)"></span>
        </div>
        <div class="span-22 borderbtm">
        	<span class="span-8 paddingLeft">[@spring.message "manadatoryHiddenFields.trained"/] </span><span class="span-7 paddingLeft "><input type="checkbox" name="hideClientTrained" [#if fields.hideClientTrained=true]  checked="checked" [/#if] [#if fields.mandatoryClientTrained=true]  DISABLED [/#if] value="1" onclick="disableFields(this)"></span><span class="span-5 paddingLeft"><input type="checkbox" name="mandatoryClientTrained" [#if fields.mandatoryClientTrained=true]  checked="checked" [/#if] [#if fields.hideClientTrained=true]  DISABLED [/#if] value="1" onclick="disableFields(this)"></span>
        </div>
        <div class="span-22 borderbtm">

...
[@adminLeftPaneLayout]
  ...
  <div class="content">
    ...
    <div class="span-20 ">
        ...
        <span class="span-20 rightAlign"><a href="editProductMix.ftl?productId=${mixDetails.prdOfferingId}">[@spring.message "manageProduct.productMixDetails.editproductmixinformation"/]</a></span>
    </div>
    <div class="span-20">
    	<div class="span-20"><span class="fontBold">[@spring.message "manageProduct.productMixDetails.allowedProducts"/] :</span><span>&nbsp;</span><br />
    	...
    	<div class="clear">&nbsp; </div>
    	<div class="span-20"><span class="fontBold">[@spring.message "manageProduct.productMixDetails.notAllowedProducts"/] :</span><span>&nbsp;</span><br />
    		<div class="clear">&nbsp; </div>

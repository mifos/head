 ...
 <div class=" content leftMargin180">
    <div class="span-24">
        ...
        <div class="prepend-3 span-22 last">
            ...
            <span class="span-2"><input type="text" id="holidayFromDateDD" size="1" maxlength="2" name="${spring.status.expression}" value="${spring.status.value?default("")}" />[@spring.message "DD" /]</span>
            [@spring.bind "formBean.fromMonth" /]
            <span class="span-2"><input type="text" id="holidayFromDateMM" size="1" maxlength="2" name="${spring.status.expression}" value="${spring.status.value?default("")}" />[@spring.message "MM" /]</span>
            [@spring.bind "formBean.fromYear" /]
            <span class="span-3"><input type="text" id="holidayFromDateYY" size="2" maxlength="4" name="${spring.status.expression}" value="${spring.status.value?default("")}" />[@spring.message "YYYY" /]</span>
        </div>
        <p>&nbsp;&nbsp;</p>
        <div class="prepend-3 span-22 last">
            <span class="span-4 rightAlign">[@spring.message "toDate"/]</span>
            [@spring.bind "formBean.toDay" /]
            <span class="span-2"><input type="text" id="holidayThruDateDD" size="1" maxlength="2" name="${spring.status.expression}" value="${spring.status.value?default("")}" />[@spring.message "DD" /]</span>
            [@spring.bind "formBean.toMonth" /]
            <span class="span-2"><input type="text" id="holidayThruDateMM" size="1" maxlength="2" name="${spring.status.expression}" value="${spring.status.value?default("")}" />[@spring.message "MM" /]</span>
            [@spring.bind "formBean.toYear" /]
            <span class="span-3"><input type="text" id="holidayThruDateYY" size="2" maxlength="4" name="${spring.status.expression}" value="${spring.status.value?default("")}" />[@spring.message "YYYY" /]</span>
        </div>
        <p>&nbsp;&nbsp;</p>
        <div class="prepend-3 span-22 last">
        ...
        <p>&nbsp;&nbsp;</p>
        <div class="prepend-3 span-22 last">
            <span class="span-4 rightAlign"><span class="red"> * </span>[@spring.message "appliesto" /] &nbsp;:</span>
            <span class="span-5">
            	    <div id="officeTree">
					</div>
            </span>

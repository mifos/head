...
<span id="page.id" title="RedoGroupLoanPreview"></span>
...
<table style="margin-bottom: 15px;" id="installments">
        ...
        <tr>
            ...
            <th style="border-top: 1px solid grey; padding-right: 30px;">[@spring.message "reviewInstallments.installmentHeading" /]</th>
            <th style="border-top: 1px solid grey; padding-right: 80px;">[@spring.message "reviewInstallments.dueDateHeading" /]</th>
            <th style="border-top: 1px solid grey; padding-right: 80px;">[@spring.message "reviewInstallments.actualPaymentDateHeading" /]</th>
        ...
        <tr>
            <th colspan="10" style="border-top: 1px solid grey;">[@spring.message "reviewInstallments.redo.paidInstallmentsHeading" /]</th>
        ...
        [#list loanScheduleFormBean.memberSchedules?keys as it]
         <tr>
            <td colspan="14" style="border-top: 1px solid grey;"><b>${loanScheduleFormBean.memberSchedules[it].globalCustomerId}</b></td>
        </tr>
            [#list loanScheduleFormBean.memberSchedules[it].loanRepaymentPaidInstallmentsWithRunningBalance as row]
                <tr>
                    ...
                    <td style="border-top: 1px solid grey;">&nbsp;</th>
...
<table style="margin-bottom: 15px; width: 700px; " id="futureInstallments">
        <thead>
        <tr>
            <th style="border-top: 1px solid grey; width: 100px;">[@spring.message "reviewInstallments.customerId" /]</th>
            <th style="border-top: 1px solid grey; width: 80px;">[@spring.message "reviewInstallments.installmentHeading" /]</th>
            <th style="border-top: 1px solid grey; width: 100px;">[@spring.message "reviewInstallments.dueDateHeading" /]</th>
            <th style="border-top: 1px solid grey; width: 120px;">[@spring.message "reviewInstallments.redo.datePaidHeading" /]</th>
            <th style="border-top: 1px solid grey; width: 60px;">[@spring.message "reviewInstallments.principalHeading" /]</th>
            <th style="border-top: 1px solid grey; width: 60px;">[@spring.message "reviewInstallments.interestHeading" /]</th>
            <th style="border-top: 1px solid grey; width: 20px;">[@spring.message "reviewInstallments.feesHeading" /]</th>
            <th style="border-top: 1px solid grey; width: 10px;">[@spring.message "reviewInstallments.totalHeading" /]</th>
        </tr>
        <tr>
            <th colspan="8" style="border-top: 1px solid grey;">[@spring.message "reviewInstallments.redo.futureInstallmentsHeading" /]</th>
        </tr>
        </thead>
        <tbody>
        [#list loanScheduleFormBean.memberSchedules?keys as it]
         <tr>
            <td colspan="8" style="border-top: 1px solid grey;"><b>${loanScheduleFormBean.memberSchedules[it].globalCustomerId}<b/></td>
        </tr>
            [#list loanScheduleFormBean.memberSchedules[it].loanRepaymentFutureInstallments as row]
            <tr>
                <td style="border-top: 1px solid grey;"></td>

...
<span id="page.id" title="DeleteCoa"></span>
<div class="content">
	<div>
	     <div class="breadcrumb">
            ...
            <span class="fontBold">[@spring.message "admin.deleteCoa"  /]</span>
        </div>
    <div class="span-24">
    
        <div class="margin20lefttop">
            <p class="font15"><span
                    class="orangeheading">[@spring.message "admin.deleteCoa" /]</span></p>
			...
			<div class="clear">&nbsp;</div>	
            <form method="post" action="deleteCoa.ftl" name="formname">

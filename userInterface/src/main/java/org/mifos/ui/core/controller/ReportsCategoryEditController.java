...
@Controller
@RequestMapping("/editReportCategory")
@SessionAttributes("reportCategory")
public class ReportsCategoryEditController {
    ...
    protected ReportsCategoryEditController(){
        //for spring autowiring
    }
    public ReportsCategoryEditController(final AdminServiceFacade adminServicefacade){

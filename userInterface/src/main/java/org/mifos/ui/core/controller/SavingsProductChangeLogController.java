...
@Controller
@RequestMapping("/viewSavingsProductChangeLog")
@SessionAttributes("auditLog")
public class SavingsProductChangeLogController {

    @Autowired
    private AdminServiceFacade adminServiceFacade;

    protected SavingsProductChangeLogController() {
        // default contructor for spring autowiring
    }

    public SavingsProductChangeLogController(final AdminServiceFacade adminServiceFacade) {

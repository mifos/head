...
@Controller
@RequestMapping("/batchjobsdetails")
public class BatchjobsDetailsController {
    ...
    public List<BreadCrumbsLinks> showBreadCrumbs() {
        return new AdminBreadcrumbBuilder().withLink("admin.batchjobs", "batchjobsdetails.ftl").build();
    }

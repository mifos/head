...
public class GenericController extends AbstractController {
    ...
    @Override
    @RequestMapping(value={"/accessDenied.ftl","/pageNotFound.ftl","/ping.ftl","/cheetah.css.ftl","/gazelle.css.ftl","/adminHome.ftl","/maincss.css","/screen.css","/maincss.css.ftl","/screen.css.ftl","/admin.ftl","/viewProductCategories.ftl","/viewOfficeHierarchy.ftl","/viewLoanProducts.ftl","/viewFunds.ftl","/defineLabels.ftl","/defineLookupOptions.ftl","/viewChecklists.ftl","/viewEditCheckLists.ftl","/viewEditSavingsProduct.ftl","/viewEditLoanProduct.ftl","/viewOffices.ftl","/viewHolidays.ftl","/viewSystemUsers.ftl","/viewAdditionalFields.ftl","/viewReportsTemplates.ftl","/viewReportsCategory.ftl","/manageRolesAndPermissions.ftl","/viewSavingsProducts.ftl","/defineAdditionalFields.ftl","/defineNewCategory.ftl","/defineNewChecklist.ftl","/defineNewHolidays.ftl","/defineNewOffice.ftl","/defineNewSystemUser.ftl","/defineSavingsProduct.ftl","/redoLoansDisbursal.ftl"})

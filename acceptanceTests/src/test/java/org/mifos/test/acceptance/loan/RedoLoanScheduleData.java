...
public class RedoLoanScheduleData {
    public static final String[][] VARIABLE_LOAN_SCHEDULE_ONE = {{"Installments paid", "", "", "", "", ""},
            ...
            {"Installments due", "", "", "", "", ""}, //future installment
    ...
    public static final String[][] DECLINING_PRINCIPAL_LATE_BALANCE_1 = {{"797.7", "9.2", "400.0", "1206.8"},
            {"795.3", "4.6", "300.0", "1099.8"}};
    ...
    public static final String[][] DECLINING_PRINCIPAL_EARLY_SCHEDULE_1 = {{"Installments paid", "", "", "", "", ""},
            ...
            {"4", "02-Nov-2010", "-", "201.2", "1.8", "100.0", "303.0"},
            {"5", "09-Nov-2010", "-", "196.9", "0.9", "100.0", "297.8"}};
    public static final String[][] DECLINING_PRINCIPAL_EARLY_BALANCE_1 = {{"797.7", "9.0", "400.0", "1206.7"},
            {"598.3", "4.4", "300.0", "902.8"},  //4.4 -> 6.2
            {"401.5", "2.2", "300.0", "703.7"}}; //2.2 -> 3.0
    ...
    public static final String[][] DECLINING_PRINCIPAL_ENTIRE_BALANCE_1 = {{"797.7", "9.2", "400.0", "1206.8"},
            {"598.3", "5.5", "300.0", "903.8"},  //4.4 -> 6.2
            {"398.1", "2.7", "200.0", "600.8"},  //4.4 -> 6.2
            {"196.9", "0.9", "100.0", "297.8"},  //4.4 -> 6.2
            {"0.4", "-0.4", "0.0", "0.0"}}; //2.2 -> 3.0

...
public class DefineNewReportsCategoryPreviewPage extends MifosPage{

    public DefineNewReportsCategoryPreviewPage(Selenium selenium) {
        super(selenium);
        this.verifyPage("defineNewReportsCategoryPreview");
    }

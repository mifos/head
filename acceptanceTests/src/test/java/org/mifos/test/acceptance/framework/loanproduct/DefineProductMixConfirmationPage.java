...
public class DefineProductMixConfirmationPage extends MifosPage {

    public DefineProductMixConfirmationPage(Selenium selenium) {
        super(selenium);
        verifyPage("createProductsMixConfirmation");
    }

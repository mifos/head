...
public class CreateGroupSearchPage extends AbstractPage {

    public CreateGroupSearchPage(Selenium selenium) {
        super(selenium);
    }

    public void verifyPage() {
        this.verifyPage("CenterSearch");
    }
    ...
    public CreateGroupEntryPage searchAndNavigateToCreateGroupPage(String centerName) {
        ...
        waitForPageToLoad();
        return new CreateGroupEntryPage(selenium);
    }

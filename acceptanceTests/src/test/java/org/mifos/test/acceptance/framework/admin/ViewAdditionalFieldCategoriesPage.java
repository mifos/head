...
public class ViewAdditionalFieldCategoriesPage extends MifosPage {
    ...
    public ViewAdditionalFieldsPage selectCategory(String category) {
        selenium.click("link="+category);
        waitForPageToLoad();
        return new ViewAdditionalFieldsPage(selenium);
    }

...
public class HolidayTestHelper {
    ...
    public HolidayTestHelper(Selenium selenium) {
        super();
        this.navigationHelper = new NavigationHelper(selenium);
    }


    public void createHoliday(CreateHolidaySubmitParameters params){
        navigationHelper.navigateToAdminPage()
            .navigateToDefineHolidayPage()
            .submitAndNavigateToHolidayConfirmationPage(params)
            .submitAndNavigateToViewHolidaysPage()
            .navigateToViewHolidaysPage()
            .verifyHolidayCreationResault(params);
    }
}

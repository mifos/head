...
public class CreateLSIMClientLoanAccountTest extends UiTestCaseBase {
    ...
    private void verify10SearchResults() {
        ...
        Assert.assertTrue(selenium
                .isTextPresent("MyOfficeDHMFT /Default Center /group1 /client1 lastname:ID0002-000000005"));
        Assert.assertFalse(selenium
                .isTextPresent("MyOfficeDHMFT /WeeklyClient Monday:ID0002-000000024"));
    }

    private void verify25SearchResults() {
        selenium.select("name=customerSearchResults_length", "value=25");
        Assert.assertTrue(selenium
                .isTextPresent("MyOfficeDHMFT /Default Center /groupWithoutLoan /ClientWithLoan 20110221:ID0002-000000010"));
        Assert.assertTrue(selenium
                .isTextPresent("MyOfficeDHMFT /Default Center /group1:ID0002-000000004"));
        Assert.assertFalse(selenium
                .isTextPresent("MyOfficeDHMFT /SavingsAccountPerformanceHistoryTestCenter /SavingsAccountPerformanceHistoryTestGroup:ID0002-000000036"));
    }

    private void verify50SearchResults() {
        selenium.select("name=customerSearchResults_length", "value=50");
        Assert.assertTrue(selenium
                .isTextPresent("MyOfficeDHMFT /Default Center /UpdateCustomPropertiesTestGroup:ID0002-000000016"));
        Assert.assertTrue(selenium
                .isTextPresent("MyOfficeDHMFT /SavingsAccountPerformanceHistoryTestCenter /SavingsAccountPerformanceHistoryTestGroup:ID0002-000000036"));
    }

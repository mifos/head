...
public class CustomizeTextAddPage extends MifosPage {

    public CustomizeTextAddPage(Selenium selenium) {
        super(selenium);
    }

    public void verifyPage() {
        verifyPage("customizeTextAdd");
    }
	...
	public CustomizeTextViewPage cancel() {
        selenium.click("customizeTextAdd.button.cancel");
        waitForPageToLoad();
        return new CustomizeTextViewPage(selenium);
	}

	public void setOriginalText(String originalText) {
        selenium.type("customizeTextAdd.input.originalText", originalText);	
	}

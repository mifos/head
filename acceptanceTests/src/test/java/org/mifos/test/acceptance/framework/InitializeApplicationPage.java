...
public class InitializeApplicationPage  extends AbstractPage  {


    public InitializeApplicationPage (Selenium selenium) {
        super(selenium);
    }

    public void navigateToInitializeApplicationPage() {
        this.selenium.open("initializeApplication.ftl");
    }

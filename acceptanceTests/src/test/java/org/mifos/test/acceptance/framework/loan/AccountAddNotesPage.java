...
public class AccountAddNotesPage extends MifosPage {
    public AccountAddNotesPage(Selenium selenium) {
        super(selenium);
    }

    public void verifyPage() {
        this.verifyPage("AccountAddNotes");
    }
    ...
    public AccountPreviewNotesPage submitAndNavigateToAccountAddNotesPreviewPage( String note ) {
        ...
        return new AccountPreviewNotesPage(selenium);
    }
}

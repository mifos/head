...
public class QuestionGroupResponsePage extends MifosPage {
    private static final String ANSWER_JS = "window.$(\"#displayResponseForm label:contains(\\\"%s\\\")\").parent().find(\"label\")[1].getElementsByTagName(\"span\")[0].innerHTML.trim()";
    ...
    public ClientViewDetailsPage navigateToViewClientDetailsPage() {
        selenium.click("id=backToDetailsPage");
        waitForPageToLoad();

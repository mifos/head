...
public class RedoLoanDisbursalSearchPage extends MifosPage {
    public RedoLoanDisbursalSearchPage (Selenium selenium) {
        super(selenium);
    }
    ...
    public RedoLoanDisbursalSearchResultsPage searchAndNavigateToRedoLoanDisbursalPage(String searchString) {
        ...
        return new RedoLoanDisbursalSearchResultsPage(selenium);
    }
}

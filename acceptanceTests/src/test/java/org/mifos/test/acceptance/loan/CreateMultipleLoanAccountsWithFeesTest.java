...
public class CreateMultipleLoanAccountsWithFeesTest extends UiTestCaseBase {
    ...
    public void createBulkLoanAccountsInPendingApprovalStatus() throws Exception {
        ...
        //Then
        loanTestHelper.createMultipleLoanAccountsAndVerify(multipleAccParameters, clients, "0000-Animal Husbandry", "10", loanTestHelper.METHOD_SUBMIT_FOR_APPROVAL);
    ...
    public void createBulkLoanAccountsInPartialApplicationStatus() throws Exception {
        ...
        //Then
        loanTestHelper.createMultipleLoanAccountsAndVerify(multipleAccParameters, clients, "0000-Animal Husbandry", "10", LoanTestHelper.METHOD_SAVE_FOR_LATER);
    }
}

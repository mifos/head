...
public class ModifyingGroupLoanTest extends UiTestCaseBase {
    ...
    public void editAccountInfoTest() throws Exception{
        ...
        accountSubmitParameters.setAmount("3500");
        accountSubmitParameters.setInterestRate("33");
        accountSubmitParameters.setNumberOfInstallments("8");
        ...
        editLoanAccountInformationPage.editAccountParams(accountSubmitParameters, editAccountParameters);
    ...
    private void verifyModifyAccountParametersFromIndividualMemberAccount(LoanAccountPage loanAccountPage) {
        loanAccountPage = loanAccountPage.navigateToIndividualLoanAccountPageFromPendingApprovalGroupLoan(0);

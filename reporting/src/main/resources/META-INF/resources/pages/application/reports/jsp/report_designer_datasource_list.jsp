...
<span id="page.id" title="report_designer_datasource_list"></span>
				             ...
				             <%int i=1;%>   
				                <tr>
								 ...
								 <tr>
									 ...
									 <c:url value="javascript:deleteMe('reportsDataSourceAction.do" var="javascript:deleteMe('reportsDataSourceActionDeleteDataSource',${reportDs.datasourceId})MethodUrl" >
									  <c:param name="method" value="deleteDataSource',${reportDs.datasourceId})" />
									 </c:url >
									 
									  <td nowrap><a href="${javascript:deleteMe('reportsDataSourceActionDeleteDataSource',${reportDs.datasourceId})MethodUrl}">Delete</a></td>

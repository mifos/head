...
<span id="page.id" title="report_designer_params_list"></span>
				             ...
				             <%int i=1;%>   
				                <tr>
								 ...
								 <tr>
									 ...
									 <c:url value="javascript:deleteMe('reportsParamsAction.do" var="javascript:deleteMe('reportsParamsActionDeleteParams',)MethodUrl" >
									  <c:param name="method" value="deleteParams',${reportParams.parameterId})" />
									 </c:url >
									 </td>
									  <td nowrap><a href="${javascript:deleteMe('reportsParamsActionDeleteParams',)MethodUrl}">Delete</a></td>
					                </tr>									
						 </c:forEach>

                              ...
                              <fieldset class="right_section" style="width:68%">
                                <ol  class="noPadding">
                                  <li class="noPadding">
                                      ...
                                      [#else]
                                      [@form.radioButtons "${formBeanName}.questionGroups[${questionGroup_index}].sectionDetails[${sectionDetail_index}].questions[${question_index}].value", question.answerChoices,' </li><li class="noPadding">', ''/]
                                      [/#if]
                                  </li>
                                </ol>
                              </fieldset>

...
public class LoanInstallmentsDto implements Serializable {

    private final BigDecimal loanAmount;
    private final BigDecimal totalInstallmentAmount;
    private final Date firstInstallmentDueDate;
    private final Date lastInstallmentDueDate;

    public LoanInstallmentsDto(BigDecimal loanAmount, BigDecimal totalInstallmentAmount, Date firstInstallmentDueDate,
            Date lastInstallmentDueDate) {

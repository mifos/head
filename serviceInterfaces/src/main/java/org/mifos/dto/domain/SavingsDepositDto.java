...
public class SavingsDepositDto {
    ...
    private final LocalDate dateOfDeposit;
    ...
    public SavingsDepositDto(Long savingsId, Long customerId, LocalDate dateOfDeposit, Double amount, Integer modeOfPayment,

...
public class LabelConfigurationActionStrutsTest extends MifosMockStrutsTestCase {
    ...
    public void testUpdate() {
        ...
        assertFalse(MenuRepository.getInstance().isMenuForLocale(userContext.getPreferredLocale()));
        ...
        assertEquals("Head Office-Changed", labelConfigurationActionForm.getHeadOffice());
        assertEquals("Regional Office-Changed", labelConfigurationActionForm.getRegionalOffice());
        assertEquals("Divisional Office-Changed", labelConfigurationActionForm.getSubRegionalOffice());
        assertEquals("Area Office-Changed", labelConfigurationActionForm.getAreaOffice());
        assertEquals("Branch Office-Changed", labelConfigurationActionForm.getBranchOffice());
        ...
        assertEquals("Voucher-Changed", labelConfigurationActionForm.getVouchers());
        assertEquals("Loan-Changed", labelConfigurationActionForm.getLoans());
        assertEquals("Margin Money-Changed", labelConfigurationActionForm.getSavings());
        assertEquals("State-Changed", labelConfigurationActionForm.getState());
        assertEquals("Postal Code-Changed", labelConfigurationActionForm.getPostalCode());
        assertEquals("Caste-Changed", labelConfigurationActionForm.getEthnicity());
        assertEquals("Religion-Changed", labelConfigurationActionForm.getCitizenship());
        assertEquals("Handicapped-Changed", labelConfigurationActionForm.getHandicapped());
        assertEquals("Government ID-Changed", labelConfigurationActionForm.getGovtId());
        assertEquals("Address1-Changed", labelConfigurationActionForm.getAddress1());
        assertEquals("Address2-Changed", labelConfigurationActionForm.getAddress2());
        assertEquals("Village-Changed", labelConfigurationActionForm.getAddress3());
        assertEquals("Partial Application-Changed", labelConfigurationActionForm.getPartialApplication());
        assertEquals("Application Pending Approval-Changed", labelConfigurationActionForm.getPendingApproval());
        assertEquals("Application Approved-Changed", labelConfigurationActionForm.getApproved());
        ...
        assertEquals("On Hold-Changed", labelConfigurationActionForm.getOnhold());
        assertEquals("Active-Changed", labelConfigurationActionForm.getActive());
        assertEquals("Inactive-Changed", labelConfigurationActionForm.getInActive());
        assertEquals("Active in Good Standing-Changed", labelConfigurationActionForm.getActiveInGoodStanding());
        assertEquals("Active in Bad Standing-Changed", labelConfigurationActionForm.getActiveInBadStanding());
        assertEquals("Closed- Obligation met-Changed", labelConfigurationActionForm.getClosedObligationMet());
        assertEquals("Closed- Rescheduled-Changed", labelConfigurationActionForm.getClosedRescheduled());
        assertEquals("Closed- Written Off-Changed", labelConfigurationActionForm.getClosedWrittenOff());
        assertEquals("None-Changed", labelConfigurationActionForm.getNone());
        assertEquals("Grace on all repayments-Changed", labelConfigurationActionForm.getGraceOnAllRepayments());
        assertEquals("Principal only grace-Changed", labelConfigurationActionForm.getPrincipalOnlyGrace());
        assertEquals("Service Charge-Changed", labelConfigurationActionForm.getInterest());
        assertEquals("External Id-Changed", labelConfigurationActionForm.getExternalId());
        assertEquals("Bulk entry-Changed", labelConfigurationActionForm.getBulkEntry());
    ...
    public void xtestLoad() throws Exception {
        ...
        LabelConfigurationActionForm labelConfigurationActionForm = (LabelConfigurationActionForm) request.getSession()
                .getAttribute("labelconfigurationactionform");
        assertEquals("Head Office", labelConfigurationActionForm.getHeadOffice());
        assertEquals("Regional Office", labelConfigurationActionForm.getRegionalOffice());
        assertEquals("Divisional Office", labelConfigurationActionForm.getSubRegionalOffice());
        assertEquals("Area Office", labelConfigurationActionForm.getAreaOffice());
        assertEquals("Branch Office", labelConfigurationActionForm.getBranchOffice());
        ...
        assertEquals("Postal Code", labelConfigurationActionForm.getPostalCode());
        ...
        assertEquals("Handicapped", labelConfigurationActionForm.getHandicapped());
        ...
        assertEquals("Partial Application", labelConfigurationActionForm.getPartialApplication());
        assertEquals("Application Pending Approval", labelConfigurationActionForm.getPendingApproval());
        assertEquals("Application Approved", labelConfigurationActionForm.getApproved());
        ...
        assertEquals("Active in Good Standing", labelConfigurationActionForm.getActiveInGoodStanding());
        assertEquals("Active in Bad Standing", labelConfigurationActionForm.getActiveInBadStanding());
        assertEquals("Closed- Obligation met", labelConfigurationActionForm.getClosedObligationMet());
        assertEquals("Closed- Rescheduled", labelConfigurationActionForm.getClosedRescheduled());
        assertEquals("Closed- Written Off", labelConfigurationActionForm.getClosedWrittenOff());
        assertEquals("None", labelConfigurationActionForm.getNone());
        assertEquals("Grace on all repayments", labelConfigurationActionForm.getGraceOnAllRepayments());
        assertEquals("Principal only grace", labelConfigurationActionForm.getPrincipalOnlyGrace());
        assertEquals("Service Charge", labelConfigurationActionForm.getInterest());
        assertEquals("External Id", labelConfigurationActionForm.getExternalId());

...
/**
 * I test {@link SaveCollectionSheetCustomerSavingDto}.
 */
@RunWith(MockitoJUnitRunner.class)
public class SaveCollectionSheetCustomerSavingDtoTest {
    ...
    public void shouldBeSuccessfulObjectCreationWithValidInput() {
        ...
        try {
            new SaveCollectionSheetCustomerSavingDto(validAccountId, validCurrencyId, validAmount, validAmount);
    ...
    public void shouldGetACCOUNTID_NULLIfAccountIdNull() {
        ...
        try {
            new SaveCollectionSheetCustomerSavingDto(null, validCurrencyId, validAmount, validAmount);
        } catch (SaveCollectionSheetException e) {
    ...
    public void shouldGetACCOUNTID_NEGATIVEifAccountIdNegative() {
        ...
        List<InvalidSaveCollectionSheetReason> InvalidSaveCollectionSheetReasons = null;
        try {
            new SaveCollectionSheetCustomerSavingDto(-3, validCurrencyId, validAmount, validAmount);
        } catch (SaveCollectionSheetException e) {
            InvalidSaveCollectionSheetReasons = e.getInvalidSaveCollectionSheetReasons();
        }
    ...
    public void shouldGetCURRENCYID_NULLifCurrencyIdNull() {
        ...
        List<InvalidSaveCollectionSheetReason> InvalidSaveCollectionSheetReasons = null;
        try {
            new SaveCollectionSheetCustomerSavingDto(validAccountId, null, validAmount, validAmount);
        } catch (SaveCollectionSheetException e) {
            InvalidSaveCollectionSheetReasons = e.getInvalidSaveCollectionSheetReasons();
        }
    ...
    public void shouldGetCURRENCYID_NEGATIVEifCurrencyIdNegative() {
        ...
        List<InvalidSaveCollectionSheetReason> InvalidSaveCollectionSheetReasons = null;
        try {
            new SaveCollectionSheetCustomerSavingDto(validAccountId, Short.valueOf("-1"), validAmount, validAmount);
        } catch (SaveCollectionSheetException e) {
            InvalidSaveCollectionSheetReasons = e.getInvalidSaveCollectionSheetReasons();
        }
    ...
    @Test
    public void shouldGetTOTALDEPOSIT_NEGATIVEifTotalDepositNegative() {

        List<InvalidSaveCollectionSheetReason> InvalidSaveCollectionSheetReasons = null;
        try {
            new SaveCollectionSheetCustomerSavingDto(validAccountId, validCurrencyId, invalidAmount, validAmount);
        } catch (SaveCollectionSheetException e) {
            InvalidSaveCollectionSheetReasons = e.getInvalidSaveCollectionSheetReasons();
        }
        ...
        assertNotNull("List was not set", InvalidSaveCollectionSheetReasons);
        assertThat(InvalidSaveCollectionSheetReasons.size(), is(1));
        assertThat(InvalidSaveCollectionSheetReasons.get(0), is(InvalidSaveCollectionSheetReason.TOTALDEPOSIT_NEGATIVE));
    }

    @Test
    public void shouldGetTOTALWITHDRAWAL_NEGATIVEifTotalWithdrawalNegative() {

        List<InvalidSaveCollectionSheetReason> InvalidSaveCollectionSheetReasons = null;
        try {
            new SaveCollectionSheetCustomerSavingDto(validAccountId, validCurrencyId, validAmount, invalidAmount);
        } catch (SaveCollectionSheetException e) {
            InvalidSaveCollectionSheetReasons = e.getInvalidSaveCollectionSheetReasons();
        }
        ...
        assertNotNull("List was not set", InvalidSaveCollectionSheetReasons);
        assertThat(InvalidSaveCollectionSheetReasons.size(), is(1));
        assertThat(InvalidSaveCollectionSheetReasons.get(0), is(InvalidSaveCollectionSheetReason.TOTALWITHDRAWAL_NEGATIVE));
    }
    ...
    public void shouldGetFourReasonsForAllInvalidInput() {
        ...
        List<InvalidSaveCollectionSheetReason> InvalidSaveCollectionSheetReasons = null;
        try {
            new SaveCollectionSheetCustomerSavingDto(null, null, invalidAmount, invalidAmount);
        } catch (SaveCollectionSheetException e) {
            InvalidSaveCollectionSheetReasons = e.getInvalidSaveCollectionSheetReasons();
        }
        ...
        assertThat(InvalidSaveCollectionSheetReasons.contains(InvalidSaveCollectionSheetReason.TOTALDEPOSIT_NEGATIVE), is(true));
        assertThat(InvalidSaveCollectionSheetReasons.contains(InvalidSaveCollectionSheetReason.TOTALWITHDRAWAL_NEGATIVE), is(true));
    }

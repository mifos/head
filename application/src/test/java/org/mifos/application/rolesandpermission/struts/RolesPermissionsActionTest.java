...
public class RolesPermissionsActionTest extends MifosMockStrutsTestCase {

    public RolesPermissionsActionTest() throws SystemException, ApplicationException {
        super();
    }
    ...
    public void testManage() throws Exception {
        ...
        assertEquals("New Role", ((RolesPermissionsActionForm) request.getSession().getAttribute(

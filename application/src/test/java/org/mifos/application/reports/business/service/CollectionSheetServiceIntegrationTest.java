...
public class CollectionSheetServiceIntegrationTest extends AbstractCollectionSheetIntegrationTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        generatedCollectionSheets.addAll(generateClientCollectionSheets(300, groupCollectionSheet,
                LOAN_OFFICER_SHORT_ID));
        generatedCollectionSheets.addAll(generateClientCollectionSheets(302, anotherGroup, LOAN_OFFICER_SHORT_ID));
        generatedCollectionSheets.addAll(generateClientCollectionSheets(304, anotherGroup, ANY_SHORT_ID));
        ...
        collectionSheetBOForCenterBranchLoanOfficer.populateTestInstance(DateUtils.getSqlDate(2002, Calendar.FEBRUARY,
        ...
        collectionSheetBOBeforeSpecifiedMeetingDate.populateTestInstance(DateUtils.getSqlDate(2000, Calendar.DECEMBER,
                31), TODAYS_DATE, CollectionUtils.asSet(customerForMeetingDateBeforeSpecifiedDate),
                CollectionSheetConstants.COLLECTION_SHEET_GENERATION_SUCCESSFUL);
    ...
    public void testCollectionSheetServiceCallsAllLoanOfficerSingleCenterMethod() throws Exception {
        CollectionSheetReportPersistence collectionSheetReportPersistenceMock = createMock(CollectionSheetReportPersistence.class);
        expect(
                collectionSheetReportPersistenceMock.extractReportDataAllLoanOfficersOneCenter(BRANCH_ID, meetingDate,
                        CENTER_ID)).andReturn(new ArrayList<CollectionSheetReportData>());
        ...
        service.extractReportData(BRANCH_ID, meetingDate, ALL_LOAN_OFFICER_ID, CENTER_ID);
    ...
    public void testCollectionSheetServiceCallsAllLoanOfficerAllCentersMethod() throws Exception {
        CollectionSheetReportPersistence collectionSheetReportPersistenceMock = createMock(CollectionSheetReportPersistence.class);
        expect(collectionSheetReportPersistenceMock.extractReportDataAllLoanOfficersAllCenters(BRANCH_ID, meetingDate))
                .andReturn(new ArrayList<CollectionSheetReportData>());
        replay(collectionSheetReportPersistenceMock);
        CollectionSheetService service = new CollectionSheetService(collectionSheetReportPersistenceMock);
        service.extractReportData(BRANCH_ID, meetingDate, ALL_LOAN_OFFICER_ID, ALL_CENTER_ID);
        verify(collectionSheetReportPersistenceMock);
    }
    ...
    public void testCollectionSheetServiceCallsOneLoanOfficerAllCentersMethod() throws Exception {
        CollectionSheetReportPersistence collectionSheetReportPersistenceMock = createMock(CollectionSheetReportPersistence.class);
        expect(
                collectionSheetReportPersistenceMock.extractReportDataAllCentersUnderLoanOfficer(BRANCH_ID,
                        meetingDate, LOAN_OFFICER_ID)).andReturn(new ArrayList<CollectionSheetReportData>());
        replay(collectionSheetReportPersistenceMock);
        CollectionSheetService service = new CollectionSheetService(collectionSheetReportPersistenceMock);
        service.extractReportData(BRANCH_ID, meetingDate, LOAN_OFFICER_ID, ALL_CENTER_ID);
        verify(collectionSheetReportPersistenceMock);
    }
    ...
    public void testCollectionSheetServiceCallsOneLoanOfficerOneCenterMethod() throws Exception {
        CollectionSheetReportPersistence collectionSheetReportPersistenceMock = createMock(CollectionSheetReportPersistence.class);
        expect(
                collectionSheetReportPersistenceMock.extractReportData(BRANCH_ID, meetingDate, LOAN_OFFICER_ID,
                        CENTER_ID)).andReturn(new ArrayList<CollectionSheetReportData>());
        replay(collectionSheetReportPersistenceMock);
        CollectionSheetService service = new CollectionSheetService(collectionSheetReportPersistenceMock);

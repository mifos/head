...
public class GroupTransferUsingCustomerServiceIntegrationTest {
    ...
    @Test
    public void shouldTransferGroupToCenterInSameBranch() throws Exception {
...
//        CenterBO previousParent = customerDao.findCenterBySystemId(groupForTransfer.getParentCustomer().getGlobalCustNum());

        assertThat(centerWithNoChildren.getMaxChildCount(), is(1));
        assertThat(centerWithNoChildren.getChildren(), is(notNullValue()));
        assertThat(centerWithNoChildren.getChildren().isEmpty(), is(false));
 ...
 // FIXME - #000002 - keithw - rewrite all transfer tests
    ...
    public void givenUpdateCenterFailure_MeetingFrequencyMonthly() throws Exception {
        ...
        //
        // Assert.assertEquals(WeekDay.MONDAY,
        // group.getCustomerMeeting().getMeeting().getMeetingDetails().getWeekDay());
        // Assert.assertEquals(WeekDay.MONDAY,
        // client.getCustomerMeeting().getMeeting().getMeetingDetails().getWeekDay());
        //
        // center = TestObjectFactory.getCenter(center.getCustomerId());
        // client = TestObjectFactory.getClient(client.getCustomerId());
        // group = TestObjectFactory.getGroup(group.getCustomerId());

...
public class SavingsIntCalcHelperIntegrationTest extends MifosIntegrationTestCase {
    ...
    public void testIntCalculation() throws Exception {
        ...
        ((SavingsIntCalcHelper) savingsIntCalcTask.getTaskHelper()).execute(cal.getTimeInMillis());
       ...
       Assert.assertEquals(TestUtils.createMoney(15.387), savings1.getInterestToBePosted());

        // using the old money class the result here was 4.3
       Assert.assertEquals(TestUtils.createMoney(4.274), savings4.getInterestToBePosted());
    ...
    private void createInitialObjects() throws Exception {
        ...
        savingsOffering1 = createSavingsOffering("prd1", "34vf", InterestCalcType.MINIMUM_BALANCE);
        savingsOffering2 = createSavingsOffering("prd2", "4frg", InterestCalcType.MINIMUM_BALANCE);
        savingsOffering3 = createSavingsOffering("prd3", "c23e", InterestCalcType.MINIMUM_BALANCE);
        savingsOffering4 = createSavingsOffering("prd4", "cwer", InterestCalcType.AVERAGE_BALANCE);
    ...
    private SavingsOfferingBO createSavingsOffering(String offeringName, String shortName,
        ...
        MeetingBO meetingIntCalc = TestObjectFactory.createMeeting(TestObjectFactory.getNewMeeting(MONTHLY,
                EVERY_MONTH, SAVINGS_INTEREST_CALCULATION_TIME_PERIOD, MONDAY));
        MeetingBO meetingIntPost = TestObjectFactory.createMeeting(TestObjectFactory.getNewMeeting(MONTHLY,
                EVERY_MONTH, SAVINGS_INTEREST_POSTING, MONDAY));

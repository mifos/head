...
public class HibernateHelperIntegrationTest extends MifosIntegrationTestCase {
    ...
    public void testDTOBuilderGetParameterTypes() throws Exception {
        ...
        assertTrue(classParams[0].equals(new java.util.GregorianCalendar().getClass().getSuperclass()));
        ...
        assertTrue(classParams[0].equals(new java.sql.Timestamp(System.currentTimeMillis()).getClass()));
        classParams = dtoBuilder.getParameterTypes("TIME");
        assertTrue(classParams[0].equals(new java.sql.Time(System.currentTimeMillis()).getClass()));

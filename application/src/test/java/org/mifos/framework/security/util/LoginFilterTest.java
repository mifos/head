...
public class LoginFilterTest extends MifosMockStrutsTestCase {
    ...
    /**
     * This test makes simply asserts that the method completes successfully. In
     ...
     */
    private boolean isFilterChainExecuted(HttpServletRequestSimulator req, HttpServletResponseSimulator res)
            throws Exception {

...
public class StandardLoanAccountServiceTest {
    ...
    @Test
    public void testMakeLoanPayment() {
        UserReferenceDTO userMakingPayment = new UserReferenceDTO((short)1);
        BigDecimal paymentAmount = new BigDecimal("100");
        LocalDate paymentDate = new LocalDate(2009,10,1);
        String comment = "some comment";
        standardLoanAccountService.makeLoanPayment(userMakingPayment, paymentAmount, paymentDate, PaymentTypes.CASH, comment);
    }
}

...
public class InterestPostingPeriodResultBuilder {
    ...
    public InterestPostingPeriodResultBuilder with(InterestCalculationPeriodResult withCalculationPeriodResult) {
        this.calculationPeriodResults.add(withCalculationPeriodResult);
        return this;
    }

    public InterestPostingPeriodResultBuilder from(LocalDate from) {
        this.intervalStartDate = from;
        return this;
    }

    public InterestPostingPeriodResultBuilder to(LocalDate to) {
        this.intervalEndDate = to;
        return this;
    }
}
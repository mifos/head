    ...
    <td align="left" valign="bottom" bgcolor="#FFFFFF"><table border="0" cellspacing="1" cellpadding="0">
        <tr>
         ...
         <c:url value="reportsAction.do" var="reportsActionLoadMethodUrl" >
          ...
          <td class="taborange"><a href="${reportsActionLoadMethodUrl}" class="tabfontwhite"><mifos:mifoslabel name="framework.reports" bundle="FrameworkUIResources"></mifos:mifoslabel></a>

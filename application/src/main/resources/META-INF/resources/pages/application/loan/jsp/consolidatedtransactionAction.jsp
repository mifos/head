...
<tr><td>
            ...
            <tr>
             ...
             <c:forEach items="${sessionScope.viewStageTransactionsDtoCRBRListValues}" var="accountHeadCRBR">
                <tr>
                <td>
                 <html-el:text property="transactionNo" name="consolidatedtransactionactionform" styleClass="separatedNumber" value="${accountHeadCRBR.transactionNo}" styleId="${accountHead.sno}" />
                 </td>
            ...
            <tr>
             ...
             <c:forEach items="${sessionScope.viewStageTransactionsDtoCPBPListValues}" var="accountHeadCPBP">
                ...
                <td>
                    ...
                    <td>
                        <html-el:text property="CpBpamount" name="consolidatedtransactionactionform" styleClass="separatedNumber" styleId="${accountHead.sno}" value="${accountHeadCPBP.transactionAmount}" />
                    </td>

			...
			<td align="center" colspan="2">
				 ...
				 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <!--
                     <tr class="fontnormal">
                    <td width="3%"><img src="pages/framework/images/bullet_circle.gif" width="9" height="11"></td>
                    <td width="97%"><a href="viewstagetransactionsaction.do?method=load"><mifos:mifoslabel name="admin.viewStageTransactions" bundle="adminUIResources"/></a></td>
                  </tr>
                      <tr class="fontnormal">
                    <td width="3%"><img src="pages/framework/images/bullet_circle.gif" width="9" height="11"></td>
                    <td width="97%"><a href="interofficetransferaction.do?method=load"><mifos:mifoslabel name="admin.interOfficeTransafer" bundle="adminUIResources"/></a></td>
                  </tr>
                  -->
               </table>
			</div>

...
function fnSubmit(form, buttonSubmit) {
	...
	form.action="audittransactionsaction.do";
	form.submit();
}
...
<html-el:form action="/audittransactionsaction.do?method=process">
...
<tr class="fontnormal">
			     <td width="15%" align="right"><mifos:mifoslabel name="simpleAccounting.audit" mandatory="yes" isColonRequired="Yes" bundle="simpleAccountingUIResources"/></td>
							<td width="25%" align="left">
								<mifos:select styleId="trxnTypeId" property="audit" >
								<html-el:option value="yes"><mifos:mifoslabel name="simpleAccounting.yes" bundle="simpleAccountingUIResources" /></html-el:option>
								<html-el:option value="no"><mifos:mifoslabel name="simpleAccounting.no" bundle="simpleAccountingUIResources" /></html-el:option>
								</mifos:select>
							</td>
			</tr>

		<tr class="fontnormal">
		   <td align="right"><mifos:mifoslabel name="simpleAccounting.auditComments" mandatory="yes" isColonRequired="Yes" bundle="simpleAccountingUIResources"/></td>
		 <td align="left" colspan="3">
		 <mifos:textarea property="auditComments" cols='68'></mifos:textarea>
             </td>
		</tr>
		</table>
			<br>

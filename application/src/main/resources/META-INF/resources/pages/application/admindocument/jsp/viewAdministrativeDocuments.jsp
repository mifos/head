...
<tiles:insert definition=".view">
	...
	<span id="page.id" title="viewAdministrativeDocuments"></span>
      ...
      <table width="95%" border="0" cellpadding="0" cellspacing="0">
		...
		<html-el:submit property="backButton" styleId="viewadministrativedocuments.button.back" styleClass="buttn" onclick="window.location.href='AdminAction.do?method=load'">

...
<tiles:insert definition=".clientsacclayoutsearchmenu">
 ...
 <span id="page.id" title="ViewClientActivity"></span>
	...
	<script>
        ...
        <table width="95%" border="0" cellpadding="0" cellspacing="0">
			...
			<customtags:headerLink/>
				<html-el:link styleId="viewClientActivity.link.viewCharges" href="${customerAccountActionLoadMethodUrl}">
	           ...
	           <table width="96%" border="0" cellpadding="0" cellspacing="0">
	              <tr>
	                ...
	                <c:url value="applyPaymentAction.do" var="applyPaymentActionLoadMethodUrl" >
	                	...
	                	<html-el:link styleId="viewClientActivity.link.applyPayment" href="${applyPaymentActionLoadMethodUrl}">
	                ...
	                <c:if test="${param.statusId == 3 || param.statusId == 4}">
	                   ...
	                   <c:url value="custApplyAdjustment.do" var="custApplyAdjustmentLoadAdjustmentMethodUrl" >
	                    ...
	                    <html-el:link styleId="viewClientActivity.link.applyAdjustment" href="${custApplyAdjustmentLoadAdjustmentMethodUrl}">
		             ...
		             <c:if test="${param.statusId == 1 || param.statusId == 2 || param.statusId == 3 || param.statusId == 4}">
	                   ...
	                   <c:url value="applyChargeAction.do" var="applyChargeActionLoadMethodUrl" >
	                    ...
	                    <html-el:link styleId="viewClientActivity.link.applyCharges" href="${applyChargeActionLoadMethodUrl}">

...
<html-el:form action="/multiplegeneralledgeraction.do">
 ...
 <TR></TABLE>
    <TABLE id="dataTable" width="350px" border="1">
     <c:forEach items="${sessionScope.accounHeadValues}" var="accountHeadvalue">
        <TR>
        ...
        <TD><INPUT type="checkbox" name="chk"/></TD>
				...
				<td align="left">
					...
					<mifos:select property="accountHead1"  >
				        <c:forEach items="${sessionScope.AccountHeadGlCodes}" var="accountHead">
				         ...
				         <c:choose>
                       <c:when test="${accountHead.glcode==accountHeadvalue.accountHead}">
				...
				<td align="left">
					  <html-el:text property="amount1" styleClass="separatedNumber" value="${accountHeadvalue.amounts}" styleId="simpleaccounting.input.amount"/>
				</td>


		 <td align="left" colspan="3">
		 <html-el:text property="notes1" styleClass="separatedNumber" value="${accountHeadvalue.trannotes}" styleId="simpleaccounting.input.amount"/>
             </td>

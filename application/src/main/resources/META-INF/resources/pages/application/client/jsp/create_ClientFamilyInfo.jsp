...
<tiles:insert definition=".withoutmenu">
	...
	<span id="page.id" title="CreateClientFamilyInfo"></span>	
...
<table>
								<tr class="fontnormal">
									<td align="left" class="paddingL10" style=" width : 97px;">
									...
									<td class="paddingL10" style=" width : 920px;" style=" width : 822px;">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr class="fontnormal">

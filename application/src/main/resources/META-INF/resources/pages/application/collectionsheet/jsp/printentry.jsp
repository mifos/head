	...
	<tiles:put name="body" type="string">
		...
		<!--
			...
			function fnCancel(form) {
				...
				form.action="collectionsheetprintaction.do";
				form.submit();
			}
			
			function fnSubmit(form, buttonSubmit) {
				buttonSubmit.disabled=true;
				form.method.value="printMembers";
				form.action="collectionsheetmemberaction.do";
				form.submit();
			}
		...
		<html-el:form action="/collectionsheetprintaction" onsubmit="return (validateMyForm(receiptDate,receiptDateFormat,receiptDateYY) && validateMyForm(transactionDate,transactionDateFormat,transactionDateYY))">
								...
								<td align="left" valign="top" class="paddingleftCreates">
									...
									<table width="93%" border="0" cellpadding="3" cellspacing="0">
										...
										<tr class="fontnormal">
											...
											<td>
                                                <date:datetag property="transactionDate" isDisabled="no" renderstyle="simple"/>
											</td>
										</tr>
									</table>
									<br>

        ...
        <tr>
          ...
          <table width="98%" border="0" cellspacing="0" cellpadding="3">
              ...
              <table width="93%" border="0" cellpadding="3" cellspacing="0">
               ...
               <tr>
               <td>
                    <c:set var="questionsHostForm" value="${savingsActionForm}" scope="request" />
                    <c:import url="/pages/application/surveys/jsp/viewQuestionResponses.jsp">
                       <c:param name="editResponseURL" value="savingsAction.do?method=editQuestionResponses&currentFlowKey=${requestScope.currentFlowKey}"/>

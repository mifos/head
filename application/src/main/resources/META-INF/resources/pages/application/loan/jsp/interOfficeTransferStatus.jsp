																				...
																				<br>
																					...
																					<table width="93%" border="0" cellpadding="3" cellspacing="0">
																						<tr class="fontnormal">
																							...
																							<td align="left">
			                   ${InterOfficeTransferActionForm.trxnDate}
			                </td>
																						</tr>
																						<tr class="fontnormal">
																							<th align="right">
																							...
																							<td align="left">
																								<c:if test="${InterOfficeTransferActionForm.fromOfficeHierarchy==1}">
																									<mifos:mifoslabel name="simpleAccounting.headOffice" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.fromOfficeHierarchy==2}">
																									<mifos:mifoslabel name="simpleAccounting.regionalOffice" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.fromOfficeHierarchy==3}">
																									<mifos:mifoslabel name="simpleAccounting.divisionalOffice" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.fromOfficeHierarchy==4}">
																									<mifos:mifoslabel name="simpleAccounting.areaOffice" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.fromOfficeHierarchy==5}">
																									<mifos:mifoslabel name="simpleAccounting.branchOffice" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.fromOfficeHierarchy==6}">
																									<mifos:mifoslabel name="simpleAccounting.center" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.fromOfficeHierarchy==7}">
																							...
																							<td align="left">
																								<c:forEach items="${sessionScope.IOFromOfficeHierarchy}" var="office">
																									<c:if test="${office.globalOfficeNum==InterOfficeTransferActionForm.fromOffice}">
					                          ${office.displayName}
								</c:if>
																								</c:forEach>
																							</td>
																						...
																						<tr class="fontnormal">
																							...
																							<td align="left">
																								<c:if test="${InterOfficeTransferActionForm.toOfficeHierarchy==1}">
																									<mifos:mifoslabel name="simpleAccounting.headOffice" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.toOfficeHierarchy==2}">
																									<mifos:mifoslabel name="simpleAccounting.regionalOffice" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.toOfficeHierarchy==3}">
																									<mifos:mifoslabel name="simpleAccounting.divisionalOffice" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.toOfficeHierarchy==4}">
																									<mifos:mifoslabel name="simpleAccounting.areaOffice" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.toOfficeHierarchy==5}">
																									<mifos:mifoslabel name="simpleAccounting.branchOffice" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.toOfficeHierarchy==6}">
																									<mifos:mifoslabel name="simpleAccounting.center" />
																								</c:if>
																								<c:if test="${InterOfficeTransferActionForm.toOfficeHierarchy==7}">
																									<mifos:mifoslabel name="simpleAccounting.group" />
																								</c:if>
																							</td>
																							<th align="right">
																							...
																							<td align="left">
																								<c:forEach items="${sessionScope.IOToOfficeHierarchy}" var="office">
																									<c:if test="${office.globalOfficeNum==InterOfficeTransferActionForm.toOffice}">
					                          ${office.displayName}
								</c:if>
																								</c:forEach>
																							</td>
																						...
																						<tr class="fontnormal">
																							...
																							<th width="15%" align="right">
																								<mifos:mifoslabel name="simpleAccounting.debitAccount" mandatory="yes" isColonRequired="Yes" />
																							</th>
																							<td width="25%" align="left">
																								<c:forEach items="${sessionScope.InterOfficeDebitAccountGlCodes}" var="debitglAccounts">
																									<c:if test="${debitglAccounts.glcode==InterOfficeTransferActionForm.debitAccountHead}">
					                  ${debitglAccounts.glname}
								</c:if>
																								</c:forEach>
																							</td>
																							<th align="right">
																								<mifos:mifoslabel name="simpleAccounting.creditAccount" mandatory="yes" isColonRequired="Yes" />
																							</th>
																							<td align="left">
																								<c:forEach items="${sessionScope.DebitAccountGlCodes}" var="creditglAccounts">
																									<c:if test="${creditglAccounts.glcode==InterOfficeTransferActionForm.creditAccountHead}">
					                  ${creditglAccounts.glname}
																						...
																						<tr class="fontnormal">
																							...
																							<td align="left">
																								<fmt:formatNumber value="${InterOfficeTransferActionForm.amount}" />
																							</td>
																						</tr>

																						<tr class="fontnormal">
																							<th align="right" colspan="1">
																								<mifos:mifoslabel name="simpleAccounting.voucherNotes" mandatory="yes" isColonRequired="Yes" />
																							</th>
																							<td align="left">
		        ${InterOfficeTransferActionForm.notes}
             </td>
																						</tr>
																						<tr class="fontnormal">

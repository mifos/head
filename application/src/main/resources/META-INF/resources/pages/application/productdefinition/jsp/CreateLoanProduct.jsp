							...
							<table width="93%" border="0" cellpadding="3" cellspacing="0">
								...
								<table width="93%" border="0" cellpadding="3" cellspacing="0">
											...
											<tr class="fontnormal">
												...
												<table width="98%" border="0" cellspacing="0"
													...
													<tr valign="top" class="fontnormal">
														...
														<td width="52%"><html-el:radio styleId="createLoanProduct.radio.freqOfInstallmentsMonths"
												...
												<table border="0" cellspacing="0" cellpadding="2">
													<tr class="fontnormal">
														...
														<td><span id="week"> <mifos:mifoslabel
															name="product.week" bundle="ProductDefUIResources" /></span> 
															<span id="month"> <mifos:mifoslabel name="product.month"
															bundle="ProductDefUIResources" /> </span></td>
														<td>	<span id="day"> <mifos:mifoslabel name="product.days"
															bundle="ProductDefUIResources" /> </span></td>
													</tr>
												</table>
												</div>
                                    ...
                                    <table width="93%" border="0" cellpadding="3" cellspacing="0">
                                        ...
                                        <tr class="fontnormal">
                                            <td width="30%" align="right" valign="top"><mifos:mifoslabel
                                                name="product.attachpenaltiestypes"
                                                bundle="ProductDefUIResources" isColonRequired="yes" /></td>
                                            <td width="70%" valign="top">
                                            <table width="80%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td class="fontnormal"><mifos:mifoslabel
                                                        name="product.clickpenaltytypes"
                                                        bundle="ProductDefUIResources" /></td>
                                                </tr>
                                                <tr>
                                                    <td><img src="pages/framework/images/trans.gif"
                                            ...
                                            <mifos:MifosSelect property="prdOfferinPenalties"
                                                input="LoanPenaltiesList" output="selectedPenaltyList"
                                                property1="penaltyId" property2="penaltyName" multiple="true">
                                            </mifos:MifosSelect>
                                            </td>
                                        </tr>
                                    </table>
									...
									<table width="93%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td align="center"><html-el:submit styleId="createLoanProduct.button.preview" styleClass="buttn submit"
												onclick="transferData(this.form.loanOfferingQGs);transferData(this.form.prdOfferinPenalties);transferData(this.form.loanOfferingFunds);transferData(this.form.prdOfferinFees);">

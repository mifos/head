...
<tiles:insert definition=".view">
	...
	<span id="page.id" title="ProductCategoryDetails"></span>
		...
		<c:set value="${session:getFromSession(sessionScope.flowManager,requestScope.currentFlowKey,'BusinessKey')}"
			...
			<table width="95%" border="0" cellpadding="0" cellspacing="0">
				...
				<c:url value="productCategoryAction.do" var="productCategoryActionGetAllCategoriesMethodUrl" >
					...
					</html-el:link> / <html-el:link href="${productCategoryActionGetAllCategoriesMethodUrl}">
							...
							<td height="23" colspan="2" class="fontnormalbold"><span
								...
								<c:otherwise>
									<span class="fontnormal"> <img
										...
										height="9">&nbsp;<mifos:mifoslabel name="product.inactive"
									bundle="ProductDefUIResources" /></span>
								</c:otherwise>
							</c:choose> <br>

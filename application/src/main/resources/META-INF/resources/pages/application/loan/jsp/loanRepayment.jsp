						...
						<tr>
                            ...
                            <c:choose>
                                <c:when test="${originalScheduleIsAvailable}">
                                   <c:url value="loanAccountAction.do" var="loanAccountActionViewOriginalScheduleMethodUrl" >
                                    <c:param name="method" value="viewOriginalSchedule" />
                                    ...
                                    href="${loanAccountActionViewOriginalScheduleMethodUrl}">
						...
						<tr>
							<td bgcolor="#F0D4A5" style="padding-left:10px; padding-bottom:3px;">
								...
								<c:if test="${(BusinessKey.accountState.id=='5' || BusinessKey.accountState.id=='9')}">
									<html-el:link styleId="loanRepayment.link.applyPayment" href="${applyPaymentActionLoadMethodUrl}">
							...
							<c:url value="applyChargeAction.do" var="applyChargeActionLoadMethodUrl" >
								...
								<html-el:link styleId="loanRepayment.link.applyCharges" href="${applyChargeActionLoadMethodUrl}">

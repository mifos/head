																				...
																				<br>
																					...
																					<table width="93%" border="0" cellpadding="3" cellspacing="0">
																						<tr class="fontnormal">
																							...
																							<td align="left">
			                    ${SingleGeneralLedgerActionForm.trxnDate}
			                </td>
																						...
																						<tr class="fontnormal">
																							...
																							<td align="left">
																								<c:if test="${SingleGeneralLedgerActionForm.officeHierarchy==1}">
																									<mifos:mifoslabel name="simpleAccounting.headOffice" />
																								</c:if>
																								<c:if test="${SingleGeneralLedgerActionForm.officeHierarchy==2}">
																									<mifos:mifoslabel name="simpleAccounting.regionalOffice" />
																								</c:if>
																								<c:if test="${SingleGeneralLedgerActionForm.officeHierarchy==3}">
																									<mifos:mifoslabel name="simpleAccounting.divisionalOffice" />
																								</c:if>
																								<c:if test="${SingleGeneralLedgerActionForm.officeHierarchy==4}">
																									<mifos:mifoslabel name="simpleAccounting.areaOffice" />
																								</c:if>
																								<c:if test="${SingleGeneralLedgerActionForm.officeHierarchy==5}">
																									<mifos:mifoslabel name="simpleAccounting.branchOffice" />
																								</c:if>
																								<c:if test="${SingleGeneralLedgerActionForm.officeHierarchy==6}">
																									<mifos:mifoslabel name="simpleAccounting.center" />
																								</c:if>
																								<c:if test="${SingleGeneralLedgerActionForm.officeHierarchy==7}">
																							...
																							<td align="left">
																								<c:forEach items="${sessionScope.OfficesOnHierarchy}" var="offices">
																									<c:if test="${offices.globalOfficeNum==SingleGeneralLedgerActionForm.offices}">
																									${offices.displayName}
																									</c:if>
																								</c:forEach>
																						...
																						<tr class="fontnormal">
																							...
																							<td width="25%" align="left">
																								<c:if test="${SingleGeneralLedgerActionForm.trxnType=='CR'}">
																									<mifos:mifoslabel name="simpleAccounting.cashReceipt" />
																								</c:if>
																								<c:if test="${SingleGeneralLedgerActionForm.trxnType=='CP'}">
																									<mifos:mifoslabel name="simpleAccounting.cashPayment" />
																								</c:if>
																								<c:if test="${SingleGeneralLedgerActionForm.trxnType=='BR'}">
																									<mifos:mifoslabel name="simpleAccounting.bankReceipt" />
																								</c:if>
																								<c:if test="${SingleGeneralLedgerActionForm.trxnType=='BP'}">
																							...
																							<td width="25%" align="left">
																								<c:forEach items="${sessionScope.MainAccountGlCodes}" var="mainaccount">
																									<c:if test="${mainaccount.glcode==SingleGeneralLedgerActionForm.mainAccount}">
				                          ${mainaccount.glname}
							</c:if>
																								</c:forEach>
																							</td>
																						...
																						<tr class="fontnormal">
																							...
																							<td align="left">
																								<c:forEach items="${sessionScope.AccountHeadGlCodes}" var="accountHead">
																									<c:if test="${accountHead.glcode==SingleGeneralLedgerActionForm.accountHead}">
				                          ${accountHead.glname}
							</c:if>
																								</c:forEach>
																							...
																							<td align="left">
																								<fmt:formatNumber value="${SingleGeneralLedgerActionForm.amount}"/>
																							</td>
																						</tr>
																						<tr class="fontnormal">
				...
				<th align="center">
					...
					${SingleGeneralLedgerActionForm.bankBranch}
																									...
																									<tr class="fontnormal">
																										...
																										<td align="left">
		   ${SingleGeneralLedgerActionForm.notes}
         </td>
																									</tr>
																									<tr class="fontnormal">
																										<th align="right" colspan="1">
																										...
																										<td align="left">
		   ${SingleGeneralLedgerActionForm.memberId}
         </td>
																									</tr>
																									<tr class="fontnormal">

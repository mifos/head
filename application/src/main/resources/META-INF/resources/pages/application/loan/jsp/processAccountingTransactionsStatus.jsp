...
<html-el:form action="/processaccountingtransactionsaction.do">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<table width="93%" border="0" cellpadding="3" cellspacing="0">
										<tr>
											<td class="headingorange">
												<mifos:mifoslabel name="simpleAccounting.processTransactionsSuccess" />
											</td>
										</tr>
									</table>
				...
				<table width="93%" border="0" cellpadding="3" cellspacing="0">
					<tr class="fontnormal">
						<td><b><mifos:mifoslabel name="simpleAccounting.note" isColonRequired="Yes"/></b><mifos:mifoslabel name="simpleAccounting.lastProcessedDateStatus"/> <b>${ProcessAccountingTransactionsActionForm.lastProcessDate}<b></td>
					</tr>
					<tr class="fontnormal">
						<td><a href="processaccountingtransactionsaction.do?method=load"><mifos:mifoslabel name="simpleAccounting.enterProcessAccountingTransactions"/></a></td>
					</tr>

            ...
            <tr class="fontnormal" >
             ...
             <c:forEach items="${sessionScope.coaNamesList}" var="accountHead">
                ...
                <tr class="fontnormal">
                    ...
                    <td>
                        <html-el:text property="amount" name="voucherbranchmappingform" styleClass="separatedNumber" value="0" styleId="${accountHead.sno}" onkeypress="return isNumberKey(event)"/>
                    </td>
                    <td>
                        <html-el:text property="transactionnotes" name="voucherbranchmappingform" styleClass="separatedNumber" value="" styleId="simpleaccounting.input.transactionnotes" />
                    </td>
                    <td>

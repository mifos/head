            ...
            <tr class="fontnormal" >
             ...
             <c:forEach items="${sessionScope.coaNamesList}" var="accountHead">
                ...
                <tr class="fontnormal">
                    ...
                    <td>
                        <html-el:text property="amount" name="voucherbranchmappingform" styleClass="separatedNumber" value="0" styleId="${accountHead.sno}" onchange="javascript:addNumbers('${accountHead.sno}')"/>
                    </td>
                    <td>

...
<script language="javascript">
	...
	function loadPrintDetails(form,memberId) {
			
		var url="collectionsheetprintchildaction.do?method=memberPrintDetails&memberId="+memberId;
		window.open(url,"_blank","directories=no,scrollbars=yes,status=no,width=800, height=600,top=0,left=0"); 
	}
...
<html-el:form action="/collectionsheetprintaction">
...
<%-- <td align="left">
<html-el:link styleId="memberId" action="collectionsheetprintchildaction.do?method=memberPrintDetails&memberId=${groupMembers.customerId}">print receipt</html-el:link>
</td> --%>
	<td>
			<html-el:hidden styleId="bulkentry.input.memberId" property="memberId"/>								
			<input  type="button" name="print receipt" value="print receipt" onclick="loadPrintDetails(this.form,${groupMembers.customerId});"/>
	</td>
</tr>
</c:forEach>

...
public class MonthlyOnDateScheduledEvent implements ScheduledEvent {
    ...
    public MonthlyOnDateScheduledEvent(final int every, final int dayOfMonth) {
        this.every = every;
    ...
    public DateTime nextEventDateAfter(final DateTime startDate) {
        ...
        return CalendarUtils.getNextDateForMonthOnDate(startDate, this.dayOfMonth, this.every);
    }

...
public class CollectionSheetReportDTO {
    ...
    public CollectionSheetReportDTO(CollSheetLnDetailsEntity loanDetailsEntity1,
            CollSheetLnDetailsEntity loanDetailsEntity2, CollSheetSavingsDetailsEntity mm1SavingsDetailEntity,
            CollSheetSavingsDetailsEntity mm2SavingsDetailEntity, Integer customerId, Integer groupId,
            String customerName, String branchName, String groupName, CustomerBO center, String loanOfferingShortName1,
            String loanOfferingShortName2, String savingsOfferingShortName1, String savingsOfferingShortName2,
            Date meetingDate) {
        ...
        this.loanOfficerId = NumberUtils.convertShortToInteger(center.getPersonnel().getPersonnelId());

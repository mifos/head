...
public class BranchReportBO extends BusinessObject {
    ...
    public void addLoanArrearsAging(BranchReportLoanArrearsAgingBO loanArrearAgingBO) {
    ...
    public void addLoanArrearsProfile(BranchReportLoanArrearsProfileBO loanArrearProfile) {
        this.loanArrearsProfile.add(loanArrearProfile);
        loanArrearProfile.setBranchReport(this);
    }

    public void addStaffSummaries(List<BranchReportStaffSummaryBO> staffSummaries) {
        for (BranchReportStaffSummaryBO staffSummary : staffSummaries) {
            addStaffSummary(staffSummary);
        }
    }

    public void addStaffingLevelSummaries(List<BranchReportStaffingLevelSummaryBO> staffingLevelSummaries) {
    ...
    public static BranchReportBO createInstanceForTest(Integer branchReportId, Short branchId, Date runDate) {
    ...
    public int hashCode() {
        ...
        result = PRIME * result + ((branchReportId == null) ? 0 : branchReportId.hashCode());
        result = PRIME * result + ((clientSummaries == null) ? 0 : clientSummaries.hashCode());
        result = PRIME * result + ((loanArrearsAging == null) ? 0 : loanArrearsAging.hashCode());
        result = PRIME * result + ((runDate == null) ? 0 : runDate.hashCode());
        result = PRIME * result + ((staffSummaries == null) ? 0 : staffSummaries.hashCode());
        result = PRIME * result + ((staffingLevelSummaries == null) ? 0 : staffingLevelSummaries.hashCode());
        return result;
    }

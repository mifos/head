...
public class FiscalCalendarRules {
    ...
    public final String FiscalCalendarRulesWorkingDays = "FiscalCalendarRules.WorkingDays";

    /**  FIXME, should be deleted after 1.7 Release */
    @Deprecated
    private final String FiscalCalendarRulesScheduleTypeForMeetingOnHoliday = "FiscalCalendarRules.ScheduleTypeForMeetingOnHoliday";

    private final String FiscalCalendarRulesScheduleMeetingIfNonWorkingDay = "FiscalCalendarRules.ScheduleMeetingIfNonWorkingDay";
    ...
    public String getScheduleMeetingIfNonWorkingDay() {
        ...
        if (configMgr.containsKey(FiscalCalendarRulesScheduleTypeForMeetingOnHoliday)) {
            ...
            System.err.println("NOT SEVERE: ONLY WARNING: FiscalCalendarRules.ScheduleTypeForMeetingOnHoliday is deprecated and will not be supported in a future release. "
                            + "Use FiscalCalendarRules.ScheduleMeetingIfNonWorkingDay instead.");
        } else if (configMgr.containsKey(FiscalCalendarRulesScheduleMeetingIfNonWorkingDay)) {
            scheduleType = configMgr.getString(FiscalCalendarRulesScheduleMeetingIfNonWorkingDay);
        } else {
    ...
    public void setScheduleTypeForMeetingIfNonWorkingDay(final String ScheduleMeetingIfNonWorkingDay) {
        ConfigurationManager.getInstance().setProperty(FiscalCalendarRulesScheduleMeetingIfNonWorkingDay, ScheduleMeetingIfNonWorkingDay);
    }

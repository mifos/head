...
public class MandatoryHiddenFieldServiceImpl implements MandatoryHiddenFieldService {
    ...
    private void updateSystemFields(MandatoryHiddenFieldsDto dto, FieldConfigurationEntity fieldConfiguration) throws Exception {
        if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.EXTERNAL_ID)) {
            fieldConfiguration.update(getShortValue(dto.isMandatorySystemExternalId()),
                    getShortValue(dto.isHideSystemExternalId()));
            ...
            fieldConfiguration.update(fieldConfiguration.getMandatoryFlag(), getShortValue(dto.isHideSystemReceiptIdDate()));
            ...
            fieldConfiguration.update(getShortValue(dto.isMandatoryLoanAccountPurpose()), fieldConfiguration.getHiddenFlag());
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.SOURCE_OF_FUND)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryLoanSourceOfFund()), fieldConfiguration.getHiddenFlag());
            ...
            fieldConfiguration.update(fieldConfiguration.getMandatoryFlag(), getShortValue(dto.isHideSystemCollateralTypeNotes()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.ASSIGN_CLIENTS)) {
            fieldConfiguration.update(fieldConfiguration.getMandatoryFlag(), getShortValue(dto.isHideSystemAssignClientPostions()));
        }
    }

    private void updateGrouptDetails(MandatoryHiddenFieldsDto dto,
        ...
        if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.ADDRESS1)) {
            ...
            fieldConfiguration.update(getShortValue(dto.isMandatorySystemEthnicity()), getShortValue(dto.isHideSystemEthnicity()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.CITIZENSHIP)) {
            fieldConfiguration.update(getShortValue(dto.isMandatorySystemCitizenShip()),
                    getShortValue(dto.isHideSystemCitizenShip()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.HANDICAPPED)) {
            fieldConfiguration.update(getShortValue(dto.isMandatorySystemHandicapped()),
                    getShortValue(dto.isHideSystemHandicapped()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.EDUCATION_LEVEL)) {
            fieldConfiguration.update(getShortValue(dto.isMandatorySystemEducationLevel()),
                    getShortValue(dto.isHideSystemEducationLevel()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.PHOTO)) {
            fieldConfiguration.update(getShortValue(dto.isMandatorySystemPhoto()), getShortValue(dto.isHideSystemPhoto()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.RECEIPT_ID)
                || fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.RECEIPT_DATE)) {
            fieldConfiguration.update(fieldConfiguration.getMandatoryFlag(), getShortValue(dto.isHideSystemReceiptIdDate()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.ASSIGN_CLIENTS)) {
    ...
    private void updateClientDetails(MandatoryHiddenFieldsDto dto,
            FieldConfigurationEntity fieldConfiguration) throws Exception {
        if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.MIDDLE_NAME)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryClientMiddleName()),
                    getShortValue(dto.isHideClientMiddleName()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.SECOND_LAST_NAME)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryClientSecondLastName()),
                    getShortValue(dto.isHideClientSecondLastName()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.GOVERNMENT_ID)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryClientGovtId()), getShortValue(dto.isHideClientGovtId()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.MARITAL_STATUS)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryMaritalStatus()), fieldConfiguration
                    .getHiddenFlag());
        } else if (fieldConfiguration.getFieldName().equals(
                HiddenMandatoryFieldNamesConstants.POVERTY_STATUS)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryClientPovertyStatus()),
                    getShortValue(dto.isHideClientPovertyStatus()));
        } else if (fieldConfiguration.getFieldName().equals(
                HiddenMandatoryFieldNamesConstants.SPOUSE_FATHER_INFORMATION)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryClientSpouseFatherInformation()),
                    getShortValue(dto.isHideClientSpouseFatherInformation()));
        } else if (fieldConfiguration.getFieldName().equals(
                HiddenMandatoryFieldNamesConstants.FAMILY_DETAILS)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryClientFamilyDetails()),
                    fieldConfiguration.getHiddenFlag());
        } else if (fieldConfiguration.getFieldName().equals(
                HiddenMandatoryFieldNamesConstants.SPOUSE_FATHER_MIDDLE_NAME)) {
            fieldConfiguration.update(fieldConfiguration.getMandatoryFlag(), getShortValue(dto.isHideClientSpouseFatherMiddleName()));
        } else if (fieldConfiguration.getFieldName().equals(
            ...
            fieldConfiguration.update(getShortValue(dto.isMandatoryClientPhone()), getShortValue(dto.isHideClientPhone()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.TRAINED)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryClientTrained()), getShortValue(dto.isHideClientTrained()));
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.TRAINED_DATE)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryClientTrainedOn()), getShortValue(dto.isHideClientTrained())); // hidden field from Trained is shared with TrainedDate (#MIFOS-2731)
        } else if (fieldConfiguration.getFieldName().equals(HiddenMandatoryFieldNamesConstants.BUSINESS_ACTIVITIES)) {
            fieldConfiguration.update(getShortValue(dto.isMandatoryClientBusinessWorkActivities()), getShortValue(dto.isHideClientBusinessWorkActivities()));

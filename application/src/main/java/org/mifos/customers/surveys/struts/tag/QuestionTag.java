...
public class QuestionTag extends BodyTagSupport {
    ...
    public String getQuestionMarkup(XmlBuilder html) {
        ...
        if (question.getAnswerTypeAsEnum() == AnswerType.MULTISELECT) {
            ...
            html.singleTag("input", "type", "text", "maxlength", "2", "size", "2", "class",
                    "surveyform dateinput fontnormal8pt", "name", String.format(nameTemplate, getQuestionId(), "DD",
                            disabledAttr, "disabled"), "value", dateParts[0]);
            html.text(" DD ");
            html.singleTag("input", "type", "text", "maxlength", "2", "size", "2", "class",
                    "surveyform dateinput fontnormal8pt", "name", String.format(nameTemplate, getQuestionId(), "MM",
                            disabledAttr, "disabled"), "value", dateParts[1]);
            html.text(" MM ");
            html.singleTag("input", "type", "text", "maxlength", "4", "size", "4", "class",
                    "surveyform dateinput fontnormal8pt", "name", String.format(nameTemplate, getQuestionId(), "YY",
                            disabledAttr, "disabled"), "value", dateParts[2]);
            html.text(" YYYY ");
        }

...
//		request.getSession().setAttribute(CollectionSheetEntryConstants.COLLECTION_SHEET_ENTRY_FORM_DTO, latestCollectionSheetEntryFormDto);
		request.getSession().setAttribute(CollectionSheetEntryConstants.MEMBERSLIST,latestCollectionSheetEntryFormDto.getMembersList()); //for get() method of main Action Class
		SessionUtils.setCollectionAttribute(CollectionSheetEntryConstants.MEMBERSLIST,latestCollectionSheetEntryFormDto.getMembersList(), request);//for jsp view
	}

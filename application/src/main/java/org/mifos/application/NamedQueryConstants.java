...
public interface NamedQueryConstants {
    ...
    // configuration
    public String GET_CONFIGURATION_KEYVALUE_BY_KEY = "getConfigurationKeyValueByKey";
    public String GET_ALL_CONFIGURATION_VALUES = "getAllConfigurationValues";
    ...
    public String GET_OFFICES_TILL_BRANCHOFFICE = "office.getOfficesTillBranchOffice";
    public String GET_BRANCH_OFFICES = "office.getBranchOffices";

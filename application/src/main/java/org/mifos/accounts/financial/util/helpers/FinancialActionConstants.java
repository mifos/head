...
public enum FinancialActionConstants {
    ...
    MISCPENALTYPOSTING(6), DISBURSAL(7), ROUNDING(8), MANDATORYDEPOSIT(9), VOLUNTORYDEPOSIT(10), MANDATORYWITHDRAWAL(11), VOLUNTORYWITHDRAWAL(
            12),
    ...
    SAVINGS_INTERESTPOSTING(14), CUSTOMERACCOUNTMISCFEESPOSTING(16), MANDATORYDEPOSIT_ADJUSTMENT(18), VOLUNTORYDEPOSIT_ADJUSTMENT(
            19), MANDATORYWITHDRAWAL_ADJUSTMENT(20), VOLUNTORYWITHDRAWAL_ADJUSTMENT(21), WRITEOFF(22), RESCHEDULE(23);

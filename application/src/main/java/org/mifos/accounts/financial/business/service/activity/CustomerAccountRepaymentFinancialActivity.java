...
import org.mifos.accounts.financial.business.service.activity.accountingentry.CustomerAccountFeesAccountingEntry;
import org.mifos.accounts.financial.business.service.activity.accountingentry.PenaltyAccountingEntry;

public class CustomerAccountRepaymentFinancialActivity extends BaseFinancialActivity {

    public CustomerAccountRepaymentFinancialActivity(AccountTrxnEntity accountTrxn) {
        super(accountTrxn);
    }

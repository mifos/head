...
package org.mifos.accounts.acceptedpaymenttype.business.service;
...
public class AcceptedPaymentTypeService {
    ...
    public static List<PaymentTypeEntity> getAcceptedPaymentTypes(Short localeId) throws Exception {
        return new AcceptedPaymentTypePersistence().getAcceptedPaymentTypesForATransaction(localeId,

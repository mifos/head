...
public class LoanAccountAction extends AccountAppAction {
    ...
    public ActionForward getPrdOfferings(final ActionMapping mapping, final ActionForm form,
        ...
        LoanCreationProductDetailsDto loanCreationProductDetailsDto = this.loanServiceFacade.retrieveGetProductDetailsForLoanAccountCreation(loanActionForm.getCustomerIdValue());
    ...
    public ActionForward load(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
        ...
        if (productId == null) {
            productId = Short.valueOf(request.getAttribute("prdOfferingId").toString());
        }
...
//        loanActionForm.initializeTransactionFields(loanScheduleDetailsDto.getPaymentDataBeans());
    ...
    public ActionForward preview(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
            @SuppressWarnings("unused") final HttpServletResponse response) throws PageExpiredException, AccountException, ServiceException, PersistenceException, NumberFormatException, MeetingException, InvalidDateException {
        ...
        if (perspective != null) {
            ...
            loanIndividualMonitoringIsEnabled = configurationPersistence.getConfigurationKeyValueInteger(LOAN_INDIVIDUAL_MONITORING_IS_ENABLED).getValue();
            ...
            if (null != loanIndividualMonitoringIsEnabled && loanIndividualMonitoringIsEnabled.intValue() != 0 && customer.getCustomerLevel().isGroup()) {
                ...
                for (String index : ids_clients_selected) {
                    if (isNotEmpty(index)) {
                        ...
                        tempLoanAccount.setGovermentId((StringUtils.isNotBlank(clt.getGovernmentId()) ? clt.getGovernmentId() : "-").toString());
    ...
    public ActionForward create(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
        ...
        CustomerBO customer = getCustomer(((CustomerDetailDto) SessionUtils.getAttribute(LOANACCOUNTOWNER, request)).getCustomerId());
        LoanBO loan;

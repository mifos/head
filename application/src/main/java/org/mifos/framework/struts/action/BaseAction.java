...
public abstract class BaseAction extends DispatchAction {
    ...
    protected LegacyFeeServiceFacade legacyFeeServiceFacade = DependencyInjectedServiceLocator.locateFeeServiceFacade();
    protected NewFeeServiceFacade feeServiceFacade = DependencyInjectedServiceLocator.locateNewFeeServiceFacade();
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        if (springAppContext != null) {
            ...
            this.legacyFeeServiceFacade = springAppContext.getBean(LegacyFeeServiceFacade.class);
            this.feeServiceFacade = springAppContext.getBean(NewFeeServiceFacade.class);

...
public class RawButton {
    /**
     * Default no arg constructor initialise the members mainley the type and
     * value
     */
    public RawButton() {
        name = null;
    ...
    public String toString() {
        ...
        results
                .append("onMouseover=\"showtip(this,event,'Click To move the selected item')\" onMouseout=\"hidetip()\" ></INPUT>");

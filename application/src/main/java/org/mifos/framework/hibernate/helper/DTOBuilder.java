 ...
 * set of search result objects , these search result objects would be obtained
 * through hibernate scroll for pagination in the front end , the associate
 * hibernate session would be held in this object , a call to close from the
 * front end on this interface would result in the hibernate session object
 * getting closed.
 */

public class DTOBuilder {

    private static final Logger logger = Logger.getLogger(DTOBuilder.class);
    ...
    public Object buildDTO(Object[] dtoData) throws HibernateSearchException {
        ...
        try {
            ...
            while (i++ < dtoData.length - 1) {
                ...
                methodToCall = dtoObject.getClass().getMethod(alias, parameterTypes);

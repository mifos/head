...
public class DisplayName {
    ...
    public String[] getDisplayName(PageContext pageContext, Fragment[] fragment, Object obj, boolean span, Locale locale)
        ...
        // if the collection is null value then string array is a single object
        // string array.
        // return the string.
            ...
            for (int k = 0; it.hasNext(); k++) {
                ...
                if (collValue != null && !(collValue.trim().equals("")) && !(collValue.trim().equalsIgnoreCase("null"))) {
                    for (int i = 0; i < stringArray.length; i++) {
                        stringbuilder.append(getData(fragment[i], stringArray[i] == null ? collValue : stringArray[i],
                                span));
                    }
    ...
    public String getDisplayName(PageContext pageContext, Fragment[] fragment, Object obj, String image, Locale locale)
            throws TableTagException {

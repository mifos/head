...
public class Column {
    ...
    /**
     * @param checkLinkOptionalRequired
     *            The checkLinkOptionalRequired to set.
     */
    ...
    /**
     * @param isLinkOptional
     *            The isLinkOptional to set.
     */
     ...
     */
    public String getColumn(PageContext pageContext, Object obj, Locale locale, boolean isFlowRequired)
            throws TableTagException {
        ...
        // Used to get the value of label according to labeltype using helper
        // method
     ...
     * @throws TableTagException
     */
    private void getLabel(PageContext pageContext, StringBuilder stringColumn, Object obj, Locale locale)
            throws TableTagException {
        Object value = TableTagUtils.getInstance().helper(pageContext, label, labeltype, obj, locale);
        stringColumn.append("<span class=\"").append(
                boldlabel.equalsIgnoreCase("true") ? "fontnormalbold" : "fontnormal").append("\">").append(value);
     ...
     * @throws TableTagException
     */
    private String getColumnValue(PageContext pageContext, Object obj, Locale locale, boolean isFlowRequired)
            throws TableTagException {
        String displayString = null;
        // To check whether type is link or text.
        if (("link".equalsIgnoreCase(type))) {
            if ("true".equals(isLinkOptional)) {
                String linkrequired = (String) TableTagUtils.getInstance().helper(pageContext,
                        checkLinkOptionalRequired, "method", obj, locale);

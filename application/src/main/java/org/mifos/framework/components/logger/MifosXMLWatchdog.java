...
/**
 * This class inherits from the FileWatchdog of log4j and is used to monitor the
 * log4j configuration file for any changes.
 */
public class MifosXMLWatchdog extends FileWatchdog {
    ...
    /**
     * This method is overridden so that whenever there is a change in the XML
     * file (which is used to configure the Log4j logger), it creates an object
     * of MifosDomConfigurator and calls the doConfigure on it.
     */
    @Override

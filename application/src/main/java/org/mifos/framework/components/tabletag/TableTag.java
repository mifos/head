...
public class TableTag extends BodyTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            if (list.size() == 0) {
                ...
                XmlBuilder result;
                result = noResults((String) SessionUtils.getAttribute(Constants.OFFICE_NAME,
                        (HttpServletRequest) pageContext.getRequest()), (String) SessionUtils.getAttribute(
                        Constants.BRANCH_ID, (HttpServletRequest) pageContext.getRequest()), (String) SessionUtils
    ...
    private void createStartTable(StringBuilder result, boolean headingRequired, boolean topBlueLineRequired)
        ...
        if (headingRequired) {
            ...
            String officeName = (String) SessionUtils.getAttribute(Constants.OFFICE_NAME,
                    (HttpServletRequest) pageContext.getRequest());
            ...
            result.append("<tr><td colspan=\"2\" valign=\"top\">").append(
                    "<img src=\"pages/framework/images/trans.gif \" width=\"5\" height=\"3\"></td></tr>");
        }
        result.append("<table width=" + width + "border=" + border + "cellspacing=" + cellspacing + "cellpadding="
                + cellpadding + " >");
        if (topBlueLineRequired) {
            result.append("<tr><td colspan=\"2\" valign=\"top\" class=\"blueline\">").append(
                    "<img src=\"pages/framework/images/trans.gif \" width=\"5\" height=\"3\"></td></tr>");
        }
    }
    ...
    void createEndTable(StringBuilder result, boolean bottomBlueLineRequired) {
        if (bottomBlueLineRequired) {
            result.append("<tr><td colspan=\"2\" valign=\"top\" class=\"blueline\">").append(
                    "<img src=\"pages/framework/images/trans.gif \" width=\"10\" height=\"5\"></td></tr>").append(
                    "<tr><td height=\"35\" colspan=\"2\" align=\"center\" class=\"blueline\">").append(
                    "<table width=\"400\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">");
        } else {
            result.append("<tr><td colspan=\"2\" valign=\"top\" class=\"blueline\">").append(
                    "<img src=\"pages/framework/images/trans.gif \" width=\"5\" height=\"3\"></td></tr>").append(
                    "<tr><td height=\"35\" colspan=\"2\" align=\"center\">").append(
                    "<table width=\"400\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">");
        }
    }
     ...
     * @return table object.
     */
    Table helperCache(String xmlFilePath, String key) throws TableTagParseException {
    ...
    private void getMultipleData(List list, Locale locale, Integer currentValue) throws TableTagTypeParserException,
        ...
        String action = (String) SessionUtils.getAttribute("action", pageContext.getSession());
        out.write(result.toString());
        String currentFlowkey = (String) ((HttpServletRequest) pageContext.getRequest())
                .getAttribute(Constants.CURRENTFLOWKEY);
        String perspective = (String) ((HttpServletRequest) pageContext.getRequest())
                .getAttribute(RequestConstants.PERSPECTIVE);
    ...
    private void displayDataMultiple(Object object, Table table, int number, Locale locale) throws TableTagException,
    ...
    private void displayData(List list, Table table, Locale locale, Integer currentValue) throws TableTagException,
            IOException, JspException {
        JspWriter out = pageContext.getOut();
        ...
        for (Iterator it = list.iterator(); it.hasNext();) {
            ...
            boolean isFlowRequired = table.getPageRequirements().getFlowRequired().equalsIgnoreCase("true") ? true
                    : false;
        ...
        StringBuilder result = new StringBuilder();
        boolean bottomBlueLineRequired = table.getPageRequirements().getBottombluelineRequired().equalsIgnoreCase(
                "true");
    ...
    private List getCacheNullList() throws HibernateSearchException {
        ...
        Cache cache = null;
        try {
            QueryResult query = (QueryResult) SessionUtils.getAttribute(Constants.SEARCH_RESULTS,
                    (HttpServletRequest) pageContext.getRequest());
            if (null != query) {
                ...
                if (null == list) {
                    ...
                    SessionUtils.setRemovableAttribute(TableTagConstants.TABLECACHE, cache, TableTagConstants.PATH,

...
<span style="display: none" id="page.id">report_designer_datasource_add</span>
				      ...
				      <tr>
				        <td class="bluetablehead05">
					        ...
					        <span class="fontnormal8ptbold">
					           	<mifos:mifoslabel name="reports.addreportsdatasource" bundle="reportsUIResources"/>						           	
					        </span>
				        </td>
				      </tr>				      
				     </table>
						  		...
						  		<tr>
									...
									<table width="95%" border="0" cellpadding="3" cellspacing="0" align='center'>
										...
										<tr class="fontnormal">
						    	            ...
						    	            <td>
						    	            <mifos:mifosalphanumtext property="driver" value=""/>						    	            
						    	            </td>
					    	            </tr>
										<tr class="fontnormal">
							                <td  nowrap align="left">
						    	            ...
						    	            <td>
						    	            <mifos:mifosalphanumtext property="url" value=""/>						    	            
						    	            </td>
					    	            </tr>
										<tr class="fontnormal">
							                <td  nowrap align="left">
						    	            ...
						    	            <td>
						    	            <mifos:mifosalphanumtext property="username" value=""/>						    	            
						    	            </td>
					    	            </tr>
										<tr class="fontnormal">
							                <td  nowrap align="left">
						    	            ...
						    	            <td>
						    	            <mifos:mifosalphanumtext property="password" value=""/>						    	            
						    	            </td>
					    	            </tr>

...
<tiles:insert definition=".view">
	...
	<span style="display: none" id="page.id">survey_edit_preview</span>
	<script src="pages/application/surveys/js/questions.js" type="text/javascript"></script>
<html-el:form action="/surveysAction.do?method=update">
...
<br>
      ...
      <span class="fontnormal"></span>
       <html-el:button property="calcelButton" onclick="submitSurveyForm('edit_update')" styleClass="insidebuttn"><mifos:mifoslabel name="Surveys.button.editsurvey" bundle="SurveysUIResources" /></html-el:button>                 </td>
                </tr>
              </table>

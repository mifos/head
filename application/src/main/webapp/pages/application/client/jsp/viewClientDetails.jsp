							...
							<table width="95%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<span class="fontnormal"><mifos:mifoslabel name="client.amtdue"
										bundle="ClientUIResources" isColonRequired="yes"/> <span id="viewClientDetails.text.amountDue"><c:out
										value="${clientInformationDto.customerAccountSummary.nextDueAmount}" /></span>
									</span></td>
								</tr>

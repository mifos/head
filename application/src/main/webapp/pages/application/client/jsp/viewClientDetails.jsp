		...
		<c:set value="${session:getFromSession(sessionScope.flowManager,requestScope.currentFlowKey,'clientInformationDto')}"
			...
			<table width="95%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<tr class="fontnormal">
							...
							<a id="viewClientDetails.link.questionGroups" href="questionGroupResponses.ftl?entityId=<c:out value="${clientInformationDto.clientDisplay.customerId}"/>&event=Create&source=Client&backPageUrl=<c:out value="${session:getFromSession(sessionScope.flowManager,requestScope.currentFlowKey,'currentPageUrl')}"/>">
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="0" class="bluetableborder">
            <tr>
              <td colspan="2" class="bluetablehead05">
                <span class="fontnormalbold">
                  <mifos:mifoslabel name="client.QuestionGroupInstances" bundle="ClientUIResources"/>
                </span>
              </td>
            </tr>
            <tr>

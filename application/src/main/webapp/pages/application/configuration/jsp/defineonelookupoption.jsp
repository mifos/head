						...
						<font class="fontnormalRedBold"><html-el:errors bundle="configurationUIResources" /> </font>
		                     <table width="93%" border="0" cellpadding="3" cellspacing="0">
					              <tr class="fontnormal">
					                ...
					                <td width="70%" valign="top"><input type="text" name="lookupValue" value='<c:out value="${lookupoptionsactionform.lookupValue}" />' maxlength="300" value="" onkeydown="doKeyPress(event);" />
									</td>
					              </tr>
							</table>

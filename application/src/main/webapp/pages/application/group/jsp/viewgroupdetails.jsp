									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td><span class="fontnormal"><mifos:mifoslabel
												name="Group.amountdue" bundle="GroupUIResources" /> <span id="viewgroupdetails.text.amountDue"><c:out
												value="${groupInformationDto.customerAccountSummary.nextDueAmount}" /> </span></span></td>
										</tr>
									</table>
									</td>
								</tr>

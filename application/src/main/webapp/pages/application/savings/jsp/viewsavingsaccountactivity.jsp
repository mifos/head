...
<tiles:insert definition=".clientsacclayoutsearchmenu">
	...
	<span id="page.id" title="viewsavingsaccountactivity" />
	...
	<c:set value="${session:getFromSession(sessionScope.flowManager,requestScope.currentFlowKey,'BusinessKey')}" var="BusinessKey" />
      ...
      <table width="95%" border="0" cellpadding="0" cellspacing="0">
        ...
        <c:set value="${session:getFromSession(sessionScope.flowManager,requestScope.currentFlowKey,'recentActivityList')}" var="recentActivityList" scope="session" />
            <mifoscustom:mifostabletag source="recentActivityList" scope="session" xmlFileName="SavingsAccountActivity.xml" moduleName="org/mifos/accounts/savings/util/resources" passLocale="true"/>
            <br>
